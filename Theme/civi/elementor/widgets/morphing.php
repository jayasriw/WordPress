...
class Widget_Morphing extends Base {
    ...
    public function get_name() {
        return 'civi-morphing';
    }

    public function get_title() {
        return esc_html__('Morphing', 'civi');
    }

    public function get_icon() {
        return 'civi-badge eicon-anchor';
    }
    ...
    {
        return ['civi-el-widget-morphing'];
    }

    public function get_script_depends()
    {
        return ['civi-widget-morphing','scrollmonitor','anime'];
    }
    ...
    private function add_content_section()
    {
        ...
        $this->add_control(
            'morph_layout',
            [
                'label' => esc_html__( 'Morphing Layout', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
                'options' => [
                    'normal'  => esc_html__( 'Normal ', 'civi' ),
                    'sec_bg'  => esc_html__( 'Section Background', 'civi' ),
                    'column_bg'  => esc_html__( 'Column Background', 'civi' ),
                    'fixed_scroll'  => esc_html__( 'Fixed Scroll', 'civi' ),
                ],
            ]
        );
        ...
        $this->start_controls_tab( 'morph_mw_mh',
            [
                'label' => esc_html__( 'Max-Size', 'civi' ),
            ]
        );
        $this->add_responsive_control(
            'morph_maxwidth',
            [
                'label' => esc_html__( 'Maximum Width', 'civi' ),
                ...
                'selectors' => [
                    '.morph-{{ID}}.civi-morphing-svg-wrapper' => 'max-width: {{SIZE}}{{UNIT}};margin: 0 auto;',
                ],
            ]
        );
        $this->add_responsive_control(
            'morph_maxheight',
            [
                'label' => esc_html__( 'Maximum Height', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
                ...
                'selectors' => [
                    '.morph-{{ID}}.civi-morphing-svg-wrapper' => 'max-height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->start_controls_tab( 'viebox_mw_mh',
            [
                'label' => esc_html__( 'ViewBox Size', 'civi' ),
            ]
        );
        $this->add_responsive_control(
            'viewbox_width',
            [
                'label' => esc_html__( 'ViewBox Width', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 50,
        ...
        $this->add_responsive_control(
            'viewbox_height',
            [
                'label' => esc_html__( 'ViewBox Height', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
        ...
        $repeater->add_control(
            'layouts',
            [
                'label' => esc_html__( 'Morphing Style', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'style-01',
                'options' => [
                    'style-01'  => esc_html__( 'Style 01', 'civi' ),
                    'style-02'  => esc_html__( 'Style 02', 'civi' ),
                    'style-03'  => esc_html__( 'Style 03', 'civi' ),
                    'style-04'  => esc_html__( 'Style 04', 'civi' ),
                    'style-05'  => esc_html__( 'Style 05', 'civi' ),
                    'style-06'  => esc_html__( 'Style 06', 'civi' ),
                    'style-07'  => esc_html__( 'Style 07', 'civi' ),
                    'style-08'  => esc_html__( 'Style 08', 'civi' ),
                    'style-09'  => esc_html__( 'Style 09', 'civi' ),
                    'style-10'  => esc_html__( 'Style 10', 'civi' ),
                    'style-11'  => esc_html__( 'Style 11', 'civi' ),
                    'style-12'  => esc_html__( 'Style 12', 'civi' ),
                    'style-13'  => esc_html__( 'Style 13', 'civi' ),
                    'style-14'  => esc_html__( 'Style 14', 'civi' ),
                    'style-15'  => esc_html__( 'Style 15', 'civi' ),
                    'custom' => esc_html__( 'Custom Morphing', 'civi' ),
                ],
            ]
        );
        $repeater->add_control(
            'custom_layouts',
            [
                'label' => esc_html__( 'Custom Morphing Code', 'civi' ),
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'placeholder' => esc_html__( 'Morphing Custom Code', 'civi' ),
                'condition'    => [
                    'layouts' => [ 'custom' ],
                ],
            ]
        ...
        $repeater->add_control(
            'fixed_scroll_alt',
            [
                'label' => esc_html__( 'Fixed Scroll Alternate', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none' => esc_html__( 'Fixed Scroll', 'civi' ),
                    'style-01'  => esc_html__( 'Style 01', 'civi' ),
                    'style-02'  => esc_html__( 'Style 02', 'civi' ),
                    'style-03'  => esc_html__( 'Style 03', 'civi' ),
                    'style-04'  => esc_html__( 'Style 04', 'civi' ),
                ...
                'description' => esc_html__('Note: If, enable (Fixed Scroll) scrolling option used for styles.','civi'),
                'separator' => 'before',
            ]
        );
        $repeater->add_control(
            'custom_layouts_alt',
            [
                'label' => esc_html__( 'Custom Alternate Morphing Code', 'civi' ),
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'placeholder' => esc_html__( 'Morphing Custom Code', 'civi' ),
                'condition'    => [
        ...
        $repeater->start_controls_tab( 'tab_path_option',
            [
                'label' => esc_html__( 'Path', 'civi' ),
            ]
        );
        $repeater->add_control(
            'path_duration',
            [
                'label' => esc_html__( 'Path Duration', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $repeater->add_control(
            'path_elasticity',
            [
                'label' => esc_html__( 'Elasticity', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 10,
        ...
        $repeater->add_control(
            'path_easing',
            [
                'label' => esc_html__( 'Path Easing', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'easeOutElastic',
                'options' => $this->civi_anime_animation(),
            ]
        );
        $repeater->end_controls_tab();
        $repeater->start_controls_tab( 'tab_svg_option',
            [
                'label' => esc_html__( 'SVG', 'civi' ),
            ]
        );
        $repeater->add_control(
            'svg_duration',
            [
                'label' => esc_html__( 'SVG Duration', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $repeater->add_control(
            'svg_easing',
            [
                'label' => esc_html__( 'SVG Easing', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'easeOutElastic',
                'options' => $this->civi_anime_animation(),
            ]
        ...
        $repeater->start_controls_tab( 'tab_fill_option',
            [
                'label' => esc_html__( 'Fill Color', 'civi' ),
            ]
        );
        $repeater->add_control(
            'fill_duration',
            [
                'label' => esc_html__( 'Fill Duration', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 10,
        ...
        $repeater->add_control(
            'fill_easing',
            [
                'label' => esc_html__( 'Fill Easing', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'linear',
                'options' => $this->civi_anime_animation(),
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'no',
                'description' => esc_html__('If, Select "Fixed Scroll" Morphing type then use on Fill Color.','civi'),
            ]
        );
        $repeater->add_control(
            'fill_color',
        ...
        $repeater->add_control(
            'extra_options',
            [
                'label' => esc_html__( 'Additional Options', 'civi' ),
        ...
        $repeater->add_control(
            'trans_x',
            [
                'label' => esc_html__( 'Horizontal Adjust', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => -500,
        ...
        $repeater->add_control(
            'trans_y',
            [
                'label' => esc_html__( 'Vertical Adjust', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => -500,
        ...
        $this->add_control(
            'morphing_loop',
            [
                'label' => esc_html__( 'Svg Morphing Loop', 'civi' ),
        ...
        $this->add_control(
            'morph_type',
            [
                'label' => esc_html__( 'Select Type', 'civi' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'color',
                'options' => [
                    'color'  => esc_html__( 'Color ', 'civi' ),
                    'gradient'  => esc_html__( 'Gradient', 'civi' ),
        ...
        $this->add_control(
            'grad_x1',
            [
                'label' => esc_html__( 'Position X1', 'civi' ),
        ...
        $this->add_control(
            'grad_x2',
            [
                'label' => esc_html__( 'Position X2', 'civi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'grad_y1',
            [
                'label' => esc_html__( 'Position Y1', 'civi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'grad_y2',
            [
                'label' => esc_html__( 'Position Y2', 'civi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'morph_image',
            [
                'label' => esc_html__( 'Masking Image', 'civi' ),
        ...
        $this->add_control(
            'image_x',
            [
                'label' => esc_html__( 'Position X', 'civi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'image_y',
            [
                'label' => esc_html__( 'Position Y', 'civi' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'image_dimension',
            [
                'label' => esc_html__( 'Image Dimension', 'civi' ),
                'type' => Controls_Manager::IMAGE_DIMENSIONS,
                'description' => esc_html__( 'Set custom width or height to keep the original size ratio.', 'civi' ),
                'default' => [
                    'width' => '',
                    'height' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'On', 'civi' ),
                'label_off' => esc_html__( 'Off', 'civi' ),
                'default' => 'no',
                'separator' => 'before',
                'condition'    => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '.civi-morph-fixed-scroll-bg.morph-fixed-{{ID}}',
                'condition'    => [
                    'morph_layout' => [ 'fixed_scroll' ],
    ...
    private function add_content_style_section()
    {
        ...
        $this->add_control(
            'hover_path',
            [
                'label' => esc_html__( 'Morphing Change Hover', 'civi' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'civi' ),
                'label_off' => esc_html__( 'No', 'civi' ),
                'separator' => 'before',
        ...
        $this->add_control(
            'duration',
            [
                'label' => esc_html__( 'Duration', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $this->start_controls_section(
            'masking_image_style',
            [
                'label' => esc_html__( 'Image Style', 'civi' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'    => [
                    'morph_type' => [ 'image' ],
                ],
        ...
        $this->add_control(
            'image_duration',
            [
                'label' => esc_html__( 'Image Duration', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $this->add_control(
            'image_elasticity',
            [
                'label' => esc_html__( 'Image Elasticity', 'civi' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 0,
        ...
        $this->add_control(
            'image_on_hover',
            [
                'label' => esc_html__( 'Image Hover', 'civi' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'civi' ),
                'label_off' => esc_html__( 'No', 'civi' ),
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Custom SVG from Blob Maker?', 'civi' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'civi' ),
                'label_off' => esc_html__( 'No', 'civi' ),
                'default' => 'no',
        ...
        $this->add_control(
            'morphing_overflow',
            [
                'label' => esc_html__( 'Overflow Morphing', 'civi' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Hidden', 'civi' ),
                'label_off' => esc_html__( 'Default', 'civi' ),
                'default' => 'hidden',
                'return_value' => 'hidden',
                'selectors' => [
                    '.civi-morphing-svg-wrapper.morph-{{ID}}' => 'overflow: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
            ...
            foreach ( $settings['morphing_loop'] as $index => $item ) :
                ...
                if($item["layouts"]!='custom'){
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                        $json_arr["path"][]=$this->civi_morphing_style($item["layouts"]);
                    }else if($i==0){
                        $first_morph=$this->civi_morphing_style($item["layouts"]);
                    }
                    $morph_style='yes';
                }else{
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                ...
                if($item["fixed_scroll_alt"]!='custom' && $item["fixed_scroll_alt"]!='none'){
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                        $json_arr["pathAlt"][]=$this->civi_morphing_style($item["fixed_scroll_alt"]);
                    }else if($i==0){
                        $first_morph_alt=$this->civi_morphing_style($item["fixed_scroll_alt"]);
                    }
        ...
        $output ='<div class="civi-morphing-svg-wrapper '.$data_class.'" id="'.esc_attr($uid).'" '.$data_attr.' data-morph=\'' . $json_array . '\' data-morphimage=\''.$image_json_array.'\'>';
        ...
        if(!empty($settings['morph_fixed_scroll_bg']) && $settings['morph_fixed_scroll_bg']=='yes' && $settings['morph_layout']=='fixed_scroll'){
            $output .='<div class="civi-morph-fixed-scroll-bg morph-fixed-'.esc_attr($this->get_id()).'" id="fixed'.esc_attr($uid).'" data-id="fixed'.esc_attr($uid).'" data-morph-fixed="morph-fixed-'.esc_attr($this->get_id()).'"></div>';
        }
        echo $output;
    }

    protected function civi_morphing_style($style=''){
        $output='';
        if($style=='style-01'){
    ...
    protected function civi_anime_animation(){
        return array(
            'linear'  => esc_html__( 'Linear', 'civi' ),
            'easeOutQuad'  => esc_html__( 'Ease-Out Quad', 'civi' ),
            'easeInQuad'  => esc_html__( 'Ease-In Quad', 'civi' ),
            'easeInOutQuad'  => esc_html__( 'Ease-InOut Quad', 'civi' ),

            'easeOutCubic'  => esc_html__( 'Ease-Out Cubic', 'civi' ),
            'easeInCubic'  => esc_html__( 'Ease-In Cubic', 'civi' ),
            'easeInOutCubic'  => esc_html__( 'Ease-InOut Cubic', 'civi' ),

            'easeOutQuart'  => esc_html__( 'Ease-Out Quart', 'civi' ),
            'easeInQuart'  => esc_html__( 'Ease-In Quart', 'civi' ),
            'easeInOutQuart'  => esc_html__( 'Ease-InOut Quart', 'civi' ),

            'easeOutQuint'  => esc_html__( 'ease-Out Quint', 'civi' ),
            'easeInQuint'  => esc_html__( 'ease-In Quint', 'civi' ),
            'easeInOutQuint'  => esc_html__( 'ease-InOut Quint', 'civi' ),

            'easeOutSine'  => esc_html__( 'Ease-Out Sine', 'civi' ),
            'easeInSine'  => esc_html__( 'Ease-In Sine', 'civi' ),
            'easeInOutSine'  => esc_html__( 'Ease-InOut Sine', 'civi' ),

            'easeOutExpo'  => esc_html__( 'Ease-Out Expo', 'civi' ),
            'easeInExpo'  => esc_html__( 'Ease-In Expo', 'civi' ),
            'easeInOutExpo'  => esc_html__( 'Ease-InOut Expo', 'civi' ),

            'easeOutElastic'  => esc_html__( 'Ease-Out Elastic', 'civi' ),
            'easeInElastic'  => esc_html__( 'Ease-In Elastic', 'civi' ),
            'easeInOutElastic'  => esc_html__( 'Ease-InOut Elastic', 'civi' ),

            'easeOutCirc'  => esc_html__( 'Ease-Out Circ', 'civi' ),
            'easeInCirc'  => esc_html__( 'Ease-In Circ', 'civi' ),
            'easeInOutCirc'  => esc_html__( 'Ease-InOut Circ', 'civi' ),

            'easeOutBack'  => esc_html__( 'Ease-Out Back', 'civi' ),
            'easeInBack'  => esc_html__( 'Ease-In Back', 'civi' ),
            'easeInOutBack'  => esc_html__( 'Ease-InOut Back', 'civi' ),

            'easeOutBounce'  => esc_html__( 'Ease-Out Bounce', 'civi' ),
            'easeInBounce'  => esc_html__( 'Ease-In Bounce', 'civi' ),
            'easeInOutBounce'  => esc_html__( 'Ease-InOut Bounce', 'civi' ),
        );
    }
}