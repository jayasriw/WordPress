...
class Widget_Utils
{
	...
	{
		return [
			'guest' => esc_html__('Guest', 'civi'),
			'logged_in' => esc_html__('Logged In User', 'civi'),
			'civi_user_candidate' => esc_html__('Candidate', 'civi'),
			'civi_user_candidate_has_package' => esc_html__('Candidate Has Package', 'civi'),
			'civi_user_candidate_no_package' => esc_html__('Candidate No Package', 'civi'),
			'civi_user_employer' => esc_html__('Employer', 'civi'),
			'civi_user_employer_has_package' => esc_html__('Employer Has Package', 'civi'),
			'civi_user_employer_no_package' => esc_html__('Employer No Package', 'civi'),
			'administrator' => esc_html__('Administrator', 'civi'),
		];
	}
	...
	public static function check_user_has_package($user_id)
	{
		if (class_exists('Civi_Package')) {
			...
			if (method_exists($civi_package, 'get_active_package_info')) {
				$package_info = $civi_package->get_active_package_info($user_id);
