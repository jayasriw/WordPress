...
// Search Settings
Civi_Kirki::add_section('search_settings', array(
	'title'    => esc_html__('Search Settings', 'civi'),
	'priority' => 120,
	'panel'    => $panel,
));
...
Civi_Kirki::add_field('theme', [
	...
	'label'       => esc_html__('Enable MySQL FULLTEXT Search', 'civi'),
	'description' => esc_html__('Enable this to use MySQL FULLTEXT index for significantly faster search performance on large sites. Note: You must create the index first via the admin notice. This method might ignore words shorter than 4 characters depending on your server configuration.', 'civi'),
	'section'     => 'search_settings',
	'default'     => $default['enable_fulltext_search'],
	'choices'     => [
		'on'  => esc_html__('On', 'civi'),
		'off' => esc_html__('Off', 'civi'),
	],
]);
