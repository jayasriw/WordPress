...
$metro_item_count   = 0;
$count              = $jobportal_query->post_count;

while ($jobportal_query->have_posts()) : $jobportal_query->the_post();
...
?>
	<div <?php post_class(implode(' ', $classes)); ?> data-width="<?php echo esc_attr($ratioW); ?>" data-height="<?php echo esc_attr($ratioH); ?>">
		<div class="post-wrapper jobportal-box">
			<div class="post-thumbnail-wrapper jobportal-image grid-item-height">

				<div class="post-thumbnail">
					<a href="<?php the_permalink(); ?>">
						<?php if (has_post_thumbnail()) { ?>
							<?php
							JobPortal_Image::the_post_thumbnail(array(
								'size'   => 'custom',
								'width'  => $_image_width,
							...
							?>
						<?php } else { ?>
							<?php JobPortal_Templates::image_placeholder(480, 480); ?>
						<?php } ?>
					</a>
				</div>
