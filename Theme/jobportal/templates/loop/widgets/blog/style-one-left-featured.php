...
?>
<?php while ($jobportal_query->have_posts()) : $jobportal_query->the_post(); ?>
	<?php if ($loop_count === 0) : ?>
		<?php ob_start(); ?>
			...
			<div class="post-wrapper jobportal-box">
				<div class="post-feature post-thumbnail jobportal-image">
					<a href="<?php the_permalink(); ?>" class="link-secret">
						<?php \JobPortal_Image::the_post_thumbnail([
							'size' => '570x330',
						]); ?>
				...
				<div class="post-caption">
					...
					<div class="post-excerpt">
						<?php JobPortal_Templates::excerpt(array(
							'limit' => 20,
							'type'  => 'word',
						)); ?>
					</div>
					...
					<?php
					$read_more_text = !empty($settings['read_more_text']) ? $settings['read_more_text'] : esc_html__('Read more', 'jobportal');

					JobPortal_Templates::render_button([
						'style'         => 'bottom-line',
						'text'          => $read_more_text,
...
<div class="row row-no-gutter">
	<div class="col-md-6 featured-post">
		<?php JobPortal_Helper::e($left_box_template); ?>
	</div>
	<div class="col-md-6 normal-posts">
		<?php JobPortal_Helper::e($right_box_template); ?>
	</div>
</div>