				...
				<div class="inner">
					<?php if (in_array('author', $meta, true)) : ?>
						<div class="post-author">
							<span><?php esc_html_e('by', 'jobportal'); ?></span>
						...
						<div class="post-comment">
							<span>
								...
								if ('1' === $comments_number) {
									...
									printf(_x('One Comment', 'comments title', 'jobportal'), get_the_title());
								} else {
									printf(
	...
	<?php if ('yes' === $settings['show_caption_read_more']) : ?>
		<div class="post-footer">
			<?php if ('yes' === $settings['show_caption_read_more']) : ?>
				...
				<!-- button readmore -->
				<div class="btn-readmore jobportal-button button-border-bottom">
					<a href="<?php the_permalink(); ?>">
						<?php esc_html_e($read_more_text); ?>
					</a>
				</div>
			<?php endif; ?>
		</div>
