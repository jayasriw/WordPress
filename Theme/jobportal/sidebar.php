...
<aside id="secondary" class="widget-area">
	...
	<div class="widget-area-init">
		...
		if (is_single() && (get_post_type() == 'jobs')) :
			do_action('jobportal_single_jobs_sidebar');
		endif;
		?>
		<?php
		if (is_single() && (get_post_type() == 'company')) :
			do_action('jobportal_single_company_sidebar');
		endif;
		?>
		<?php
		if (is_single() && (get_post_type() == 'candidate')) :
			do_action('jobportal_single_candidate_sidebar');
		endif;
		?>
		<?php
		if (is_single() && (get_post_type() == 'service')) :
			do_action('jobportal_single_service_sidebar');
		endif;
		?>
