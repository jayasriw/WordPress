...
JobPortal_Kirki::add_section($section, array(
	'title'    => esc_html__('Typography', 'jobportal'),
	'priority' => 20,
));
...
JobPortal_Kirki::add_field('theme', [
	...
	'label'    => esc_html__('Body Font', 'jobportal'),
	'section'  => $section,
]);
...
JobPortal_Kirki::add_field('theme', [
	...
	'label'     => esc_html__('Body Font Type', 'jobportal'),
	'section'   => $section,
	'transport' => 'auto',
	'default'   => array(
...
JobPortal_Kirki::add_field('theme', [
	...
	'label'     => esc_html__('Heading Font Type', 'jobportal'),
	'section'   => $section,
	'transport' => 'auto',
	'default'   => array(
	...
	'output' => [
		[
			'element' => 'h1,h2,h3,h4,h5,h6,.block-heading .entry-title,.jobportal-filter-toggle>span',
		],
	],
]);