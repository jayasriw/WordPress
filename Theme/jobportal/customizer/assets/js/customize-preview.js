(function ($) {
	...
	wp.customize("text_color", function (value) {
		...
		value.bind(function (newval) {
			// Add CSS to elements.
			var color_element =
				"body,.woocommerce nav.woocommerce-pagination ul li .page-numbers,.posts-pagination ul li .page-numbers,.archive .block-heading.category-heading .entry-result,.jobportal-menu-filter ul.filter-control a,.woocommerce div.product .woocommerce-product-rating a,.woocommerce div.product div.summary .product_meta > span span,.woocommerce div.product div.summary .product_meta > span a";
			$(color_element).css("color", newval);
		});
	});
	...
	wp.customize("accent_color", function (value) {
		...
		value.bind(function (newval) {
			// Add CSS to elements.
			var color_element =
				".popup-booking .list-group li.jobs-name a strong,.account .user-control li.active a,.accent-color,.jobportal-marker .jobs-rating,.jobportal-nav-filter.active .jobportal-clear-filter,.jobs-item .btn-add-to-wishlist.added i,.agent-manager .agent-nav ul li.active a,.woocommerce .checkout.woocommerce-checkout #order_review table tfoot tr.order-total td .amount,.woocommerce-info a.showcoupon,.woocommerce .woocommerce-message a.button, .woocommerce .woocommerce-info a.button, .woocommerce .woocommerce-error a.button,.minicart .top-mb-menu .your-cart a .cart-count,.widget_categories li,.single-jobs .jobs-thumbnails.type-1 .single-jobs-thumbs .jobs-meta > div .rating-count,.author-rating .star.checked i,.single-jobs .site-layout.type-1 .jobs-map > a .redirect,.single-jobs .jobs-content a,.single-jobs .site-layout.type-1 .jobs-amenities .hidden-amenities > a,.single-jobs .single-jobs-thumbs .entry-nav .btn-add-to-wishlist.added,.dropdown-select ul li.active a,header.site-header .right-header .minicart a.toggle span.cart-count,.archive .nav-categories .entry-categories ul li.active a,.jobs-item .jobs-preview .jobs-rating,.single-jobs .jobs-reviews .entry-heading .rating-count,.woocommerce #reviews #review_form_wrapper .comment-form-rating .stars a,.woocommerce #reviews #comments ol.commentlist .star-rating > span, div.elementor-slick-slider ul.slick-dots li.slick-active button:before,.jobportal-swiper .swiper-pagination-bullet:hover, .jobportal-swiper .swiper-pagination-bullet.swiper-pagination-bullet-active,.single-jobs .site-layout .jobs-meta > div .rating-count,.jobs-menu .toggle-desc a,.jobs-reviews .login-for-review a,.archive-layout.layout-column .entry-center a.active, .archive-layout.layout-top-filter .entry-center a.active";
			var pseudo_element =
				".jobportal-table td.jobs-control a:hover,.jobportal-jobs-multi-step .jobportal-steps .listing-menu li a:hover,.jobs-item.layout-02 .entry-head .jobs-city a:hover,.jobs-item.layout-03 .entry-head .jobs-city a:hover,.woocommerce-error:before,.woocommerce nav.woocommerce-pagination ul li .page-numbers:hover, .posts-pagination ul li .page-numbers:hover, .woocommerce nav.woocommerce-pagination ul li .page-numbers:focus, .posts-pagination ul li .page-numbers:focus,.archive-post .post .post-meta .post-author a:hover,.product-quantity .btn-quantity:hover i,a:hover,.slick-arrow:hover,.widget_calendar tbody tr > td:hover,.widget ul > li a:hover,.city-item .entry-detail a:hover,input:checked ~ label:before,.woocommerce-info:before, label:hover:before, label:hover ~ label:before,.jobportal-filter-toggle:hover,.single-jobs .jobs-reviews .reviews-list .entry-nav a:hover, .jobportal-clear-filter:hover, .jobportal-filter-toggle.active, .jobportal-clear-filter.active,.jobs-search .btn-close:hover,.archive .nav-categories .entry-categories ul li a:hover,.archive .nav-categories .entry-categories ul li a:hover,.single-jobs .entry-categories a:hover,.jobs-item .jobs-title a:hover,.woocommerce div.product div.summary .product_meta > span a:hover,.product-quantity .btn-quantity:hover svg path,a.customize-unpreviewable:hover,.account a:hover,.mobile-menu .menu li a:hover,.archive-post .post .post-title a:hover,.single .post .inner-post-wrap .post-author .head-author .entry-title a:hover,.single .post .inner-post-wrap .post-meta .post-author a:hover,.single .post .inner-post-wrap .post-categories a:hover,.archive-post .post .post-categories li a:hover,.woocommerce .products .product .entry-detail .product-title .entry-title a:hover";
			var pseudo_bg_element =
				".jobportal-ldef-spinner span:after,.jobportal-ldef-roller span:after,.jobportal-ldef-heart span:after,.jobportal-ldef-heart span:before,.woocommerce .wc-proceed-to-checkout a.checkout-button:hover,.woocommerce .checkout.woocommerce-checkout #order_review #payment .jobs-order .button:hover,.archive-post .post .btn-readmore a:after,.archive .nav-categories .entry-categories ul li a:after,.archive .nav-categories .entry-categories ul li a:hover:after,.archive .nav-categories .entry-categories ul li.active a:after,.woocommerce nav.woocommerce-pagination ul li .page-numbers.current:hover, .posts-pagination ul li .page-numbers.current:hover";
			var bg_element =
				".filter-jobs-search .btn-close,.archive-layout.layout-column .top-area .entry-right .btn-maps-filter a,.jobportal-page-title.layout-column.layout-01 .entry-detail,.jobportal-ldef-grid span,.jobportal-ldef-ellipsis span,.jobportal-ldef-default span,.jobportal-ldef-heart span,.jobportal-ldef-facebook span,.jobportal-ldef-circle > span,.woocommerce .wc-proceed-to-checkout a.checkout-button,.jobportal-pagination .page-numbers.current,.gl-button, .wpcf7-submit,.minicart .woocommerce-mini-cart__buttons a.elementor-button--checkout, .minicart .elementor-menu-cart__footer-buttons a.elementor-button--checkout,.widget_calendar caption,.widget_calendar tbody tr > td#today,.newsletter-area .submit-control,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.single-jobs .jobs-booking a.gl-button,.woocommerce nav.woocommerce-pagination ul li .page-numbers.current, .posts-pagination ul li .page-numbers.current, .woocommerce span.onsale,.woocommerce #respond input#submit, .woocommerce button.button, .woocommerce input.button,.woocommerce div.product form.cart .button,.btn-civi,.jobportal-button a,.woocommerce .products .product .entry-detail .button.add_to_cart_button, .woocommerce .products .product .entry-detail .button.product_type_external, .woocommerce .products .product .entry-detail .button.product_type_grouped, .woocommerce .products .product .entry-detail .button.product_type_variation,.block-search.layout-02 .location-field .icon-search, .block-search.layout-03 .location-field .icon-search, .block-search.layout-02 .type-field .icon-search, .block-search.layout-03 .type-field .icon-search,.jobportal-pagination .pagination.loadmore .page-numbers,.inner-content.has-map .btn-control .slider, .nav-bar.has-map .btn-control .slider";
			var border_element =
				".filter-jobs-search .btn-close,.archive-layout.layout-column .top-area .entry-right .btn-maps-filter a,.jobportal-jobs-multi-step .jobportal-steps .listing-menu li.active a,.jobportal-ldef-ripple span,.woocommerce .inner-action-form .coupon input,.gl-button, .wpcf7-submit,.jobs-manager-form .form-group .form-control, .jobs-manager-form .form-group .chosen-choices:focus, .jobportal-my-profile .form-group input.form-control:focus,.minicart .woocommerce-mini-cart__buttons a.elementor-button--checkout, .minicart .elementor-menu-cart__footer-buttons a.elementor-button--checkout,.woocommerce #respond input#submit, .woocommerce a.button, .woocommerce button.button, .woocommerce input.button,.woocommerce-info,.post-categories li a, .single-jobs .entry-categories a, .single-jobs .entry-categories span,.single-jobs .jobs-booking a.gl-button,.woocommerce #respond input#submit, .woocommerce button.button, .woocommerce input.button,.woocommerce div.product form.cart .button,.btn-civi,.archive-post .post .post-categories li,.jobportal-button a,.single .post .inner-post-wrap .post-categories a,.woocommerce .products .product .entry-detail .button.add_to_cart_button,.woocommerce .products .product .entry-detail .button.product_type_external, .woocommerce .products .product .entry-detail .button.product_type_grouped, .woocommerce .products .product .entry-detail .button.product_type_variation,.jobportal-pagination .pagination.loadmore .page-numbers";
			$(color_element).css("color", newval);
			...
			pseudoStyle(
				".woocommerce button.button:hover,.gl-button, .wpcf7-submit,.minicart .woocommerce-mini-cart__buttons a.elementor-button--checkout, .minicart .elementor-menu-cart__footer-buttons a.elementor-button--checkout,.single-jobs .jobs-booking a.gl-button:hover,.woocommerce #respond input#submit:hover, .woocommerce button.button:hover, .woocommerce input.button:hover,.woocommerce div.product form.cart .button:hover,.btn-civi:hover,.jobportal-button a:hover,.woocommerce .products .product .entry-detail .button.add_to_cart_button:hover, .woocommerce .products .product .entry-detail .button.product_type_external:hover, .woocommerce .products .product .entry-detail .button.product_type_grouped:hover, .woocommerce .products .product .entry-detail .button.product_type_variation:hover",
				"{ background: transparent!important;color:" + newval + "}"
			);
			pseudoStyle(
				".jobportal-dual-ring:after,.jobportal-ldef-hourglass:after,.jobportal-ldef-dual-ring:after",
				"{ border-color: " + newval + " transparent " + newval + " transparent}"
			);
			pseudoStyle(
				".jobportal-ldef-ring span",
				"{ border-color: " + newval + " transparent transparent transparent}"
			);
			pseudoStyle(
				".jobportal-page-title.layout-column.block-left .entry-detail .after-image svg use",
				"{ fill: " + newval + "}"
			);
			pseudoStyle(
