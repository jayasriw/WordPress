(function ($) {
	...
	$.fn.JobPortalSwiper = function (options) {
		var defaults = {};
		...
		this.each(function () {
			...
			if (sliderSettings.nav) {
				...
				if (sliderSettings.customNav && sliderSettings.customNav !== "") {
					...
					var uniqueId = "jobportal-swiper-' + Math.random().toString(36).substr(2, 5);
			...
			$(document).trigger("JobPortalSwiperInit", [$swiper, $slider, swiperOptions]);
		});
