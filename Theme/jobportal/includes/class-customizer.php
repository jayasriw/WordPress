	...
	public function wp_default_custom_scripts($scripts)
	{
		if (is_admin()) {
			...
			did_action('init') && $scripts->localize(
				...
				'wpColorPickerL10n',
				array(
					'clear'            => __('Clear', 'jobportal'),
					'clearAriaLabel'   => __('Clear color', 'jobportal'),
					'defaultString'    => __('Default', 'jobportal'),
					'defaultAriaLabel' => __('Select default color', 'jobportal'),
					'pick'             => __('Select Color', 'jobportal'),
					'defaultLabel'     => __('Color value', 'jobportal'),
				)
			);
		}
	}
