...
class AdminSecurityHandler
{
    ...
    public function create_custom_user_role()
    {
        if (!get_role('restricted_user')) {
            add_role('restricted_user', __('Restricted User', 'jobportal'), array(
                'read' => true,
                'edit_posts' => false,
                'upload_files' => true,
                'edit_pages' => false,
    ...
    public function add_redirect_notice_script()
    {
        ...
        $message = apply_filters(
            ...
            sprintf(__('Hello %s! You do not have permission to access the admin area.', 'jobportal'), $user_display_name)
        );
