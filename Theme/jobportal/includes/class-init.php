...
class JobPortal_Init
{
	...
	function __construct()
	{
		...
		new JobPortal_Helper();

		// class JobPortal_Enqueue
		new JobPortal_Enqueue();

		// class JobPortal_Kirki
		new JobPortal_Kirki();

		// class JobPortal_Customizer
		new JobPortal_Customizer();

		// class JobPortal_Ajax
		new JobPortal_Ajax_Include();
	...
	public function register_nav_menus()
	{
		...
		register_nav_menus([
			...
			"main_menu" => esc_html__("Main Menu", "jobportal"),
			"mobile_menu" => esc_html__("Mobile Menu", "jobportal"),
		]);
	}
	...
	{
		load_theme_textdomain("jobportal", JOBPORTAL_THEME_DIR . "/languages");
	}
	...
	function widgets_init()
	{
		register_sidebar([
			"id" => "sidebar",
			"name" => esc_html__("Sidebar", "jobportal"),
			"description" => esc_html__("Add widgets here.", "jobportal"),
		...
		register_sidebar([
			"id" => "jobs_sidebar",
			"name" => esc_html__("Jobs Sidebar", "jobportal"),
			"description" => esc_html__("Add widgets here.", "jobportal"),
			"before_widget" => '<section id="%1$s" class="widget %2$s">',
			"after_widget" => "</section>",
			"before_title" => '<h3 class="widget-title">',
		...
		register_sidebar([
			"id" => "company_sidebar",
			"name" => esc_html__("Company Sidebar", "jobportal"),
			"description" => esc_html__("Add widgets here.", "jobportal"),
			"before_widget" => '<section id="%1$s" class="widget %2$s">',
			"after_widget" => "</section>",
			"before_title" => '<h3 class="widget-title">',
		...
		register_sidebar(array(
			...
			'name'          => esc_html__('Candidate Sidebar', 'jobportal'),
			'description'   => esc_html__('Add widgets here.', 'jobportal'),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h3 class="widget-title">',
		...
		register_sidebar(array(
			'id'            => 'service_sidebar',
			'name'          => esc_html__('Service Sidebar', 'jobportal'),
			'description'   => esc_html__('Add widgets here.', 'jobportal'),
			'before_widget' => '<section id="%1$s" class="widget %2$s">',
			'after_widget'  => '</section>',
			'before_title'  => '<h3 class="widget-title">',
	...
	function recaptcha_styling()
	{
		...
		if ($enable_captcha === '1' && $recaptcha_version === 'v3') {
			...
			echo '<style id="jobportal-recaptcha-styling">';
			if ($hide_badge === '1') {
