...
$has_page_title = true;
$layout_sidebar = JobPortal_Helper::get_setting('layout_sidebar');
$elementor_page = get_post_meta(get_the_ID(), '_elementor_edit_mode', true);

if (!empty($elementor_page) || is_page('cart') || is_page('checkout') || JobPortal_Helper::jobportal_page_shortcode('[jobportal_packages]') || JobPortal_Helper::jobportal_page_shortcode('[jobportal_payment]') || JobPortal_Helper::jobportal_page_shortcode('[jobportal_payment_completed]')) {
