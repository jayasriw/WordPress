...
$blog_content_layout = JobPortal_Helper::get_setting("blog_content_layout");
$blog_number_column = JobPortal_Helper::get_setting("blog_number_column");
$blog_sidebar = JobPortal_Helper::get_setting("blog_sidebar");
$blog_enable_categories = JobPortal_Helper::get_setting("blog_enable_categories");
...
<?php echo JobPortal_Templates::page_title(); ?>
		...
		<div class="site-layout <?php echo join(" ", $sidebar_classes); ?>">
			...
			<div id="primary" class="content-area">
				...
				<?php if ($blog_enable_categories) :
					echo JobPortal_Templates::post_categories();
				endif; ?>
				...
				<main id="main" class="site-main">
					...
					<?php if (have_posts()) : ?>
						...
						<?php echo JobPortal_Templates::pagination(); ?>
