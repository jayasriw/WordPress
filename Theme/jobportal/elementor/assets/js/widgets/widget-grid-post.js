(function ($) {
	...
	var JobPortalGridDataHandler = function ($scope, $) {
	...
	$(window).on("elementor/frontend/init", function () {
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/jobportal-blog.default",
			JobPortalGridDataHandler
		);
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/jobportal-product.default",
			JobPortalGridDataHandler
		);
	});
})(jQuery);
