(function ($) {
	...
	var JobPortalFlipBoxHandler = function ($scope, $) {
		var $element = $scope.find(".jobportal-flip-box");
	...
	$(window).on("elementor/frontend/init", function () {
		elementorFrontend.hooks.addAction(
			"frontend/element_ready/jobportal-flip-box.default",
			JobPortalFlipBoxHandler
		);
	});
})(jQuery);
