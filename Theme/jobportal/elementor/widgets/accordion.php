...
class Widget_Accordion extends Base
{
	...
	{
		return "jobportal-accordion';
	}

	public function get_title()
	{
		return esc_html__('Modern Accordion/Toggle', 'jobportal');
	}
	...
	{
		return ["jobportal-widget-accordion'];
	}

    public function get_style_depends()
    {
        return ["jobportal-el-widget-accordion'];
    }
	...
	private function add_content_section()
	{
		$this->start_controls_section('content_section', [
			'label' => esc_html__('Items', 'jobportal'),
		]);
		...
		$this->add_control('style', [
			...
			'prefix_class' => "jobportal-accordion-style-',
		]);
		...
		$this->add_control('type', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'accordion' => esc_html__('Accordion', 'jobportal'),
				'toggle'    => esc_html__('Toggle', 'jobportal'),
			],
			'default' => 'accordion',
		]);

		$this->add_control('active_first_item', [
			'label'              => esc_html__('Active First Item', 'jobportal'),
		...
		$repeater->add_control('title', [
			...
			'default'     => esc_html__('Accordion Title', 'jobportal'),
			'label_block' => true,
			'dynamic'     => [
				'active' => true,
			],
		...
		$repeater->add_control('content', [
			...
			'default' => esc_html__('Accordion Content', 'jobportal'),
		]);
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					'title'   => esc_html__('Accordion #1', 'jobportal'),
					'content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'jobportal'),
				],
				[
					'title'   => esc_html__('Accordion #2', 'jobportal'),
					'content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'jobportal'),
				],
				[
					'title'   => esc_html__('Accordion #3', 'jobportal'),
					'content' => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'jobportal'),
				],
			],
			'title_field' => '{{{ title }}}',
		...
		$this->add_control('active_icon', [
			'label'       => esc_html__('Active Icon', 'jobportal'),
			'type'        => Controls_Manager::ICONS,
			'default'     => [
	...
	private function add_icon_style_section()
	{
		...
		$this->add_control('icon_align', [
			...
			'options' => [
				'left'  => [
					'title' => esc_html__('Start', 'jobportal'),
					'icon'  => 'eicon-h-align-left',
				],
				'right' => [
					'title' => esc_html__('End', 'jobportal'),
		...
		$this->start_controls_tab('icon_active_color_tab', [
			'label' => esc_html__('Active', 'jobportal'),
		]);
		...
		$this->add_responsive_control('icon_size', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-accordion .accordion-icons' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_responsive_control('icon_space', [
			...
			'selectors' => [
				'body:not(.rtl) {{WRAPPER}} .jobportal-accordion.jobportal-accordion-icon-right .accordion-icons' => 'margin: 0 0 0 {{SIZE}}{{UNIT}};',
				'body:not(.rtl) {{WRAPPER}} .jobportal-accordion.jobportal-accordion-icon-left .accordion-icons'  => 'margin: 0 {{SIZE}}{{UNIT}} 0 0;',
				'body.rtl {{WRAPPER}} .jobportal-accordion.jobportal-accordion-icon-right .accordion-icons'       => 'margin: 0 {{SIZE}}{{UNIT}} 0 0;',
				'body.rtl {{WRAPPER}} .jobportal-accordion.jobportal-accordion-icon-left .accordion-icons'        => 'margin: 0 0 0 {{SIZE}}{{UNIT}};',
			],
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-accordion');
		...
		if ($has_icon) {
			$this->add_render_attribute('wrapper', 'class', "jobportal-accordion-icon-' . $settings['icon_align']);
		}
?>
	...
	protected function content_template()
	{
		// @formatter:off
	?>
		<# var iconHTML=elementor.helpers.renderIcon( view, settings.icon, { 'aria-hidden' : true }, 'i' , 'object' ); var iconActiveHTML=elementor.helpers.renderIcon( view, settings.active_icon, { 'aria-hidden' : true }, 'i' , 'object' ); view.addRenderAttribute( 'wrapper' , 'class' , "jobportal-accordion' ); if ( 'toggle'===settings.type ) { view.addRenderAttribute( 'wrapper' , 'data-multi-open' , '1' ); } if ( iconHTML.rendered ) { view.addRenderAttribute( 'wrapper' , 'class' , "jobportal-accordion-icon-' + settings.icon_align); } var loopCount=0; #>
