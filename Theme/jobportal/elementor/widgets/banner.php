...
class Widget_Banner extends Base
{
	...
	{
		return "jobportal-banner';
	}

	public function get_title()
	{
		return esc_html__('Banner', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-banner'];
    }
	...
	private function add_layout_section()
	{
		...
		$this->add_control('size_mode', [
			'label' => esc_html__('Size Mode', 'jobportal'),
			'type' => Controls_Manager::SELECT,
			'options' => [
				'custom-mode' => esc_html__('Custom Mode', 'jobportal'),
				'custom-height' => esc_html__('Custom Height', 'jobportal'),
			],
		...
		$this->add_responsive_control(
			'size_width',
			[
				'label' => esc_html__('Custom Width', 'jobportal'),
				...
				'selectors' => [
					'{{WRAPPER}} .jobportal-banner-bg ' => '--jobportal-custom-width: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			'size_height',
			[
				'label' => esc_html__('Custom Height', 'jobportal'),
				'type' => Controls_Manager::NUMBER,
				'default' => 1,
				'min' => 1,
				'condition' => [
				...
				'selectors' => [
					'{{WRAPPER}} .jobportal-banner-bg ' => 'padding-bottom:calc(({{VALUE}}/var(--jobportal-custom-width))*100%)',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .jobportal-banner-bg ' => 'height: {{VALUE}}px',
				],
			]
		);
	...
	private function add_content_section()
	{
		...
		$this->add_control('title_size', [
			'label'   => esc_html__('Title HTML Tag', 'jobportal'),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'h1'   => 'H1',
				'h2'   => 'H2',
		...
		$this->add_control('sub_title', [
			'label'       => esc_html__('Sub Title', 'jobportal'),
			'type'        => Controls_Manager::TEXT,
			'default'     => esc_html__('Sub Heading', 'jobportal'),
		]);

		$this->add_control('description', [
			'label' => esc_html__('Description', 'jobportal'),
			'default' => esc_html__('Description on the Banner', 'jobportal'),
	...
	private function add_button_settings_section()
	{
		...
		$this->add_control('button_text', [
			...
			'default'     => esc_html__('Click here', 'jobportal'),
		]);
	...
	private function add_box_style_section()
	{
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jobportal-box .content',
			]
		);
		...
		$this->add_responsive_control('box_padding', [
			...
			'size_units' => ['px', '%', 'em'],
			'selectors'  => [
				'{{WRAPPER}} .jobportal-box .content' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
		...
		$this->add_responsive_control('box_max_width', [
			...
			'selectors'  => [
				'{{WRAPPER}} .jobportal-box .content' => 'max-width: {{SIZE}}{{UNIT}};',
			],
		]);
	...
	private function add_content_style_section()
	{
		...
		$this->add_control('title_hover_color', [
			'label'     => esc_html__('Hover Color', 'jobportal'),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'selectors' => [
	...
	private function add_button_style_section()
	{
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'selector' => '{{WRAPPER}} .jobportal-button .button-text',
		]);
		...
		$this->add_control('button_line_color', [
			...
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
				'{{WRAPPER}} .jobportal-button.button-border-bottom:after' => 'background: {{VALUE}};',
			],
			'condition' => [
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'hover_text',
			'selector' => '{{WRAPPER}} .jobportal-button:hover .button-text',
		]);
		...
		$this->add_control('button_style_spacing', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-button-wrapper'  => 'margin-top: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_control('button_style_height', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-button'  => 'min-height: {{SIZE}}{{UNIT}};',
				'{{WRAPPER}} .jobportal-button'  => 'line-height: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_responsive_control('button_style_border_radius', [
			...
			'size_units' => ['px', '%', 'em'],
			'selectors'  => [
				'{{WRAPPER}} .jobportal-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
		...
		$this->add_control('icon_indent', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-button.icon-left .button-icon'  => 'margin-right: {{SIZE}}{{UNIT}};',
				'{{WRAPPER}} .jobportal-button.icon-right .button-icon' => 'margin-left: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_responsive_control('icon_font_size', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-button .button-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'icon',
			'selector' => '{{WRAPPER}} .jobportal-button .button-icon',
		]);
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'icon_hover',
			'selector' => '{{WRAPPER}} .jobportal-button:hover .button-icon',
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-banner jobportal-box');
		...
		if ($settings['image']['url'] !== '') {
			...
			$this->add_render_attribute('bg_attr', array(
				'class' => "jobportal-banner-bg image',
				'style' => $bg_style,
			));
		} ?>
	...
	private function print_button(array $settings)
	{
		...
		$this->add_render_attribute('wrapper-buttton', 'class', "jobportal-button-wrapper');
		...
		$this->add_render_attribute('button', 'class', "jobportal-button');
