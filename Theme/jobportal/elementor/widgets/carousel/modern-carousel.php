...
class Widget_Modern_Carousel extends Carousel_Base
{
	...
	{
		return "jobportal-modern-carousel';
	}

	public function get_title()
	{
		return esc_html__('Modern Carousel', 'jobportal');
	}
	...
	{
		return ["jobportal-el-widget-modern-carousel'];
	}
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-modern-carousel');
?>
	...
	private function add_content_section()
	{
		...
		$this->add_control('style', [
			...
			'default'      => '01',
			'prefix_class' => "jobportal-modern-carousel-style-',
		...
		$repeater->add_control('tags', [
			'label'       => esc_html__('Tags', 'jobportal'),
			'type'        => Controls_Manager::TEXTAREA,
			'placeholder' => esc_html__('One tag per line', 'jobportal'),
		]);
	...
	private function add_style_section()
	{
		...
		$this->add_responsive_control('box_border_radius', [
			...
			'size_units' => ['px', '%'],
			'selectors'  => [
				'{{WRAPPER}} .jobportal-box' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
	...
	protected function print_slides(array $settings)
	{
		...
		foreach ($settings['slides'] as $slide) :
			...
			$this->add_render_attribute($box_key, 'class', "jobportal-box slide-wrapper');
		...
		?>
			<div <?php $this->print_attributes_string($item_key); ?>>
				...
				<?php if ('02' === $settings['style']) : ?>
					<div class="slide-image jobportal-image">
