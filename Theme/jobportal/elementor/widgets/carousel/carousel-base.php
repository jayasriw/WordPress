...
abstract class Carousel_Base extends Base
{
	...
	{
		return ["jobportal-group-widget-carousel'];
	}
	...
	private function add_swiper_options_section()
	{
		$this->start_controls_section('swiper_options_section', [
			'label' => esc_html__('Carousel Options', 'jobportal'),
		]);

		$this->add_responsive_control('swiper_items', [
			'label'          => esc_html__('Slides Per View', 'jobportal'),
			'type'           => Controls_Manager::SELECT,
			'options'        => array(
				'auto'       => esc_html__('Auto', 'jobportal'),
				'auto-fixed' => esc_html__('Auto - Fixed Width', 'jobportal'),
				'1'          => '1',
				'2'          => '2',
				'3'          => '3',
				'4'          => '4',
		...
		$this->add_responsive_control('swiper_slides_width', [
			'label'       => esc_html__('Slides Width', 'jobportal'),
		...
		$this->add_responsive_control('swiper_gutter', [
			'label'   => esc_html__('Space Between', 'jobportal'),
		...
		$this->add_control('swiper_autoplay', [
			'label'       => esc_html__('Auto Play', 'jobportal'),
			'description' => esc_html__('Delay between transitions (in ms). For e.g: 3000. Leave blank to disabled. Input 1 to make smooth transition.', 'jobportal'),
			'type'        => Controls_Manager::NUMBER,
			'default'     => '',
		]);
		...
		$this->add_control('swiper_centered', [
			'label' => esc_html__('Centered', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
		]);

		$this->add_control('swiper_centered_highlight', [
			'label'     => esc_html__('Highlight Active Items', 'jobportal'),
			'type'      => Controls_Manager::SWITCHER,
			'condition' => [
				'swiper_centered' => 'yes',
			],
		...
		$this->add_control('swiper_free_mode', [
			'label' => esc_html__('Free Mode', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
		]);

		$this->add_control('swiper_touch', [
			'label'       => esc_html__('Touchable', 'jobportal'),
			'description' => esc_html__('Click and drag to change slides', 'jobportal'),
			'type'        => Controls_Manager::SWITCHER,
			'default'     => 'yes',
		]);

		$this->add_control('swiper_mousewheel', [
			'label' => esc_html__('Mousewheel', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
		]);
		...
		$this->add_control('swiper_inner_heading', [
			'label'     => esc_html__('Slider Inner', 'jobportal'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
		...
		$this->add_control('swiper_container_heading', [
			'label'     => esc_html__('Slider Container', 'jobportal'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
		...
		$this->add_control('swiper_content_alignment_heading', [
			'label'     => esc_html__('Content Alignment', 'jobportal'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);

		$this->add_responsive_control('swiper_content_horizontal_align', [
			'label'       => esc_html__('Horizontal Align', 'jobportal'),
			'label_block' => true,
		...
		$this->add_responsive_control('swiper_content_vertical_align', [
			'label'       => esc_html__('Vertical Align', 'jobportal'),
			'label_block' => true,
			'type'        => Controls_Manager::CHOOSE,
	...
	private function add_swiper_arrows_popover()
	{
		$this->add_control('swiper_arrows_show', [
			'label'        => esc_html__('Arrows', 'jobportal'),
		...
		$this->add_control('swiper_arrows_aligned_by', [
			'label'       => esc_html__('Aligned By', 'jobportal'),
			'type'        => Controls_Manager::SELECT,
			'options'     => [
				'slider' => esc_html__('Slider', 'jobportal'),
		...
		$this->add_control('swiper_left_arrow_heading', [
			'label' => esc_html__('Left Arrow', 'jobportal'),
			'type'  => Controls_Manager::HEADING,
		]);
		...
		$this->add_control('swiper_right_arrow_heading', [
			'label' => esc_html__('Right Arrow', 'jobportal'),
			'type'  => Controls_Manager::HEADING,
		]);
		...
		$this->add_control('swiper_arrows_visibility_heading', [
			'label' => esc_html__('Visibility', 'jobportal'),
			'type'  => Controls_Manager::HEADING,
		]);

		$this->add_control('swiper_arrows_show_always', [
			'label' => esc_html__('Show Always', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
		]);
	...
	private function add_swiper_dots_popover()
	{
		$this->add_control('swiper_dots_show', [
			'label'        => esc_html__('Dots', 'jobportal'),
			'type'         => Controls_Manager::POPOVER_TOGGLE,
			'label_off'    => esc_html__('Hide', 'jobportal'),
			'label_on'     => esc_html__('Show', 'jobportal'),
			'return_value' => 'yes',
		...
		$this->add_control('swiper_dots_style', [
			...
			'type'    => Controls_Manager::SELECT,
			'options' => [
				'01' => esc_html__('01 - Circle Bullets', 'jobportal'),
				'02' => esc_html__('02 - Rectangle Bullets', 'jobportal'),
				'03' => esc_html__('03 - Fraction', 'jobportal'),
				'04' => esc_html__('04 - Circle Fraction & Arrows', 'jobportal'),
				'05' => esc_html__('05 - Modern Circle Bullets', 'jobportal'),
				'06' => esc_html__('06 - Fraction 02', 'jobportal'),
			],
			'default' => '01',
		]);
		...
		$this->add_responsive_control('swiper_dots_direction', [
			'label'   => esc_html__('Direction', 'jobportal'),
			'type'    => Controls_Manager::CHOOSE,
			'options' => [
				'horizontal' => [
					'title' => esc_html__('Horizontal', 'jobportal'),
					'icon'  => 'eicon-navigation-horizontal',
				],
				'vertical'   => [
					'title' => esc_html__('Vertical', 'jobportal'),
		...
		$this->add_responsive_control('swiper_dots_vertical_align', [
			...
			'options'              => [
				...
				'below'  => [
					'title' => esc_html__('Below Slider', 'jobportal'),
		...
		$this->add_responsive_control('swiper_dots_vertical_offset', [
			'label'       => esc_html__('Vertical Offset', 'jobportal'),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => ['px', '%'],
			'range'       => [
				'px' => [
		...
		$this->add_responsive_control('swiper_dots_horizontal_offset', [
			'label'       => esc_html__('Horizontal Offset', 'jobportal'),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => ['px', '%'],
			'range'       => [
				'px' => [
	...
	private function add_swiper_arrows_style_section()
	{
		$this->start_controls_section('swiper_arrows_style_section', [
			'label'     => esc_html__('Carousel Arrows', 'jobportal'),
		...
		$this->add_responsive_control('swiper_arrows_icon_size', [
			'label'      => esc_html__('Icon Size', 'jobportal'),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => ['px'],
			'range'      => [
				'px' => [
		...
		$this->add_responsive_control('swiper_arrows_border_width', [
			'label'     => esc_html__('Border Width', 'jobportal'),
			'type'      => Controls_Manager::SLIDER,
			'selectors' => [
	...
	private function add_swiper_dots_style_section()
	{
		$this->start_controls_section('swiper_dots_style_section', [
			'label'     => esc_html__('Carousel Dots', 'jobportal'),
			'tab'       => Controls_Manager::TAB_STYLE,
			'condition' => [
		...
		$this->add_control('swiper_dots_primary_color', [
			'label'     => esc_html__('Primary Color', 'jobportal'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
		...
		$this->add_control('swiper_dots_secondary_color', [
			'label'     => esc_html__('Secondary Color', 'jobportal'),
			'type'      => Controls_Manager::COLOR,
			'selectors' => [
	...
	{
		$slider_settings = [
			'class'          => ["jobportal-swiper jobportal-slider-widget'],
