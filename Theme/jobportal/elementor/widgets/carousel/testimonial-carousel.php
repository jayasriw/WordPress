...
class Widget_Testimonial_Carousel extends Base
{
	...
	{
		return "jobportal-testimonial';
	}

	public function get_title()
	{
		return esc_html__('Testimonial Carousel', 'jobportal');
	}
	...
	{
		return ["jobportal-el-widget-testimonial-carousel'];
	}

	public function get_script_depends()
	{
		return ['carousel',"jobportal-widget-testimonial-carousel'];
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('style', [
			...
			'options'      => [
				...
				'04' => esc_html__('04', 'jobportal'),
			],
			'render_type'  => 'template',
			'prefix_class' => "jobportal-testimonial-style-',
		]);
		...
		$this->add_control('layout', [
			...
			'options'      => [
				'image-inline'  => esc_html__('Image Inline', 'jobportal'),
				'image-stacked' => esc_html__('Image Stacked', 'jobportal'),
				'image-top'     => esc_html__('Image Top Overlap', 'jobportal'),
				'image-top-02'  => esc_html__('Image Top', 'jobportal'),
				'image-bottom'     => esc_html__('Image Bottom', 'jobportal'),
				'image-above'   => esc_html__('Image Above', 'jobportal'),
				'image-left'    => esc_html__('Image Left', 'jobportal'),
			],
			'render_type'  => 'template',
			'prefix_class' => 'layout-',
			'condition'    => [
		...
		$this->add_control('image_position', [
			'label'        => esc_html__('Info Position', 'jobportal'),
			'type'         => Controls_Manager::CHOOSE,
			'label_block'  => false,
			'default'      => 'below',
			'options'      => [
				'above'  => [
					'title' => esc_html__('Above', 'jobportal'),
					'icon'  => 'eicon-v-align-top',
				],
				'below'  => [
					'title' => esc_html__('Below', 'jobportal'),
		...
		$this->add_control('cite_layout', [
			'label'        => esc_html__('Cite Layout', 'jobportal'),
			'label_block'  => false,
			'type'         => Controls_Manager::CHOOSE,
			'default'      => 'block',
			'options'      => [
				'block'  => [
					'title' => esc_html__('Default', 'jobportal'),
					'icon'  => 'eicon-editor-list-ul',
				],
				'inline' => [
					'title' => esc_html__('Inline', 'jobportal'),
					'icon'  => 'eicon-ellipsis-h',
				],
			],
			'prefix_class' => "jobportal-testimonial-cite-layout-',
		]);

        $this->add_responsive_control(
            'column_gap',
            [
                'label' => __('Columns Gap', 'jobportal'),
    ...
    private function add_slider_section()
    {
        ...
        $this->add_responsive_control(
            'slides_to_show',
            [
                'label' => esc_html__('Slides to Show', 'jobportal'),
                'type' => Controls_Manager::SELECT,
                'default' => '2',
                'options' => [
                        '' => esc_html__('Default', 'jobportal'),
                    ] + $slides_to_show,
            ]
        );
        ...
        $this->add_responsive_control(
            'slides_to_scroll',
            [
                'label' => esc_html__('Slides to Scroll', 'jobportal'),
                'type' => Controls_Manager::SELECT,
                'description' => esc_html__('Set how many slides are scrolled per swipe.', 'jobportal'),
                'default' => '1',
                'options' => [
                        '' => esc_html__('Default', 'jobportal'),
                    ] + $slides_to_show,
        ...
        $this->add_control(
            'navigation',
            [
                'label' => esc_html__('Navigation', 'jobportal'),
                'type' => Controls_Manager::SELECT,
                'default' => 'both',
                'options' => [
                    'both' => esc_html__('Arrows and Dots', 'jobportal'),
                    'arrows' => esc_html__('Arrows', 'jobportal'),
                    'dots' => esc_html__('Dots', 'jobportal'),
		...
		$this->add_control('dots_alignment', [
			'label'     => esc_html__('Dots Alignment', 'jobportal'),
			'type'      => Controls_Manager::CHOOSE,
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label' => esc_html__('Pause on Hover', 'jobportal'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'autoplay',
            [
                'label' => esc_html__('Autoplay', 'jobportal'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'no',
            ]
        );
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label' => esc_html__('Autoplay Speed', 'jobportal'),
                'type' => Controls_Manager::NUMBER,
                'default' => 5000,
                'condition' => [
                    'autoplay' => 'yes',
        ...
        $this->add_control(
            'infinite',
            [
                'label' => esc_html__('Infinite Loop', 'jobportal'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            'transition',
            [
                'label' => esc_html__('Transition', 'jobportal'),
                'type' => Controls_Manager::SELECT,
                'default' => 'slide',
                'options' => [
                    'slide' => esc_html__('Slide', 'jobportal'),
                    'fade' => esc_html__('Fade', 'jobportal'),
                ],
            ]
        );
        ...
        $this->add_control(
            'transition_speed',
            [
                'label' => esc_html__('Transition Speed', 'jobportal') . ' (ms)',
                'type' => Controls_Manager::NUMBER,
                'default' => 500,
            ]
        );
    ...
    private function register_content()
    {
        $this->start_controls_section('slides_section', [
            'label' => esc_html__('Slides', 'jobportal'),
        ]);
    ...
    private function add_box_style_section()
	{
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::SELECT,
				'options' => [
					'none' => __('None', 'jobportal'),
					'solid' => __('Solid', 'jobportal'),
					'double' => __('Double', 'jobportal'),
					'dotted' => __('Dotted', 'jobportal'),
					'dashed' => __('Dashed', 'jobportal'),
				],
				'default' => 'none',
				'selectors' => [
		...
		$this->add_control(
			'border_width',
			[
				'label' => __('Border Width', 'jobportal'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 10,
		...
		$this->add_control(
			'border_color',
			[
				'label' => __('Border Color', 'jobportal'),
		...
		$this->add_control(
			...
			[
				'label' => __('Border Radius', 'jobportal'),
				'type' => Controls_Manager::SLIDER,
				'size_units' => ['px', '%'],
				'selectors' => [
	...
	private function add_content_style_section()
	{
		...
		$this->add_control('content_text_align', [
			'label'        => esc_html__('Text Align', 'jobportal'),
			'label_block'  => false,
			'type'         => Controls_Manager::CHOOSE,
			'default'      => 'center',
			'options'      => Widget_Utils::get_control_options_text_align(),
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__('Typography', 'jobportal'),
			'selector' => '{{WRAPPER}} .title',
		]);

		$this->add_responsive_control('title_margin', [
			'label'      => esc_html__('Margin', 'jobportal'),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => ['px', '%', 'em'],
			'selectors'  => [
		...
		$this->add_control('name_heading', [
			'label'     => esc_html__('Name', 'jobportal'),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		]);
	...
	protected function add_repeater_controls($repeater)
	{
		...
		$repeater->add_control('image', [
			'label' => esc_html__('Avatar', 'jobportal'),
			'type'  => Controls_Manager::MEDIA,
		]);

		$repeater->add_control('image_logo', [
			'label' => esc_html__('Logo', 'jobportal'),
			'type'  => Controls_Manager::MEDIA,
		]);
		...
		$repeater->add_control('name', [
			'label'   => esc_html__('Name', 'jobportal'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('John Doe', 'jobportal'),
		]);

		$repeater->add_control('position', [
			'label'   => esc_html__('Position', 'jobportal'),
			'type'    => Controls_Manager::TEXT,
			'default' => esc_html__('CEO', 'jobportal'),
		]);

		$repeater->add_control('rating', [
			'label' => esc_html__('Rating', 'jobportal'),
			'type'  => Controls_Manager::NUMBER,
			'min'   => 0,
			'max'   => 5,
			'step'  => 0.1,
	...
	protected function get_repeater_defaults()
	{
		...
		return [
			[
				'content'  => esc_html__('I am slide content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'jobportal'),
				'name'     => esc_html__('John Doe', 'jobportal'),
				'position' => esc_html__('Web Design', 'jobportal'),
...
?>
		<div class="image">
			<?php echo \JobPortal_Image::get_elementor_attachment([
				'settings'       => $slide,
		...
		<div class="info">
			...
			if ($settings['style'] == '03') {
				if (!empty($slide['image_logo']['url'])) {
					...
					$logo =  JOBPORTAL_THEME_URI . '/assets/images/testimonial-icon.svg';
				} ?>
	...
	?>
		<?php if ($settings['style'] == '01' || $settings['style'] == '02') {
			if (!empty($slide['image_logo']['url'])) {
				...
				$logo =  JOBPORTAL_THEME_URI . '/assets/images/testimonial-icon.png';
			} ?>
			<div class="testimonial-logo">
				<img src="<?php echo esc_url($logo); ?>" alt="" />
			</div>
    ...
    protected function render()
    {
        ...
        if (empty($settings['center_padding_tablet'])) : $settings['center_padding_tablet'] = $settings['center_padding'];endif;
        if (empty($settings['center_padding_mobile'])) : $settings['center_padding_mobile'] = $settings['center_padding'];endif;
	...
	?>
		<?php if ($slide['content']) : ?>
			<div class="content">
				<div class="text">
					<?php echo wp_kses($slide['content'], "jobportal-default'); ?>
				</div>
			</div>
		<?php endif; ?>
	...
	protected function after_slider()
	{
		...
		$this->add_render_attribute('_wrapper', 'class', "jobportal-swiper-linked-yes');

		$testimonial_thumbs_template = '';

		foreach ($settings['slides'] as $slide) :
			if ($slide['image']['url']) :
				$testimonial_thumbs_template .= '<div class="swiper-slide"><div class="post-thumbnail"><div class="image">' . \JobPortal_Image::get_elementor_attachment([
					'settings'       => $slide,
					'image_size_key' => 'image_size',
				]) . '</div></div></div>';
			endif;
	...
	?>
		<div class="jobportal-swiper jobportal-slider-widget jobportal-testimonial-pagination style-01 jobportal-thumbs-swiper" data-lg-items="3" data-lg-gutter="30" data-slide-to-clicked-slide="1" data-centered="1" data-loop="1" data-looped-slides="<?php echo esc_attr($this->slider_looped_slides); ?>">
