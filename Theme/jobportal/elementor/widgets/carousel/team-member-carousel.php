...
class Widget_Team_Member_Carousel extends Static_Carousel
{
	...
	{
		return "jobportal-team-member-carousel';
	}

	public function get_title()
	{
		return esc_html__('Team Member Carousel', 'jobportal');
	}
	...
	{
		return ["jobportal-el-widget-team-member-carousel'];
	}
	...
	protected function add_repeater_controls(Repeater $repeater)
	{
		...
		$repeater->add_control('profile', [
			'label'         => esc_html__('Profile', 'jobportal'),
		...
		$repeater->add_control('socials', [
			'label'       => esc_html__('Socials', 'jobportal'),
			'description' => esc_html__('One social per line. Icon class & url separator with |. For eg: fab fa-facebook|https://facebook.com', 'jobportal'),
			'type'        => Controls_Manager::TEXTAREA,
		]);
	}
...
?>
		<div class="jobportal-team-member jobportal-box">
			<div class="item">
				<?php if ($slide['image']['url']) : ?>
					<div class="photo jobportal-image">
	...
	{
		$this->add_render_attribute('wrapper', 'class', "jobportal-team-member-carousel');
	?>
