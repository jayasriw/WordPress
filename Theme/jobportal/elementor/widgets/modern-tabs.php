...
class Widget_Moderm_Tabs extends Base
{
	...
	{
		return "jobportal-modern-tabs';
	}

	public function get_title()
	{
		return esc_html__('Modern Tabs', 'jobportal');
	}
	...
	{
		return [
			"jobportal-widget-modern-tabs',
		];
	}

    public function get_style_depends()
    {
        return ["jobportal-el-widget-modern-tabs'];
    }
	...
	private function add_layout_section()
	{
		...
		$template = $this->jobportal_get_page_templates();

		$tabs->add_control('title', [
			'label'   => esc_html__('Title Tabs', 'jobportal'),
		...
		$tabs->add_control(
			'template',
			[
				'label'   => esc_html__('Choose Template', 'jobportal'),
		...
		$this->add_control(
			'tabs',
			[
				'label' => esc_html__('Tabs', 'jobportal'),
				'type'      => Controls_Manager::REPEATER,
				'fields'    => $tabs->get_controls(),
				'default' => [
					[
						'title' => esc_html__('Tabs 01', 'jobportal'),
					],
					[
						'title' => esc_html__('Tabs 02', 'jobportal'),
					],
					[
						'title' => esc_html__('Tabs 03', 'jobportal'),
					],
				],
				'title_field' => '{{{ title }}}',
			]
	...
	private function add_tabs_style_section()
	{
		...
		$this->add_responsive_control('tabs_margin_bottom', [
			'label'          => esc_html__('Margin Bottom', 'jobportal'),
			'type'           => Controls_Manager::SLIDER,
			'size_units'     => ['px', '%'],
			'range'          => [
				'%'  => [
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-modern-tabs');
		$id_int = $this->get_id();
?>
...
<?php }
	...
	private function jobportal_get_page_templates($type = null)
	{
		$args = [
