...
class Modify_Widget_Section extends Modify_Base
{
	...
	public function section_layout($element)
	{
		...
		$section_gap['options'] = [
			...
			'default'  => esc_html__('Normal', 'jobportal'),
			'no'       => esc_html__('No Gap', 'jobportal'),
			'narrow'   => esc_html__('Narrow', 'jobportal'),
			'extended' => esc_html__('Extended', 'jobportal'),
			'wide'     => esc_html__('Wide', 'jobportal'),
			'wider'    => esc_html__('Wider', 'jobportal'),
			// Add flexible gap width.
			'custom'   => esc_html__('Custom', 'jobportal'),
		];
		...
		$element->add_control('gap_beside', [
			'label'        => esc_html__('Gap Beside', 'jobportal'),
			'type'         => Controls_Manager::SELECT,
			'default'      => 'yes',
			'options'      => [
				'no'  => esc_html__('No', 'jobportal'),
				'yes' => esc_html__('Yes', 'jobportal'),
			],
		...
		$element->add_responsive_control('gap_width', [
			'label'     => esc_html__('Gap Width', 'jobportal'),
		...
		$element->add_control('column_vertical_alignment', [
			'label'                => esc_html__('Column Vertical Alignment', 'jobportal'),
			'label_block'          => true,
			'type'                 => Controls_Manager::CHOOSE,
