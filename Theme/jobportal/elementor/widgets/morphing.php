...
class Widget_Morphing extends Base {
    ...
    public function get_name() {
        return "jobportal-morphing';
    }

    public function get_title() {
        return esc_html__('Morphing', 'jobportal');
    }

    public function get_icon() {
        return "jobportal-badge eicon-anchor';
    }
    ...
    {
        return ["jobportal-el-widget-morphing'];
    }

    public function get_script_depends()
    {
        return ["jobportal-widget-morphing','scrollmonitor','anime'];
    }
    ...
    private function add_content_section()
    {
        ...
        $this->add_control(
            'morph_layout',
            [
                'label' => esc_html__( 'Morphing Layout', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'normal',
                'options' => [
                    'normal'  => esc_html__( 'Normal ', 'jobportal' ),
                    'sec_bg'  => esc_html__( 'Section Background', 'jobportal' ),
                    'column_bg'  => esc_html__( 'Column Background', 'jobportal' ),
                    'fixed_scroll'  => esc_html__( 'Fixed Scroll', 'jobportal' ),
                ],
            ]
        );
        ...
        $this->start_controls_tab( 'morph_mw_mh',
            [
                'label' => esc_html__( 'Max-Size', 'jobportal' ),
            ]
        );
        $this->add_responsive_control(
            'morph_maxwidth',
            [
                'label' => esc_html__( 'Maximum Width', 'jobportal' ),
                ...
                'selectors' => [
                    '.morph-{{ID}}.jobportal-morphing-svg-wrapper' => 'max-width: {{SIZE}}{{UNIT}};margin: 0 auto;',
                ],
            ]
        );
        $this->add_responsive_control(
            'morph_maxheight',
            [
                'label' => esc_html__( 'Maximum Height', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
                ...
                'selectors' => [
                    '.morph-{{ID}}.jobportal-morphing-svg-wrapper' => 'max-height: {{SIZE}}{{UNIT}}',
                ],
            ]
        );
        ...
        $this->start_controls_tab( 'viebox_mw_mh',
            [
                'label' => esc_html__( 'ViewBox Size', 'jobportal' ),
            ]
        );
        $this->add_responsive_control(
            'viewbox_width',
            [
                'label' => esc_html__( 'ViewBox Width', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 50,
        ...
        $this->add_responsive_control(
            'viewbox_height',
            [
                'label' => esc_html__( 'ViewBox Height', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 20,
        ...
        $repeater->add_control(
            'layouts',
            [
                'label' => esc_html__( 'Morphing Style', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'style-01',
                'options' => [
                    'style-01'  => esc_html__( 'Style 01', 'jobportal' ),
                    'style-02'  => esc_html__( 'Style 02', 'jobportal' ),
                    'style-03'  => esc_html__( 'Style 03', 'jobportal' ),
                    'style-04'  => esc_html__( 'Style 04', 'jobportal' ),
                    'style-05'  => esc_html__( 'Style 05', 'jobportal' ),
                    'style-06'  => esc_html__( 'Style 06', 'jobportal' ),
                    'style-07'  => esc_html__( 'Style 07', 'jobportal' ),
                    'style-08'  => esc_html__( 'Style 08', 'jobportal' ),
                    'style-09'  => esc_html__( 'Style 09', 'jobportal' ),
                    'style-10'  => esc_html__( 'Style 10', 'jobportal' ),
                    'style-11'  => esc_html__( 'Style 11', 'jobportal' ),
                    'style-12'  => esc_html__( 'Style 12', 'jobportal' ),
                    'style-13'  => esc_html__( 'Style 13', 'jobportal' ),
                    'style-14'  => esc_html__( 'Style 14', 'jobportal' ),
                    'style-15'  => esc_html__( 'Style 15', 'jobportal' ),
                    'custom' => esc_html__( 'Custom Morphing', 'jobportal' ),
                ],
            ]
        );
        $repeater->add_control(
            'custom_layouts',
            [
                'label' => esc_html__( 'Custom Morphing Code', 'jobportal' ),
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'placeholder' => esc_html__( 'Morphing Custom Code', 'jobportal' ),
                'condition'    => [
                    'layouts' => [ 'custom' ],
                ],
            ]
        ...
        $repeater->add_control(
            'fixed_scroll_alt',
            [
                'label' => esc_html__( 'Fixed Scroll Alternate', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none' => esc_html__( 'Fixed Scroll', 'jobportal' ),
                    'style-01'  => esc_html__( 'Style 01', 'jobportal' ),
                    'style-02'  => esc_html__( 'Style 02', 'jobportal' ),
                    'style-03'  => esc_html__( 'Style 03', 'jobportal' ),
                    'style-04'  => esc_html__( 'Style 04', 'jobportal' ),
                ...
                'description' => esc_html__('Note: If, enable (Fixed Scroll) scrolling option used for styles.','jobportal'),
                'separator' => 'before',
            ]
        );
        $repeater->add_control(
            'custom_layouts_alt',
            [
                'label' => esc_html__( 'Custom Alternate Morphing Code', 'jobportal' ),
                'type' => Controls_Manager::TEXTAREA,
                'rows' => 5,
                'placeholder' => esc_html__( 'Morphing Custom Code', 'jobportal' ),
                'condition'    => [
        ...
        $repeater->start_controls_tab( 'tab_path_option',
            [
                'label' => esc_html__( 'Path', 'jobportal' ),
            ]
        );
        $repeater->add_control(
            'path_duration',
            [
                'label' => esc_html__( 'Path Duration', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $repeater->add_control(
            'path_elasticity',
            [
                'label' => esc_html__( 'Elasticity', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 10,
        ...
        $repeater->add_control(
            'path_easing',
            [
                'label' => esc_html__( 'Path Easing', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'easeOutElastic',
                'options' => $this->jobportal_anime_animation(),
            ]
        );
        $repeater->end_controls_tab();
        $repeater->start_controls_tab( 'tab_svg_option',
            [
                'label' => esc_html__( 'SVG', 'jobportal' ),
            ]
        );
        $repeater->add_control(
            'svg_duration',
            [
                'label' => esc_html__( 'SVG Duration', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $repeater->add_control(
            'svg_easing',
            [
                'label' => esc_html__( 'SVG Easing', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'easeOutElastic',
                'options' => $this->jobportal_anime_animation(),
            ]
        ...
        $repeater->start_controls_tab( 'tab_fill_option',
            [
                'label' => esc_html__( 'Fill Color', 'jobportal' ),
            ]
        );
        $repeater->add_control(
            'fill_duration',
            [
                'label' => esc_html__( 'Fill Duration', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 10,
        ...
        $repeater->add_control(
            'fill_easing',
            [
                'label' => esc_html__( 'Fill Easing', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'linear',
                'options' => $this->jobportal_anime_animation(),
            ]
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => 'no',
                'description' => esc_html__('If, Select "Fixed Scroll" Morphing type then use on Fill Color.','jobportal'),
            ]
        );
        $repeater->add_control(
            'fill_color',
        ...
        $repeater->add_control(
            'extra_options',
            [
                'label' => esc_html__( 'Additional Options', 'jobportal' ),
        ...
        $repeater->add_control(
            'scaleX',
            [
                'label' => esc_html__( 'ScaleX', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 0.6,
        ...
        $repeater->add_control(
            'scaleY',
            [
                'label' => esc_html__( 'ScaleY', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 0.6,
        ...
        $repeater->add_control(
            'trans_x',
            [
                'label' => esc_html__( 'Horizontal Adjust', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => -500,
        ...
        $repeater->add_control(
            'trans_y',
            [
                'label' => esc_html__( 'Vertical Adjust', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => -500,
        ...
        $this->add_control(
            'morphing_loop',
            [
                'label' => esc_html__( 'Svg Morphing Loop', 'jobportal' ),
        ...
        $this->add_control(
            'morph_type',
            [
                'label' => esc_html__( 'Select Type', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'color',
                'options' => [
                    'color'  => esc_html__( 'Color ', 'jobportal' ),
                    'gradient'  => esc_html__( 'Gradient', 'jobportal' ),
        ...
        $this->add_control(
            'grad_x1',
            [
                'label' => esc_html__( 'Position X1', 'jobportal' ),
        ...
        $this->add_control(
            'grad_x2',
            [
                'label' => esc_html__( 'Position X2', 'jobportal' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'grad_y1',
            [
                'label' => esc_html__( 'Position Y1', 'jobportal' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'grad_y2',
            [
                'label' => esc_html__( 'Position Y2', 'jobportal' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->start_controls_tab( 'tab_grad_color1',
            [
                'label' => esc_html__( 'Color 1', 'jobportal' ),
                'condition'    => [
                    'morph_type' => [ 'gradient' ],
                ],
            ]
        ...
        $this->add_control(
            'grad_color1_offset',
            [
                'label' => esc_html__( 'Offset', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '%' => [
                        'min' => 0,
        ...
        $this->start_controls_tab( 'tab_grad_color2',
            [
                'label' => esc_html__( 'Color 2', 'jobportal' ),
                'condition'    => [
                    'morph_type' => [ 'gradient' ],
                ],
            ]
        ...
        $this->add_control(
            'morph_image',
            [
                'label' => esc_html__( 'Masking Image', 'jobportal' ),
        ...
        $this->add_control(
            'image_x',
            [
                'label' => esc_html__( 'Position X', 'jobportal' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'image_y',
            [
                'label' => esc_html__( 'Position Y', 'jobportal' ),
                'type' => Controls_Manager::NUMBER,
                'min' => 0,
                'max' => 100,
                'step' => 0.5,
        ...
        $this->add_control(
            'image_dimension',
            [
                'label' => esc_html__( 'Image Dimension', 'jobportal' ),
                'type' => Controls_Manager::IMAGE_DIMENSIONS,
                'description' => esc_html__( 'Set custom width or height to keep the original size ratio.', 'jobportal' ),
                'default' => [
                    'width' => '',
                    'height' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'On', 'jobportal' ),
                'label_off' => esc_html__( 'Off', 'jobportal' ),
                'default' => 'no',
                'separator' => 'before',
                'condition'    => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '.jobportal-morph-fixed-scroll-bg.morph-fixed-{{ID}}',
                'condition'    => [
                    'morph_layout' => [ 'fixed_scroll' ],
    ...
    private function add_content_style_section()
    {
        ...
        $this->add_control(
            'hover_path',
            [
                'label' => esc_html__( 'Morphing Change Hover', 'jobportal' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'jobportal' ),
                'label_off' => esc_html__( 'No', 'jobportal' ),
                'separator' => 'before',
        ...
        $this->add_control(
            'duration',
            [
                'label' => esc_html__( 'Duration', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $this->add_control(
            'morph_easing',
            [
                'label' => esc_html__( 'Easing', 'jobportal' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'linear',
                'options' => $this->jobportal_anime_animation(),
                'separator' => 'before',
        ...
        $this->start_controls_section(
            'masking_image_style',
            [
                'label' => esc_html__( 'Image Style', 'jobportal' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition'    => [
                    'morph_type' => [ 'image' ],
                ],
        ...
        $this->add_control(
            'image_duration',
            [
                'label' => esc_html__( 'Image Duration', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 300,
        ...
        $this->add_control(
            'image_elasticity',
            [
                'label' => esc_html__( 'Image Elasticity', 'jobportal' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    '' => [
                        'min' => 0,
        ...
        $this->add_control(
            'image_on_hover',
            [
                'label' => esc_html__( 'Image Hover', 'jobportal' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'jobportal' ),
                'label_off' => esc_html__( 'No', 'jobportal' ),
            ]
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Custom SVG from Blob Maker?', 'jobportal' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Yes', 'jobportal' ),
                'label_off' => esc_html__( 'No', 'jobportal' ),
                'default' => 'no',
        ...
        $this->add_control(
            'morphing_overflow',
            [
                'label' => esc_html__( 'Overflow Morphing', 'jobportal' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__( 'Hidden', 'jobportal' ),
                'label_off' => esc_html__( 'Default', 'jobportal' ),
                'default' => 'hidden',
                'return_value' => 'hidden',
                'selectors' => [
                    '.jobportal-morphing-svg-wrapper.morph-{{ID}}' => 'overflow: {{VALUE}}',
                ],
            ]
        );
    ...
    protected function render() {
            ...
            foreach ( $settings['morphing_loop'] as $index => $item ) :
                ...
                if($item["layouts"]!='custom'){
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                        $json_arr["path"][]=$this->jobportal_morphing_style($item["layouts"]);
                    }else if($i==0){
                        $first_morph=$this->jobportal_morphing_style($item["layouts"]);
                    }
                    $morph_style='yes';
                }else{
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                ...
                if($item["fixed_scroll_alt"]!='custom' && $item["fixed_scroll_alt"]!='none'){
                    if($i>0 || (!empty($settings['morph_layout']) && $settings['morph_layout']=='fixed_scroll')){
                        $json_arr["pathAlt"][]=$this->jobportal_morphing_style($item["fixed_scroll_alt"]);
                    }else if($i==0){
                        $first_morph_alt=$this->jobportal_morphing_style($item["fixed_scroll_alt"]);
                    }
        ...
        $output ='<div class="jobportal-morphing-svg-wrapper '.$data_class.'" id="'.esc_attr($uid).'" '.$data_attr.' data-morph=\'' . $json_array . '\' data-morphimage=\''.$image_json_array.'\'>';
        ...
        if(!empty($settings['morph_fixed_scroll_bg']) && $settings['morph_fixed_scroll_bg']=='yes' && $settings['morph_layout']=='fixed_scroll'){
            $output .='<div class="jobportal-morph-fixed-scroll-bg morph-fixed-'.esc_attr($this->get_id()).'" id="fixed'.esc_attr($uid).'" data-id="fixed'.esc_attr($uid).'" data-morph-fixed="morph-fixed-'.esc_attr($this->get_id()).'"></div>';
        }
        echo $output;
    }

    protected function jobportal_morphing_style($style=''){
        $output='';
        if($style=='style-01'){
    ...
    protected function jobportal_anime_animation(){
        return array(
            'linear'  => esc_html__( 'Linear', 'jobportal' ),
            'easeOutQuad'  => esc_html__( 'Ease-Out Quad', 'jobportal' ),
            'easeInQuad'  => esc_html__( 'Ease-In Quad', 'jobportal' ),
            'easeInOutQuad'  => esc_html__( 'Ease-InOut Quad', 'jobportal' ),

            'easeOutCubic'  => esc_html__( 'Ease-Out Cubic', 'jobportal' ),
            'easeInCubic'  => esc_html__( 'Ease-In Cubic', 'jobportal' ),
            'easeInOutCubic'  => esc_html__( 'Ease-InOut Cubic', 'jobportal' ),

            'easeOutQuart'  => esc_html__( 'Ease-Out Quart', 'jobportal' ),
            'easeInQuart'  => esc_html__( 'Ease-In Quart', 'jobportal' ),
            'easeInOutQuart'  => esc_html__( 'Ease-InOut Quart', 'jobportal' ),

            'easeOutQuint'  => esc_html__( 'ease-Out Quint', 'jobportal' ),
            'easeInQuint'  => esc_html__( 'ease-In Quint', 'jobportal' ),
            'easeInOutQuint'  => esc_html__( 'ease-InOut Quint', 'jobportal' ),

            'easeOutSine'  => esc_html__( 'Ease-Out Sine', 'jobportal' ),
            'easeInSine'  => esc_html__( 'Ease-In Sine', 'jobportal' ),
            'easeInOutSine'  => esc_html__( 'Ease-InOut Sine', 'jobportal' ),

            'easeOutExpo'  => esc_html__( 'Ease-Out Expo', 'jobportal' ),
            'easeInExpo'  => esc_html__( 'Ease-In Expo', 'jobportal' ),
            'easeInOutExpo'  => esc_html__( 'Ease-InOut Expo', 'jobportal' ),

            'easeOutElastic'  => esc_html__( 'Ease-Out Elastic', 'jobportal' ),
            'easeInElastic'  => esc_html__( 'Ease-In Elastic', 'jobportal' ),
            'easeInOutElastic'  => esc_html__( 'Ease-InOut Elastic', 'jobportal' ),

            'easeOutCirc'  => esc_html__( 'Ease-Out Circ', 'jobportal' ),
            'easeInCirc'  => esc_html__( 'Ease-In Circ', 'jobportal' ),
            'easeInOutCirc'  => esc_html__( 'Ease-InOut Circ', 'jobportal' ),

            'easeOutBack'  => esc_html__( 'Ease-Out Back', 'jobportal' ),
            'easeInBack'  => esc_html__( 'Ease-In Back', 'jobportal' ),
            'easeInOutBack'  => esc_html__( 'Ease-InOut Back', 'jobportal' ),

            'easeOutBounce'  => esc_html__( 'Ease-Out Bounce', 'jobportal' ),
            'easeInBounce'  => esc_html__( 'Ease-In Bounce', 'jobportal' ),
            'easeInOutBounce'  => esc_html__( 'Ease-InOut Bounce', 'jobportal' ),
        );
    }
}