...
class Widget_Nav_Menu extends Base
{
	...
	{
		return "jobportal-modern-menu';
	}

	public function get_title()
	{
		return esc_html__('Modern Menu', 'jobportal');
	}
	...
	{
		return [
			"jobportal-widget-modern-menu',
		];
	}

	public function get_style_depends()
	{
		return ["jobportal-el-widget-modern-menu'];
	}
	...
	protected function register_controls()
	{
		...
		if (!empty($menus)) {
			$this->add_control(
				'menu',
				[
					'label' => __('Menu', 'jobportal'),
					'type' => Controls_Manager::SELECT,
					'options' => $menus,
					'default' => array_keys($menus)[0],
					'save_default' => true,
					'separator' => 'after',
					'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'jobportal'), admin_url('nav-menus.php')),
				]
			);
		} else {
			$this->add_control(
				...
				[
					...
					'raw' => '<strong>' . __('There are no menus in your site.', 'jobportal') . '</strong><br>' . sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'jobportal'), admin_url('nav-menus.php?action=edit&menu=0')),
					'separator' => 'after',
		...
		$this->add_control(
			...
			[
				...
				'default' => 'horizontal',
				'options' => [
					'horizontal' => __('Horizontal', 'jobportal'),
					'dropdown' => __('Dropdown', 'jobportal'),
				],
		...
		$this->add_control(
			'align_items',
			[
				'label' => __('Align', 'jobportal'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
						'title' => __('Left', 'jobportal'),
						'icon' => 'eicon-h-align-left',
					],
					'center' => [
						'title' => __('Center', 'jobportal'),
						'icon' => 'eicon-h-align-center',
					],
					'right' => [
						'title' => __('Right', 'jobportal'),
						'icon' => 'eicon-h-align-right',
					],
					'justify' => [
						'title' => __('Stretch', 'jobportal'),
		...
		$this->add_control(
			'pointer',
			[
				'label' => __('Pointer', 'jobportal'),
				'type' => Controls_Manager::SELECT,
				'default' => 'underline',
				'options' => [
					'none' => __('None', 'jobportal'),
					'underline' => __('Underline', 'jobportal'),
					'overline' => __('Overline', 'jobportal'),
					'double-line' => __('Double Line', 'jobportal'),
					'framed' => __('Framed', 'jobportal'),
					'background' => __('Background', 'jobportal'),
					'text' => __('Text', 'jobportal'),
				],
				'style_transfer' => true,
				'condition' => [
					'layout!' => 'dropdown',
		...
		$this->add_control(
			'indicator',
			[
				'label' => __('Submenu Indicator', 'jobportal'),
				'type' => Controls_Manager::SELECT,
				'default' => 'classic',
				'options' => [
					'none' => __('None', 'jobportal'),
					'classic' => __('Classic', 'jobportal'),
					'chevron' => __('Chevron', 'jobportal'),
					'angle' => __('Angle', 'jobportal'),
					'plus' => __('Plus', 'jobportal'),
				],
		...
		$this->add_control(
			...
			[
				'label' => __('Mobile Dropdown', 'jobportal'),
		...
		$this->add_control(
			...
			[
				'label' => __('Pointer Color', 'jobportal'),
				'type' => Controls_Manager::COLOR,
				'global' => [
					'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_ACCENT,
				],
		...
		$this->add_responsive_control(
			'pointer_width',
			[
				'label' => __('Pointer Width', 'jobportal'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Horizontal Padding', 'jobportal'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			...
			[
				'label' => __('Vertical Padding', 'jobportal'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 50,
		...
		$this->add_responsive_control(
			'menu_space_between',
			[
				'label' => __('Space Between', 'jobportal'),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'max' => 100,
		...
		$this->start_controls_section(
			'style_toggle',
			[
				'label' => __('Toggle Button', 'jobportal'),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __('Background Color', 'jobportal'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'raw' => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'jobportal'),
				'type' => Controls_Manager::RAW_HTML,
...
?>
		...
		<div class="mb-menu canvas-menu canvas-left <?php echo esc_attr__('elementor-nav-menu--layout-' . $settings['layout']); ?>">
			...
			<div class="site-menu area-menu mobile-menu">
				...
				<div class="inner-menu custom-scrollbar">
					...
					<?php \JobPortal_Templates::site_logo('dark'); ?>
