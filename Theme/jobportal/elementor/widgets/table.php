...
class Widget_Table extends Base
{
	...
	{
		return "jobportal-table';
	}

	public function get_title()
	{
		return esc_html__('Table', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-table'];
    }
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section('table_head_section', [
			'label' => esc_html__('Table Header', 'jobportal'),
		]);

		$table_header = new Repeater();

		$table_header->add_control('action', [
			'label'       => esc_html__('Action', 'jobportal'),
			'description' => esc_html__('You have started a new row. Please add new cells in your row by clicking Add Item button below.', 'jobportal'),
			'type'        => Controls_Manager::SELECT,
			'default'     => 'Cell',
			'options'     => [
				'Row'  => esc_html__('Start New Row', 'jobportal'),
				'Cell' => esc_html__('Add New Cell', 'jobportal'),
			],
		]);
		...
		$table_header->add_control('text', [
			...
			'default'   => esc_html__('Sample', 'jobportal'),
			'condition' => [
				'action' => 'Cell',
			],
		]);
		...
		$this->start_controls_section('table_body_section', [
			'label' => esc_html__('Table Content', 'jobportal'),
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-table');
...
?>
	...
	protected function content_template()
	{
		// @formatter:off
	?>
		<# view.addRenderAttribute( 'wrapper' , 'class' , "jobportal-table' ); view.addRenderAttribute( 'wrapper' , 'class' , 'style-' + settings.style ); #>
