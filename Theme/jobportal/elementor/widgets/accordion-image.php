...
class Widget_Accordion_Image extends Base
{
	...
	{
		return "jobportal-accordion-image';
	}

	public function get_title()
	{
		return esc_html__('Accordion/Toggle Image', 'jobportal');
	}
	...
	{
		return ["jobportal-widget-accordion-image'];
	}

    public function get_style_depends()
    {
        return ["jobportal-el-widget-accordion-image'];
    }
	...
	private function add_content_section()
	{
		...
		$this->add_control('heading', [
			'label'       => esc_html__('Heading', 'jobportal'),
		...
		$this->add_control('button_title', [
			'label'       => esc_html__('Button Title', 'jobportal'),
			'type'        => Controls_Manager::TEXT,
			'label_block' => true,
			'dynamic'     => [
				'active' => true,
		...
		$this->add_control(
			'button_link',
			[
				'label' => esc_html__('Button Link', 'jobportal'),
	...
	private function add_styling_section()
	{
		...
		$this->add_group_control(Group_Control_Typography::get_type(), [
			...
			'label'    => esc_html__('Heading Typography', 'jobportal'),
		...
		$this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'placeholder' => esc_html__('Example: 300x300', 'jobportal'),
                'default' => '570x570',
            ]
        );

		$this->add_control('thumbnail_border_radius', [
            'label' => esc_html__('Image Border Radius', 'jobportal'),
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-accordion-image');
...
?>
		<div class="flex">
			...
			?>
			<a class="jobportal-button" href="<?php echo esc_attr($settings['button_link']['url']); ?>"><?php echo esc_html( $settings['button_title'] ); ?></a>
			<?php
				}
			?>
			</div>
			<div class="right">
				<?php
					if( $settings['items'] ){
						foreach ($settings['items'] as $key => $item) {
							if( $item['image'] ){
								$image_src_full = jobportal_image_resize_url($item['image']['url'], $width, $height);
