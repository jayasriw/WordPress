...
class Widget_Search_Popup extends Base
{
    ...
    {
        return "jobportal-search-popup';
    }

    public function get_title()
    {
        return esc_html__('Search Popup', 'jobportal');
    }
    ...
    private function add_search_popup_section()
    {
        $this->start_controls_section('search_popup_section', [
            'label' => esc_html__('Search Popup', 'jobportal'),
        ]);
    ...
    {
        ?>
        <div class="block-search search-icon jobportal-ajax-search">
