...
class Widget_Team_Member extends Base
{
	...
	{
		return "jobportal-team-member';
	}

	public function get_title()
	{
		return esc_html__('Team Member', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-team-member'];
    }
	...
	private function add_content_section()
	{
		...
		$this->add_control('style', [
			...
			'prefix_class' => "jobportal-team-member-style-',
		]);
		...
		$this->add_control('social_networks', [
			'label'       => esc_html__('Social Networks', 'jobportal'),
			...
			'default'     => [
				...
				[
					'title' => esc_html__('Youtube Channel', 'jobportal'),
					'link'  => [
						'url'         => '#',
						'is_external' => true,
						'nofollow'    => true,
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-team-member jobportal-box');
?>
			...
			<div class="item">
				<?php if ($settings['image']['url']) : ?>
					<div class="photo jobportal-image">
						...
						<?php if (!in_array($settings['style'], array('01'))) : ?>
					...
					<div class="info">
						<?php if (in_array($settings['style'], array('03'))) : ?>
							<?php if (!empty($settings['position'])) : ?>
								<div class="position"><?php esc_html_e($settings['position']); ?></div>
							<?php endif; ?>
						...
						<?php if ($settings['content'] !== '') : ?>
							<div class="description">
								<?php echo wp_kses($settings['content'], "jobportal-default'); ?>
							</div>
						<?php endif; ?>
