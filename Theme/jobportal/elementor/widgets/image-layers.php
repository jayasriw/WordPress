...
class Widget_Image_Layers extends Base
{
	...
	{
		return "jobportal-image-layers';
	}

	public function get_title()
	{
		return esc_html__('Image Layers', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-image-layers'];
    }
	...
	private function add_artboard_section()
	{
		$this->start_controls_section('artboard_section', [
			'label' => esc_html__('Artboard', 'jobportal'),
		]);
	...
	private function add_layers_section()
	{
		$this->start_controls_section('layers_section', [
			'label' => esc_html__('Layers', 'jobportal'),
		]);

		$repeater = new Repeater();

		$repeater->add_control('static', [
			'label' => esc_html__('Static Layer', 'jobportal'),
		...
		$repeater->start_controls_tab('layer_loop_tab', [
			'label' => esc_html__('Loop', 'jobportal'),
		]);
		...
		$repeater->add_control('loop', [
			...
			'options' => [
				...
				'rotate'          => esc_html__('Rotate', 'jobportal'),
				'move-horizontal' => esc_html__('Move - Horizontal', 'jobportal'),
				'move-vertical'   => esc_html__('Move - Vertical', 'jobportal'),
			],
			'default' => '',
		]);
