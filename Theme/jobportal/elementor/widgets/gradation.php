...
class Widget_Gradation extends Base
{
	...
	{
		return "jobportal-gradation';
	}

	public function get_title()
	{
		return esc_html__('Gradation', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-gradation'];
    }
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-gradation');
?>
