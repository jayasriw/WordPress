...
class Widget_Icon extends Base
{
	...
	{
		return "jobportal-icon';
	}

	public function get_title()
	{
		return esc_html__('Modern Icon', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-icon'];
    }
	...
	private function add_icon_style_section()
	{
		...
		$this->add_group_control(Group_Control_Text_Gradient::get_type(), [
			'name'     => 'hover_icon',
			'selector' => '{{WRAPPER}} .jobportal-icon:hover .icon',
		]);
		...
		$this->add_responsive_control('icon_size', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-icon, {{WRAPPER}} .jobportal-icon-view' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_group_control(Group_Control_Background::get_type(), [
			...
			'selector' => '{{WRAPPER}} .jobportal-icon:hover .jobportal-icon-view',
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('box', 'class', "jobportal-icon');
		$box_tag = 'div';
				...
				<{{{ box_tag }}} {{{ view.getRenderAttributeString( 'box' ) }}}>
					<div class="jobportal-icon-wrap">
						...
						<# if ( 'bubble'==settings.view ) { #>
							<div class="jobportal-icon-view second"></div>
							<# } #>
