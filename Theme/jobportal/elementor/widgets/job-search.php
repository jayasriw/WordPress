...
class Widget_Job_Search extends Base
{
	...
	{
		return "jobportal-job-search';
	}

	public function get_title()
	{
		return esc_html__('Job Search', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-job-search'];
    }
	...
	private function add_job_search_section()
	{
		$this->start_controls_section('job_search_section', [
			'label' => esc_html__('Job Search', 'jobportal'),
		]);
		...
		$this->add_control('type', [
			...
			'options'      => [
				'jobs-categories' => esc_html__('Categories', 'jobportal'),
				'company' => esc_html__('Companies', 'jobportal'),
				'jobs-location' => esc_html__('Locations', 'jobportal'),
			],
			'default'      => 'categories',
		]);

		$this->add_control('image', [
			'label'   => esc_html__('Banner Image', 'jobportal'),
		...
		$this->add_control('title', [
			...
			'default'     => esc_html__('Categories', 'jobportal'),
		]);

		$this->add_control(
			'posts_per_page',
			[
				'label' => esc_html__('Posts Per Page', 'jobportal'),
		...
		$this->add_control('show_total_posts', [
			'label' => esc_html__('Show total posts', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
		]);

		$this->add_control('show_button', [
			'label' => esc_html__('Show button', 'jobportal'),
			'type'  => Controls_Manager::SWITCHER,
			'separator'   => 'before',
		]);
		...
		$this->add_control('button_text', [
			...
			'type'        => Controls_Manager::TEXT,
			'default'     => esc_html__('All Categories', 'jobportal'),
			'condition' => [
				'show_button' => 'yes',
			],
		]);
	...
	private function add_box_style_section()
	{
		...
		$this->add_responsive_control(
            'image_height',
            [
                'label' => __('Image Height', 'jobportal'),
		...
		$this->add_responsive_control('content_padding', [
			'label'      => esc_html__('Content Padding', 'jobportal'),
		...
		$this->add_control('list_heading', [
			'label' => esc_html__('List', 'jobportal'),
			'type'  => Controls_Manager::HEADING,
		]);
		...
		$this->add_control('number_heading', [
			'label' => esc_html__('Number of posts', 'jobportal'),
			'type'  => Controls_Manager::HEADING,
		]);
			...
			<div class="inner">
				...
				<div class="content">
					<?php
						...
						// Show button
						if ($link['url'] !== '') {
							echo '<a ' . $this->get_render_attribute_string('job_search') . ' class="jobportal-button">';
