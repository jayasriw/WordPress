...
class Widget_View_Demo extends Static_Grid
{
	...
	{
		return "jobportal-view-demo';
	}

	public function get_title()
	{
		return esc_html__('View Demo', 'jobportal');
	}
	...
	private function add_layout_section()
	{
		...
		$this->add_control('hover_effect', [
			...
			'options'      => [
				...
				'move-up-drop-shadow' => esc_html__('Move Up - Drop Shadow', 'jobportal'),
			],
			'default'      => '',
	...
	protected function add_repeater_controls(Repeater $repeater)
	{
		...
		$repeater->add_control('badge', [
			'label'   => esc_html__('Badge', 'jobportal'),
			'type'    => Controls_Manager::SELECT,
			'default' => '',
			'options' => [
				''       => esc_html__('None', 'jobportal'),
				'new'    => esc_html__('New', 'jobportal'),
				'hot'    => esc_html__('Hot', 'jobportal'),
				'coming' => esc_html__('Coming Soon', 'jobportal'),
			],
		]);

		$repeater->add_control('text_badge', [
			'label' => __('Text', 'jobportal'),
			'type' => Controls_Manager::TEXT,
			'dynamic' => [
				'active' => true,
			],
			'placeholder' => __('Text', 'jobportal'),
			'condition' => [
				'badge!' => '',
			],
		]);
...
<?php
	...
	{
		$this->add_render_attribute('wrapper', 'class', "jobportal-view-demo');
	}
}
