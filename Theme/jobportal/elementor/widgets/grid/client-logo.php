...
class Widget_Client_Logo extends Static_Grid
{
	...
	{
		return "jobportal-client-logo';
	}

	public function get_title()
	{
		return esc_html__('Client Logo', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-client-logo'];
    }
	...
	protected function register_controls()
	{
		...
		$this->add_control('hover', [
			'label'   => esc_html__('Hover Type', 'jobportal'),
			'type'    => Controls_Manager::SELECT,
			'options' => [
				''          => esc_html__('None', 'jobportal'),
				'grayscale' => esc_html__('Grayscale to normal', 'jobportal'),
				'opacity'   => esc_html__('Opacity to normal', 'jobportal'),
				'faded'     => esc_html__('Normal to opacity', 'jobportal'),
			],
			'default' => '',
		]);
...
?>
		<div class="item">
			...
			<?php if (!empty($item['link']['url'])) { ?>
				...
				<div class="image">
					<img src="<?php echo esc_url($item['logo']['url']); ?>" alt="<?php esc_attr_e('Client Logo', 'jobportal'); ?>">
				</div>
...
<?php
	...
	protected function before_grid()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-client-logo');
