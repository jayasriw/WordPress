...
abstract class Grid_Base extends Base
{
	...
	protected function add_grid_options_section()
	{
		...
		$this->add_responsive_control('grid_column_gutter', [
			'label'     => esc_html__('Column Gutter', 'jobportal'),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
		...
		$this->add_responsive_control('grid_row_gutter', [
			'label'     => esc_html__('Row Gutter', 'jobportal'),
			'type'      => Controls_Manager::NUMBER,
			'min'       => 0,
			'max'       => 200,
			'step'      => 1,
		...
		$this->add_responsive_control('grid_content_position', [
			'label'                => esc_html__('Content Position', 'jobportal'),
			'type'                 => Controls_Manager::SELECT,
			'default'              => '',
			'options'              => [
				''       => esc_html__('Default', 'jobportal'),
				'top'    => esc_html__('Top', 'jobportal'),
				'middle' => esc_html__('Middle', 'jobportal'),
		...
		$this->add_responsive_control('grid_content_alignment', [
			...
			'options'              => [
				...
				'center' => esc_html__('Center', 'jobportal'),
		...
		$this->add_responsive_control('grid_content_padding', [
			'label'      => esc_html__('Item Padding', 'jobportal'),
