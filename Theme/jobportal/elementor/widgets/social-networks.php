...
class Widget_Social_Networks extends Base
{
    ...
    {
        return "jobportal-social-networks';
    }

    public function get_title()
    {
        return esc_html__('Social Networks', 'jobportal');
    }
    ...
    {
        return ["jobportal-el-widget-social-networks'];
    }
    ...
    private function add_content_section()
    {
        ...
        $this->add_control('style', [
            ...
            'options' => [
                'icons'              => esc_html__('Icons', 'jobportal'),
                'large-icons'        => esc_html__('Large Icons', 'jobportal'),
                'flat-rounded-icon'  => esc_html__('Flat Rounded Icon', 'jobportal'),
                'solid-rounded-icon' => esc_html__('Solid Rounded Icon', 'jobportal'),
                'icon-title'         => esc_html__('Icon + Title', 'jobportal'),
        ...
        $this->add_control('layout', [
            ...
            'type'    => Controls_Manager::SELECT,
            'options' => [
                'inline'      => esc_html__('Inline', 'jobportal'),
                'list'        => esc_html__('List', 'jobportal'),
                'two-columns' => esc_html__('2 Columns', 'jobportal'),
            ],
            'default' => 'inline',
        ]);
        ...
        $repeater->add_control('title', [
            ...
            'type'        => Controls_Manager::TEXT,
            'default'     => esc_html__('Title', 'jobportal'),
            'label_block' => true,
        ]);
        ...
        $this->add_control('items', [
            ...
            'default'     => [
                [
                    'title' => esc_html__('Facebook', 'jobportal'),
                    'link'  => [
                        'url'         => '#',
                        'is_external' => true,
                        'nofollow'    => true,
                ...
                [
                    'title' => esc_html__('Twitter', 'jobportal'),
                    'link'  => [
                        'url'         => '#',
                        'is_external' => true,
                        'nofollow'    => true,
                ...
                [
                    'title' => esc_html__('Instagram', 'jobportal'),
                    'link'  => [
                        'url'         => '#',
                        'is_external' => true,
                        'nofollow'    => true,
                ...
                [
                    'title' => esc_html__('Linkedin', 'jobportal'),
                    'link'  => [
                        'url'         => '#',
                        'is_external' => true,
                        'nofollow'    => true,
    ...
    private function add_style_section()
    {
        ...
        $this->add_control('items_vertical_spacing', [
            'label'      => esc_html__('Items Vertical Spacing', 'jobportal'),
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'class', "jobportal-social-networks');
    ...
    protected function content_template()
    {
        // @formatter:off
        ?>
        <div class="jobportal-social-networks style-{{ settings.style }} layout-{{ settings.layout }}">
            <ul class="list">
