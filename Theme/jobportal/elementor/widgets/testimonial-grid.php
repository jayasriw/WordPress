...
class Widget_Testimonial_Grid extends Base
{
	...
	{
		return "jobportal-testimonial-grid';
	}

	public function get_title()
	{
		return esc_html__('Testimonial Masonry', 'jobportal');
	}
	...
	{
		return ["jobportal-group-widget-grid', "jobportal-grid-layout'];
	}

	public function get_style_depends()
	{
		return ["jobportal-el-widget-testimonial-grid'];
	}
	...
	private function add_content_section()
	{
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					...
					'position'  => esc_html__('CEO', 'jobportal'),
				],
				[
					'thumbnail' => ['url' => $placeholder_image_src],
					'content'   => esc_html__('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'jobportal'),
		...
		$this->add_group_control(Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__('Thumbnail Size', 'jobportal'),
				],
			],
		]);
		...
		$this->add_group_control(Group_Control_Image_Size::get_type(), [
			...
			'fields_options' => [
				'size' => [
					'label' => esc_html__('Avatar Size', 'jobportal'),
				],
			],
		]);
	...
	private function add_thumbnail_style_section()
	{
		...
		$this->add_group_control(Group_Control_Css_Filter::get_type(), [
			'name'     => 'css_filters',
			'selector' => '{{WRAPPER}} .jobportal-image img',
		]);
		...
		$this->add_control('thumbnail_opacity', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-image img' => 'opacity: {{SIZE}};',
			],
		]);
		...
		$this->add_group_control(Group_Control_Box_Shadow::get_type(), [
			...
			'selector' => '{{WRAPPER}} .jobportal-box:hover .jobportal-image',
		]);

		$this->add_group_control(Group_Control_Css_Filter::get_type(), [
			'name'     => 'css_filters_hover',
			'selector' => '{{WRAPPER}} .jobportal-box:hover .jobportal-image img',
		]);
		...
		$this->add_control('thumbnail_opacity_hover', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-box:hover .jobportal-image img' => 'opacity: {{SIZE}};',
			],
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', [
			'class' => [
				"jobportal-grid-wrapper',
			],
		]);

		$this->add_render_attribute('content-wrapper', 'class', "jobportal-grid lazy-grid');
...
?>
				...
				<?php foreach ($settings['items'] as $item) : ?>
					...
					<div <?php $this->print_attributes_string($this->get_current_key()); ?>>
						...
						$this->add_render_attribute($this->get_current_key() . '-testimonial', [
							'class' => "jobportal-box testimonial-item',
						]);
						?>
	...
	?>
		<div class="jobportal-image thumbnail">
			<?php echo \JobPortal_Image::get_elementor_attachment([
				'settings'       => $item,
				'image_key'      => 'thumbnail',
	...
	?>
		...
		<?php if ($item['content']) : ?>
			<div class="content">
				...
				<div class="text">
					<?php echo wp_kses($item['content'], "jobportal-default'); ?>
				</div>
			</div>
		<?php endif; ?>
