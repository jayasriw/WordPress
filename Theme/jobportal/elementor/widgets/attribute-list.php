...
class Widget_Attribute_List extends Base
{
	...
	{
		return "jobportal-attribute-list';
	}

	public function get_title()
	{
		return esc_html__('Attribute List', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-attribute-list'];
    }
	...
	protected function register_controls()
	{
		...
		$repeater->add_control('name', [
			...
			'default'     => esc_html__('Name', 'jobportal'),
			'label_block' => true,
		]);

		$repeater->add_control('value', [
			'label' => esc_html__('Value', 'jobportal'),
		...
		$this->add_control('items', [
			...
			'default'     => [
				[
					'name'  => esc_html__('Attribute #1', 'jobportal'),
					'value' => esc_html__('Value #1', 'jobportal'),
				],
				[
					'name'  => esc_html__('Attribute #2', 'jobportal'),
					'value' => esc_html__('Value #2', 'jobportal'),
				],
			],
			'title_field' => '{{{ name }}}',
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-attribute-list');
		...
		<div <?php $this->print_attributes_string('wrapper'); ?>>
			<div class="inner">
				<div class="list">
					...
					?>
							<div class="item">
								<h6 class="name"><?php esc_html_e($attribute['name']); ?></h6>
								<div class="value"><?php echo wp_kses($attribute['value'], "jobportal-default'); ?></div>
							</div>
					<?php
						}
					}
