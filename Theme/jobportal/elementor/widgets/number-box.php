...
class Widget_Number_Box extends Base
{
	...
	{
		return "jobportal-number-box';
	}

	public function get_title()
	{
		return esc_html__('Modern Number Box', 'jobportal');
	}
	...
	{
		return ["jobportal-el-widget-number-box'];
	}
	...
	private function add_number_box_section()
	{
		$this->start_controls_section('icon_box_section', [
			'label' => esc_html__('Number Box', 'jobportal'),
		]);
		...
		$this->add_control('style', [
			...
			'default'      => '01',
			'prefix_class' => "jobportal-number-box-style-',
		]);

		$this->add_control('number', [
			'label'       => esc_html__('Number', 'jobportal'),
			'type'        => Controls_Manager::TEXT,
			'default'     => esc_html__('1', 'jobportal'),
		]);
		...
		$this->add_control('enable_icon', [
			'label' => esc_html__('Enable Icon', 'jobportal'),
	...
	private function add_desc_style_section()
	{
		$this->start_controls_section('desc_style_section', [
			'label'     => esc_html__('Desc', 'jobportal'),
			'tab'       => Controls_Manager::TAB_STYLE,
		]);
	...
	private function add_icon_style_section()
	{
		...
		$this->add_responsive_control('icon_size', [
			...
			'selectors' => [
				'{{WRAPPER}} .jobportal-icon' => 'font-size: {{SIZE}}{{UNIT}};',
			],
		]);
		...
		$this->add_control('icon_padding', [
			...
			'type'      => Controls_Manager::SLIDER,
			'selectors' => [
				'{{WRAPPER}} .jobportal-icon' => 'padding: {{SIZE}}{{UNIT}};',
			],
			'range'     => [
				'em' => [
					'min' => 0,
		...
		$this->add_control('icon_border_radius', [
			...
			'size_units' => ['px', '%'],
			'selectors'  => [
				'{{WRAPPER}} .jobportal-icon' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
