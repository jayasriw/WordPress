...
class Widget_Image_Rotate extends Base
{
	...
	{
		return "jobportal-image-rotate';
	}

	public function get_title()
	{
		return esc_html__('Image Rotate', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-image-rotate'];
    }
	...
	private function add_image_rotate_section()
	{
		$this->start_controls_section('image_section', [
			'label' => esc_html__('Image Rotate', 'jobportal'),
		]);

		$this->add_control('postion', [
			'label'     => esc_html__('Position Animation', 'jobportal'),
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', "jobportal-image-rotate jobportal-box');
...
?>
		...
		<div class="content-wrap">
			...
			<?php if (!empty($settings['image']['url'])) : ?>
				<div class="layer jobportal-image image">
	...
	?>
		<div <?php $this->print_render_attribute_string('description_text'); ?>>
			<?php echo wp_kses($settings['description_text'], "jobportal-default'); ?>
		</div>
<?php
	}
}
