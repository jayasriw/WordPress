...
class Widget_Mailchimp_Form extends Form_Base
{
	...
	{
		return "jobportal-mailchimp-form';
	}

	public function get_title()
	{
		return esc_html__('Mailchimp Form', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-mailchimp-form'];
    }
	...
	private function add_content_section()
	{
		...
		$this->add_control('form_id', [
			'label'       => esc_html__('Form Id', 'jobportal'),
			'description' => esc_html__('Input the id of form. Leave blank to show default form.', 'jobportal'),
		...
		$this->add_control('style', [
			...
			'default'      => '01',
			'prefix_class' => "jobportal-mailchimp-form-style-',
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('box', 'class', "jobportal-mailchimp-form');
?>
