...
class Widget_Contact_Form_7 extends Form_Base
{
	...
	{
		return "jobportal-contact-form-7';
	}

	public function get_title()
	{
		return esc_html__('Contact Form 7', 'jobportal');
	}
    ...
    {
        return ["jobportal-el-widget-contact-form-7'];
    }
	...
	private function get_form_list()
	{
		...
		if ($cf7) {
			...
			$forms[0] = esc_html__('No contact forms found', 'jobportal');
		}
    ...
    protected function add_field_contact_style_section()
    {
        $this->start_controls_section('form_field_style_section', [
            'label' => esc_html__('Field', 'jobportal'),
        ...
        $this->start_controls_tab('field_colors_focus_tab', [
            'label' => esc_html__('Focus', 'jobportal'),
        ]);
	...
	private function add_content_section()
	{
		...
		$this->add_control('form_id', [
			'label'   => esc_html__('Select Form', 'jobportal'),
		...
		$this->add_control('style', [
			...
			'default'      => '01',
			'prefix_class' => "jobportal-contact-form-style-',
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('box', 'class', "jobportal-contact-form-7');
?>
