...
class Group_Control_Advanced_Border extends Group_Control_Base
{
	...
	protected function init_fields()
	{
		...
		$fields['type'] = [
			'label'     => _x('Type', 'Border Control', 'jobportal'),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __('Default', 'jobportal'),
				'none'   => __('None', 'jobportal'),
				'solid'  => _x('Solid', 'Border Control', 'jobportal'),
				'double' => _x('Double', 'Border Control', 'jobportal'),
				'dotted' => _x('Dotted', 'Border Control', 'jobportal'),
				'dashed' => _x('Dashed', 'Border Control', 'jobportal'),
				'groove' => _x('Groove', 'Border Control', 'jobportal'),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x('Color', 'Border Control', 'jobportal'),
		...
		$fields['width'] = [
			'label'      => _x('Width', 'Border Control', 'jobportal'),
		...
		$fields['radius'] = [
			'label'      => _x('Rounded', 'Border Control', 'jobportal'),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => ['px', '%'],
			'selectors'  => [
	...
	protected function get_default_options()
	{
		return [
			'popover' => [
				'starter_title' => _x('Border', 'Advanced Border Control', 'jobportal'),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
