...
class Font_Awesome_Pro
{
	...
	{
		$json_url = JOBPORTAL_ELEMENTOR_ASSETS . '/libs/font-awesome-pro/%s.json';
		$version  = '5.10.0-pro';
		...
		$icons['fa-regular'] = array_merge($default_icon_config, [
			'name'          => 'fa-regular',
			'label'         => esc_html__('Font Awesome - Regular Pro', 'jobportal'),
			'displayPrefix' => 'far',
		...
		$icons['fa-solid'] = array_merge($default_icon_config, [
			'name'          => 'fa-solid',
			'label'         => esc_html__('Font Awesome - Solid Pro', 'jobportal'),
			'displayPrefix' => 'fas',
		...
		$icons['fa-brands'] = array_merge($default_icon_config, [
			'name'          => 'fa-brands',
			'label'         => esc_html__('Font Awesome - Brands Pro', 'jobportal'),
			'displayPrefix' => 'fab',
		...
		$icons['fa-light'] = array_merge($default_icon_config, [
			'name'          => 'fa-light',
			'label'         => esc_html__('Font Awesome - Light Pro', 'jobportal'),
			'displayPrefix' => 'fal',
