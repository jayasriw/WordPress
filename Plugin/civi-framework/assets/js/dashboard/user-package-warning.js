var CIVI_USER_PACKAGE_WARNING = CIVI_USER_PACKAGE_WARNING || {};
(function ($) {
  "use strict";

  CIVI_USER_PACKAGE_WARNING = {
    init: function () {
    ...
    checkOldPackage: function () {
      var self = this;
      var $newPackageLink = $("#civi-new-package-link");
      ...
      $newPackageLink.on("click", function (e) {
        ...
        if (typeof civi_package_vars !== "undefined") {
          var ajax_url = civi_package_vars.ajax_url;
          var nonce = civi_package_vars.nonce;
          var action = civi_package_vars.action || "civi_check_old_package_before_activate";
    ...
    showWarningModal: function (packageInfo, redirectUrl) {
      var $modal = $("#civi-package-warning-modal");
    ...
    hideWarningModal: function () {
      $("#civi-package-warning-modal").fadeOut(300);
    },

    modalEvents: function () {
      var self = this;
      var $modal = $("#civi-package-warning-modal");
      var $overlay = $modal.find(".civi-modal-overlay");
      var $closeBtn = $modal.find(".civi-modal-close");
      var $cancelBtn = $modal.find(".civi-modal-cancel");
      var $confirmBtn = $modal.find(".civi-modal-confirm");
  ...
  $(document).ready(function () {
    CIVI_USER_PACKAGE_WARNING.init();
  });
})(jQuery);
