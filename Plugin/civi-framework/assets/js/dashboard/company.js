(function ($) {
  ...
  var ajax_url = civi_company_dashboard_vars.ajax_url,
    not_company = civi_company_dashboard_vars.not_company;
  ...
  $(document).ready(function () {
    ...
    function ajax_load(item_id = "", action_click = "") {
      ...
      $.ajax({
        ...
        data: {
          action: "civi_filter_company_dashboard",
          item_amount: item_amount,
          paged: paged,
          item_id: item_id,
          action_click: action_click,
          security: civi_company_dashboard_vars.delete_company,
        },
        beforeSend: function () {
          company_dashboard
        ...
        success: function (data) {
          if (data.success === true) {
            ...
            if (paged > 1) {
              paged = paged - 1;
              company_dashboard.find(".civi-pagination").find('input[name="paged"]').val(paged);
              ajax_load();
              return;
            }
            company_dashboard
