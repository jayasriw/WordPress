/**
 * Autocomplete Fix for Civi Framework
 */
...
(function($) {
    ...
    function updateLocationFields(place) {
        ...
        $('input[name="civi_map_location"]').val(lat + ',' + lng);
        $('input[name="civi_longtitude"]').val(lng);
        $('input[name="civi_latitude"]').val(lat);
        $('input[name="civi_map_address"]').val(address);
