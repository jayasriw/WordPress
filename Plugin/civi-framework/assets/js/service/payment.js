        ...
        if (typeof civi_payment_vars !== "undefined") {
            ...
            $("#civi_payment_service").on("click", function (event) {
                ...
                if (payment_method == "paypal") {
                    ...
                    civi_razor_payment_project_addons(service_id);
                }
            });
            ...
            function civi_razor_payment_project_addons (service_id) {
                let package_addons = [];
                ...
                $.ajax({
                    ...
                    url: ajax_url,
                    data: {
                        action: "civi_razor_service_create_order",
                        service_id: service_id,
                        civi_service_security_payment: $(
                            "#civi_service_security_payment"
                        ).val(),
                    ...
                    success: function (order) {
                        ...
                        order.modal = {
                            ondismiss: function() {
                                setDisabled('civi_payment_service', false);
                            },
                        };
                        ...
                        order.handler = function(payment) {
                            ...
                            $.ajax({
                                url: ajax_url,
                                data: {
                                    action: "civi_razor_service_payment_verify",
