jQuery(document).ready(function ($) {
  var ajax_url = civi_company_review_vars.ajax_url;
  ...
  $("body").on("click", ".form-reply .civi-submit-company-reply", function (e) {
    e.preventDefault();
    var $this = $(this);
  ...
  $(".reviewForm").validate({
    ...
    submitHandler: function (form) {
      var $this = $(".reviewForm").find(".civi-submit-company-rating");
      var $form = $(".reviewForm");
