    ...
    COMPANY.elements = {
        ...
        display_clear: function () {
            ...
            var has_filter_active = (
                ...
                ($("select.civi-select-country").val() !== '' && $("select.civi-select-country").val() !== null)
            );

            $('.civi-menu-filter input[type="checkbox"]:checked').closest(".entry-filter").addClass("open");
            if ($("select.civi-select-country").val() !== '' && $("select.civi-select-country").val() !== null) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (pagination === "pagination") {
                        COMPANY.elements.scroll_to(".area-company .civi-company-item:first");
                    }
                },
            });
        },
