...
class Widget_Candidate_Box extends Widget_Base
{
    ...
    {
        return 'civi-candidate-box';
    }

    public function get_title()
    {
        return esc_html__('Candidate Box', 'civi-framework');
    }
    ...
    {
        return [CIVI_PLUGIN_PREFIX . 'candidate-box'];
    }
    ...
    private function register_layout_section()
    {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-carousel .civi-candidate-item' => 'padding-left: calc({{SIZE}}{{UNIT}}/2); padding-right: calc({{SIZE}}{{UNIT}}/2)',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-carousel .civi-candidate-item' => 'padding-top: calc({{SIZE}}{{UNIT}}/2); padding-bottom: calc({{SIZE}}{{UNIT}}/2)',
    ...
    private function register_layout_style_section()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .civi-candidate-item',
            ]
        );
        ...
        $this->add_control('box_padding', [
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .civi-candidate-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_control('layout_border_radius', [
            ...
            'size_units' => ['px', '%'],
            'selectors' => [
                '{{WRAPPER}} .civi-candidate-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
            ],
        ]);
        ...
        $this->add_control(
            'heading_position',
            [
                'label' => __('Position', 'civi-framework'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'class', 'civi-candidate');
        $args = array(
        ...
        $tax_query = array(
            array(
                'key' => 'civi-enable_candidate_package_expires',
                'value' => 0,
                'compare' => '=='
            )
        );
        ...
        if ($settings['type_query'] == 'orderby') {
            if (!empty($settings['orderby'])) {
                if ($settings['orderby'] == 'featured') {
                    $meta_query[] = array(
                        'key' => CIVI_METABOX_PREFIX . 'candidate_featured',
                        'value' => 1,
                        'type' => 'NUMERIC',
                        'compare' => '=',
                    );
