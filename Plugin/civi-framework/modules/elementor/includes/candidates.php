...
class Widget_Candidates extends Widget_Base
{
    ...
    {
        return [CIVI_PLUGIN_PREFIX . 'candidates'];
    }
    ...
    private function register_query_section()
    {
        ...
        $taxonomies  = array(
            ...
            esc_html__("Location", 'civi-framework') => "candidate_locations",
            esc_html__("Age", 'civi-framework') => "candidate_ages",
            esc_html__("Language", 'civi-framework') => "candidate_languages",
            esc_html__("Qualification", 'civi-framework') => "candidate_qualification",
            esc_html__("Experience", 'civi-framework') => "candidate_yoe",
            esc_html__("Level", 'civi-framework') => "candidate_education_levels",
            esc_html__("Skill", 'civi-framework') => "candidate_skills",
        );
