(function ($) {
    ...
    var CiviPaginationHandler = function ($scope, $) {
        ...
        $element.on("click", ".civi-pagination a.page-numbers", function (e) {
            e.preventDefault();

            var $currentWidget = $(this).closest('.civi-jobs');

            $currentWidget.find(".civi-pagination li .page-numbers").removeClass("current");
            ...
            if ($currentWidget.find('input[name="paged"]').val()) {
                current_page = $currentWidget.find(".civi-pagination").find('input[name="paged"]').val();
            }
            ...
            $currentWidget.find(".civi-pagination")
        ...
        function ajax_load($currentWidget) {
            ...
            var type_pagination = $currentWidget.find(".civi-pagination").attr("data-type");
            ...
            paged = $currentWidget.find(".civi-pagination").find('input[name="paged"]').val();
            ...
            $.ajax({
                ...
                beforeSend: function () {
                    $currentWidget.find(".civi-jobs-item").addClass("skeleton-loading");
                ...
                success: function (data) {
                    ...
                    $currentWidget.find(".civi-jobs-item").removeClass("skeleton-loading");
                    ...
                    if (type_pagination == "number") {
                        ...
                        if (data.hidden_pagination) {
                            $currentWidget.find(".civi-pagination .pagination").html("");
                        }
                    }
                },
