...
if (!class_exists("Civi_Shortcode_Jobs")) {
    ...
    class Civi_Shortcode_Jobs
    {
        ...
        public function __construct()
        {
            ...
            add_shortcode("civi_payment", [$this, "payment"]);
        ...
        public function dashboard_employer()
        {
            ob_start();
            global $current_user;
            if (in_array("civi_user_employer", (array)$current_user->roles) || current_user_can('administrator')) {
...
?>
        ...
        public function dashboard_candidate()
        {
            ob_start();
            global $current_user;
            if (in_array("civi_user_candidate", (array)$current_user->roles) || current_user_can('administrator')) {
        ...
        public function messages()
        {
            ob_start();
            global $current_user;
            if (in_array("civi_user_employer", (array)$current_user->roles) || in_array("civi_user_candidate", (array)$current_user->roles) || current_user_can('administrator')) {
