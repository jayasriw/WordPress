...
?>
        ...
        public function user_package_available($user_id)
        {
            ...
            $args_invoice = apply_filters('civi_modify_author_query_args', $args_invoice);
        ...
        public function update_custom_user_profile_fields($user_id)
        {
            ...
            if (current_user_can('edit_user', $user_id)) {
                ...
                $old_user_status = get_user_meta($user_id, CIVI_METABOX_PREFIX . 'user_status', true);
        ...
        private function sync_candidate_post_status($user_id, $user_status)
        {
            ...
            if (!empty($candidate_post_id)) {
                ...
                update_post_meta($candidate_post_id, CIVI_METABOX_PREFIX . 'candidate_approval_status', $user_status);
        ...
        private function sync_company_post_status($user_id, $user_status)
        {
            ...
            if (!empty($company_post_id)) {
                ...
                wp_update_post($post_data);
                update_post_meta($company_post_id, CIVI_METABOX_PREFIX . 'company_approval_status', $user_status);
