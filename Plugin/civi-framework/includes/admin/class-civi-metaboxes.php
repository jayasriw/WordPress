...
?>
        ...
        public function invoice_meta($object)
        {
            ...
            $invoice_pdf_id = get_post_meta($object->ID, CIVI_METABOX_PREFIX . 'invoice_pdf_id', true);
        ...
        ?>
            <table class="form-table">
                <tbody>
                    ...
                    ?>
                        <tr>
                            <th scope="row"><?php esc_html_e('PDF Link:', 'civi-framework'); ?></th>
                            <td><a href="<?php echo esc_url($attachment_url); ?>" target="_blank"><?php esc_html_e('Download', 'civi-framework'); ?></a></td>
                        </tr>
                    <?php
                    }
                    ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <strong><?php echo $civi_meta['invoice_payment_type']; ?></strong>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row">
