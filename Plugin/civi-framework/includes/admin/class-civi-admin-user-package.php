    ...
    class Civi_User_Package_Admin
    {
        ...
        public function filter_restrict_manage_user_package()
        {
            ...
            if ($typenow == $post_type) { ?>
                <input type="text" placeholder="<?php esc_html_e('Buyer', 'civi-framework'); ?>" name="package_user" value="<?php echo (isset($_GET['package_user']) ? esc_attr(civi_clean(wp_unslash($_GET['package_user']))) : ''); ?>">
<?php }
        }
