...
if (!class_exists('Civi_Breadcrumb')) {

    /**
     *  Class Civi_Breadcrumb
     */
    class Civi_Breadcrumb
    {
        ...
        public static function breadcrumb($args = '')
        {
            ...
            $default = array(
                'type' => 'list',
                'home_label' => esc_html__('Home', 'civi-framework'),
                'search_label' => esc_html__('Search Result of "%s"', 'civi-framework'),
                '404_label' => esc_html__('404 Not Found', 'civi-framework'),
                'category_label' => _x('%s', 'category label', 'civi-framework'),
                'tag_label' => _x('%s', 'tag label', 'civi-framework'),
                'taxonomy_label' => _x('%s', 'taxonomy label', 'civi-framework'),
                'author_label' => _x('%s', 'author label', 'civi-framework'),
                'attachment_label' => _x('%s', 'attachment label', 'civi-framework'),
                'year_label' => _x('%s', 'year label', 'civi-framework'),
                'month_label' => _x('%s', 'month label', 'civi-framework'),
                'day_label' => _x('%s', 'day label', 'civi-framework'),
                'post_type_label' => _x('%s', 'post type label', 'civi-framework'),
                'joint_string' => esc_html__(' &gt; ', 'civi-framework'),
                'navi_element' => '',
                'elm_class' => 'civi_breadcrumb',
                'elm_id' => '',
                'li_class' => '',
                'class_prefix' => '',
            ...
            $default = apply_filters('civi_breadcrumb_default', $default);
            ...
            if ($args['type'] == 'string') {
                ...
                $output = apply_filters('civi_breadcrumb_after', $output, $args);
            } else {
                ...
                $output = apply_filters('civi_breadcrumb_before', $output, $args);
            ...
            $output = apply_filters('civi_breadcrumb', $output, $args);
        ...
        public static function get_breadcrumb_array($args)
        {
            ...
            return apply_filters('civi_breadcrumb_arr', $breadcrumb_arr, $args);
        }
