 ...
 *
 * Override WooCommerce price formatting to use Civi theme options
 *
...
/**
 * Class Civi_WooCommerce_Integration
 */
class Civi_WooCommerce_Integration
{
    /**
    ...
    public function woocommerce_price_html($price, $product)
    {
        if (function_exists('civi_get_format_money')) {
            ...
            if ($price_value > 0) {
                return civi_get_format_money($price_value, '', null, false);
            }
        }
        return $price;
    }
...
new Civi_WooCommerce_Integration();
