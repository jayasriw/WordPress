...
<div class="<?php echo join(' ', $candidate_item_class); ?>">
            ...
            <div class="candidate-status-inner">
                ...
                if ($button_type !== 'service-bottom') {
                    if ($button_type === 'service-top') {
                        echo '<a class="civi-button button-outline-accent" href="' . get_the_permalink($candidate_id) . '">' . esc_html__('View Profile', 'civi-framework') . '</a>';
                    } else {
                        civi_get_template('candidate/follow.php', array(
    ...
    <?php if ($button_type === 'service-bottom') {
        echo '<a class="civi-button button-outline-accent button-block" href="' . get_the_permalink($candidate_id) . '">' . esc_html__('View Profile', 'civi-framework') . '</a>';
    } ?>
