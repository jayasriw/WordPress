...
wp_enqueue_script(CIVI_PLUGIN_PREFIX . 'candidate-review');
wp_localize_script(
    CIVI_PLUGIN_PREFIX . 'candidate-review',
    'civi_candidate_review_vars',
    array(
...
$check_candidate_package = civi_get_field_check_candidate_package('review_and_commnent');
$check_employer_package = civi_get_field_check_employer_package('review_and_commnent');
...
<div class="candidate-review-details block-archive-inner">
    <h3 class="title-candidate"><?php esc_html_e('Review', 'civi-framework'); ?></h3>
        ...
        <div class="rating-bars">
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Working attitude', 'civi-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Progressive working attitude', 'civi-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Progressive working attitude', 'civi-framework'); ?></div>
                    </div>
                </div>
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Team work', 'civi-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Good teamwork spirit', 'civi-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Good teamwork spirit', 'civi-framework'); ?></div>
                    </div>
                </div>
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Skill & Experience', 'civi-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Skills and experience meet well', 'civi-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Skills and experience meet well', 'civi-framework'); ?></div>
                    </div>
                </div>
                <span class="rating-bars-inner">
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Offered Salary', 'civi-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Suitable salary', 'civi-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Suitable salary', 'civi-framework'); ?></div>
                    </div>
                </div>
                <span class="rating-bars-inner">
    ...
    <div class="entry-detail">
        ...
        <?php
            ...
            <?php if ((in_array("civi_user_candidate", (array)$current_user->roles) && ($check_candidate_package == -1 || $check_candidate_package == 0))
                || (in_array("civi_user_employer", (array)$current_user->roles) && ($check_employer_package == -1 || $check_employer_package == 0))
            ) { ?>
                <div class="add-new-review">
                    <h4 class="review-title"><?php esc_html_e('Write a Review', 'civi-framework'); ?></h4>
                    <p class="notice">
                        <i class="fal fa-exclamation-circle"></i>
                        <?php esc_html_e("Please renew the package for review and comment", "civi-framework"); ?>
                    </p>
                </div>
            <?php } ?>
            <?php if (
                $post_author_id != $userID
                && (in_array("civi_user_candidate", (array)$current_user->roles) && ($check_candidate_package == 1 || $check_candidate_package == 2)
                    || (in_array("civi_user_employer", (array)$current_user->roles) && ($check_employer_package == 1 || $check_employer_package == 2)
                        || (!in_array("civi_user_employer", (array)$current_user->roles) && !in_array("civi_user_candidate", (array)$current_user->roles))
                    ))
            ) { ?>
                <div class="add-new-review">
                    <h4 class="review-title"><?php esc_html_e('Write a Review', 'civi-framework'); ?></h4>
                        ...
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Working attitude', 'civi-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Progressive working attitude', 'civi-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Progressive working attitude', 'civi-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Team work', 'civi-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Good teamwork spirit', 'civi-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Good teamwork spirit', 'civi-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Skill & Experience', 'civi-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Skills and experience meet well', 'civi-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Skills and experience meet well', 'civi-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Offered Salary', 'civi-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Suitable salary', 'civi-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Suitable salary', 'civi-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="civi-submit-candidate-rating civi-button button-icon-right"><span><?php esc_html_e('Submit Review', 'civi-framework'); ?></span></button>
                            <?php wp_nonce_field('civi_submit_review_ajax_nonce', 'civi_security_submit_review'); ?>
                            <input type="hidden" name="action" value="civi_candidate_submit_review_ajax">
                    ...
                    ?>
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            ...
                            <button type="submit" class="civi-submit-candidate-rating civi-button button-icon-right"><span><?php esc_html_e('Update Review', 'civi-framework'); ?></span></button>
                            <?php wp_nonce_field('civi_submit_review_ajax_nonce', 'civi_security_submit_review'); ?>
                            <input type="hidden" name="action" value="civi_candidate_submit_review_ajax">
                            <input type="hidden" name="candidate_id" value="<?php the_ID(); ?>">
                        </form>
    ...
    <div class="duplicate-form-reply hide none">
        ...
        <form method="post" class="repreviewForm" action="#">
            ...
            <button type="submit" class="civi-submit-candidate-reply civi-button"><?php esc_html_e('Send', 'civi-framework'); ?></button>
            <?php wp_nonce_field('civi_submit_reply_ajax_nonce', 'civi_security_submit_reply'); ?>
            <input type="hidden" name="action" value="civi_candidate_submit_reply_ajax">
            <input type="hidden" name="candidate_id" value="<?php the_ID(); ?>">
