...
<div id="civi-package-impact-modal" class="civi-modal civi-package-impact-modal" style="display: none;">
        ...
        <div class="civi-modal-body">
            ...
            <div class="civi-impact-section civi-impact-cleanup" style="display: none;">
                ...
                <p class="civi-impact-cleanup-note">
                    <?php esc_html_e('Latest items will be removed/cancelled first.', 'civi-framework'); ?>
                </p>
            </div>
