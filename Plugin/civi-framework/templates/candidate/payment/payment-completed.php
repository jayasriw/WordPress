...
elseif ($candidate_payment_method == 4) {
    $civi_candidate_payment->razor_candidate_payment_completed();
}
?>
<div class="civi-payment-completed-wrap">
    <div class="inner-payment-completed">
        ...
        if (isset($_GET['order_id']) && $_GET['order_id'] != '') :
            ...
            $candidate_wire_transfer_card_number = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_card_number', '') : '';
            $candidate_wire_transfer_card_name = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_card_name', '') : '';
            $candidate_wire_transfer_bank_name = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_bank_name', '') : '';
            $candidate_wire_transfer_bank_address = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_bank_address', '') : '';
            $candidate_wire_transfer_swift_bic = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_swift_bic', '') : '';
            $candidate_wire_transfer_iban = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_iban', '') : '';
            $candidate_wire_transfer_routing_number = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_routing_number', '') : '';
            $candidate_wire_transfer_info = $is_wire_transfer ? civi_get_option('candidate_wire_transfer_info', '') : '';
            ?>
            ...
            <div class="panel panel-default">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item">
                        ...
                        <strong class="pull-right">
                            ...
                            $payment_method_display = isset($order_meta['candidate_order_payment_method'])
                                ? Civi_candidate_order::get_candidate_order_payment_method($order_meta['candidate_order_payment_method'])
                    ...
                    <li class="list-group-item">
                        ...
                        <strong class="pull-right"><?php echo isset($order_meta['candidate_order_item_price']) ? civi_get_format_money($order_meta['candidate_order_item_price']) : ''; ?></strong>
                    </li>
                </ul>
            </div>
