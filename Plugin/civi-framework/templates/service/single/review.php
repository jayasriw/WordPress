...
wp_enqueue_script(CIVI_PLUGIN_PREFIX . 'service-review');
wp_localize_script(
    CIVI_PLUGIN_PREFIX . 'service-review',
    'civi_service_review_vars',
    array(
...
$service_rating = get_post_meta($service_id, CIVI_METABOX_PREFIX . 'service_rating', true);
...
?>
<div class="civi-block-inner block-archive-inner service-review-details" id="service-review-details">
    <h3 class="title-service"><?php esc_html_e('Review', 'civi-framework'); ?></h3>
    ...
    <div class="entry-overview">
        <div class="rating-bars">
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Work Speed', 'civi-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Does the speed of project completion meet the deadline?', 'civi-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Does the speed of project completion meet the deadline?', 'civi-framework'); ?></div>
                    </div>
                </div>
                <div class="rating-bars-inner">
                ...
                <div class="add-new-review">
                    ...
                    ?>
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Work Speed', 'civi-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Does the speed of project completion meet the deadline?', 'civi-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Does the speed of project completion meet the deadline?', 'civi-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="civi-submit-service-rating civi-button button-icon-right">
                            ...
                            <input type="hidden" name="action" value="civi_service_submit_review_ajax">
    ...
    <div class="duplicate-form-reply hide none">
        ...
        <form method="post" class="repreviewForm" action="#">
            ...
            <button type="submit" class="civi-submit-service-reply civi-button"><?php esc_html_e('Send', 'civi-framework'); ?></button>
            <?php wp_nonce_field('civi_submit_reply_ajax_nonce', 'civi_security_submit_reply'); ?>
            <input type="hidden" name="action" value="civi_service_submit_reply_ajax">
            <input type="hidden" name="service_id" value="<?php the_ID(); ?>">
