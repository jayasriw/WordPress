                ...
                <div class="col-lg-8 col-md-7">
                    <div class="submit-service-header civi-submit-header">
                        <div class="entry-title">
                            <h4><?php esc_html_e('Create New Service', 'civi-framework') ?></h4>
                        </div>
                        <div class="button-wrapper">
                            ...
                            <?php if (($has_candidate_package && $candidate_package_number_service > 0 && $package_status == 1) || $candidate_paid_submission_type !== 'candidate_per_package') { ?>
                                <button type="submit" class="btn-submit-service civi-button" name="submit_service">
                                    <span><?php esc_html_e('Post service', 'civi-framework'); ?></span>
                    ...
                    <?php foreach ($layout as $value) { ?>
                        <div id="tab-<?php echo $value; ?>" class="tab-info">
                            <?php civi_get_template('service/submit/' . $value . '.php'); ?>
                        </div>
                    <?php } ?>

                    <?php wp_nonce_field('civi_service_submit_ajax_nonce', 'civi_security_service_submit'); ?>
