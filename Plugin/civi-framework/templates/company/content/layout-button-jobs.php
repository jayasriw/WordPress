...
$enable_company_review = civi_get_option('enable_single_company_review','1');
...
<div class="<?php echo join(' ', $company_item_class); ?>">
    ...
    <?php if(!empty($company_id)){?>
        <a class="civi-button button-outline-accent button-icon-right" href="<?php echo esc_url(get_post_type_archive_link('jobs')) . '/?company_id=' . $company_id ?>">
            <span><?php esc_html_e('View jobs', 'civi-framework') ?></span><i class="fas fa-external-link-alt"></i>
        </a>
    <?php } ?>
