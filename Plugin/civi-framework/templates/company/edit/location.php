...
$enable_add_new_company_location = civi_get_option('enable_add_new_company_location');
$col = '6';
...
<div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            <div class="select2-field">
                <select name="company_location" class="civi-select2">
                    <?php civi_get_taxonomy_location('company-location', 'company-state', 'company-location-state', 'company-state-country', $company_data->ID); ?>
                </select>
            </div>
        </div>
        <?php if ($enable_add_new_company_location) : ?>
            <div class="form-group col-md-6">
                <label for="company_new_location"><?php esc_html_e('Add New Location', 'civi-framework'); ?></label>
                <input type="text" id="company_new_location" name="company_new_location" value="" placeholder="<?php esc_attr_e('Enter new location', 'civi-framework'); ?>">
            </div>
        <?php endif; ?>
    <?php endif; ?>
    ...
    <?php if (!in_array('fields_company_map', $hide_company_fields)) : ?>
        ...
        <div class="form-group col-md-6">
            <label for="company_longtitude"><?php esc_html_e('Marker longtitude', 'civi-framework'); ?></label>
        ...
        <div class="form-group col-md-6">
            <label for="company_latitude"><?php esc_html_e('Marker latitude', 'civi-framework'); ?></label>
