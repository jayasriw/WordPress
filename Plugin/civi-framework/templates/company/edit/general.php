...
$company_phone_code = isset($company_meta_data[CIVI_METABOX_PREFIX . 'company_phone_code']) ? $company_meta_data[CIVI_METABOX_PREFIX . 'company_phone_code'][0] : '';
...
$enable_add_new_company_categories = civi_get_option('enable_add_new_company_categories');
?>
    ...
    <?php if (!in_array('fields_company_category', $hide_company_fields)) : ?>
            ...
            <div class="select2-field">
                ...
                if ($term_count <= 150): ?>
                    <select name="company_categories" class="civi-select2" data-taxonomy="<?php echo esc_attr($taxonomy); ?>">
                        <?php civi_get_taxonomy_by_post_id($company_id, $taxonomy, true); ?>
                    </select>
                <?php else: ?>
        ...
        <?php if ($enable_add_new_company_categories) : ?>
            <div class="form-group col-md-12">
                <label for="company_new_categories"><?php esc_html_e('Add New Categories', 'civi-framework'); ?></label>
                <input type="text" id="company_new_categories" name="company_new_categories" value="" placeholder="<?php esc_attr_e('Enter new Categories', 'civi-framework'); ?>">
            </div>
        <?php endif; ?>
    <?php endif; ?>
        ...
        <div class="form-group col-md-6">
            ...
            <div class="tel-group">
                <select name="prefix_code" class="civi-select2 prefix-code">
                    ...
                    $selected_prefix = Civi_Helper::get_prefix_key_from_phone($company_phone, $prefix_code, $default_phone);
        ...
        <div class="form-group col-md-6">
            ...
            <div class="select2-field">
                <select name="company_size" class="civi-select2">
                    <?php civi_get_taxonomy_by_post_id($company_data->ID, 'company-size', true, false, true, 'company_size_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
