    ...
    <div class="company-fields-avatar civi-fields-avatar">
        ...
        <div class="form-field">
            ...
            <div id="civi_avatar_container" class="file-upload-block preview">
                <div id="civi_avatar_view" data-image-id="<?php echo esc_attr($company_logo_id); ?>" data-image-url="<?php echo esc_url($company_logo_url); ?>"></div>
        ...
        <div class="field-note"><?php echo sprintf(__('Maximum file size: %s.', 'civi-framework'), esc_html($image_max_file_size)); ?></div>
    </div>
    <?php endif; ?>
    ...
    <div class="company-fields-thumbnail civi-fields-thumbnail">
        ...
        <div class="form-field">
            ...
            <div id="civi_thumbnail_container" class="file-upload-block preview">
                <div id="civi_thumbnail_view" data-image-id="<?php echo esc_attr($company_thumbnail_id); ?>" data-image-url="<?php echo esc_url($company_image_url); ?>"></div>
