...
$tab_active = isset($_GET['tab']) ? civi_clean(wp_unslash($_GET['tab'])) : '';
...
<div class="entry-my-page jobs-performance-dashboard mettings-action-dashboard">
    ...
    <div class="tab-dashboard-active">
        <ul class="tab-list-active">
            <li class="tab-item <?php if ($tab_active == 'statics') { ?>active<?php } ?>"><a href="#tab-statics"><?php esc_html_e('Statics', 'civi-framework'); ?></a></li>
            <li class="tab-item <?php if ($tab_active == 'applicants') { ?>active<?php } ?>"><a href="#tab-applicants"><?php esc_html_e('Applicants', 'civi-framework'); ?>
