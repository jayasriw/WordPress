...
if (isset($_POST['submit'])) {
    ...
    if (!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'civi_verify_id_employer_form_nonce')) {
        ...
        ?>
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <div class="employer-fields-verify-id-before civi-fields-verify-id-before">
                        ...
                        <div class="form-field">
                            ...
                            <div id="civi_verify_id_before_container" class="file-upload-block preview">
                                <div id="civi_verify_id_before_view" data-image-id="<?php echo $employer_verify_id_before_id; ?>" data-image-url="<?php if (!empty($employer_verify_id_before_url)) {
                ...
                <div class="form-group col-md-6">
                    <div class="employer-fields-verify-id-after civi-fields-verify-id-after">
                        ...
                        <div class="form-field">
                            ...
                            <div id="civi_verify_id_after_container" class="file-upload-block preview">
                                <div id="civi_verify_id_after_view" data-image-id="<?php echo $employer_verify_id_after_id; ?>" data-image-url="<?php if (!empty($employer_verify_id_after_url)) {
            ...
            <div class="form-submit">
                <input type="hidden" name="_wpnonce" value="<?php echo wp_create_nonce('civi_verify_id_employer_form_nonce'); ?>" />
