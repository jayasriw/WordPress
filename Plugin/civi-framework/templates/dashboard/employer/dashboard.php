...
$show_jobs_dashboard = civi_get_option( 'show_employer_jobs_dashboard', '1' );
$show_applicants = civi_get_option( 'show_employer_applicants', '1' );
$show_meetings = civi_get_option( 'show_employer_meetings', '1' );
$show_candidates = civi_get_option( 'show_employer_candidates', '1' )
?>
<div class="civi-dashboard civi-dashboard-employer area-main-control">
    <div class="entry-my-page">
        ...
        <div class="notification-dashboard">
            <div class="row">
                <div class="col-md-7">
                    <div class="civi-chart-wrapper civi-chart-employer">
