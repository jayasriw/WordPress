                        ...
                        <tr>
                            ...
                            <td class="action-setting">
                                <div class="list-action">
                                    ...
                                    <?php else : ?>
                                        <a href="#" class="action btn-delete tooltip" athour-id="<?php echo esc_attr($author_id) ?>" follow_company="<?php echo $user_follow_athour; ?>" items-id="<?php echo esc_attr($id); ?>" data-title="<?php echo esc_attr__('Delete', 'civi-framework') ?>"><i class="far fa-trash-alt"></i></a>
                                    <?php endif; ?>
