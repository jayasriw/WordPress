...
wp_enqueue_script(CIVI_PLUGIN_PREFIX . 'follow-candidate');
wp_localize_script(
    CIVI_PLUGIN_PREFIX . 'follow-candidate',
    'civi_follow_candidate_vars',
    array(
...
<div class="civi-follow-candidate">
                        ...
                        <tr>
                            ...
                            <td class="action-setting">
                                <div class="list-action">
                                    <a href="<?php echo esc_url(get_the_permalink($id)); ?>" target="_blank" class="action icon-view tooltip" data-title="<?php echo esc_attr__('View', 'civi-framework') ?>"><i class="far fa-eye"></i></i></a>
                                    <a href="mailto: <?php esc_html_e($candidate_email); ?>" class="action icon-gmail tooltip" data-title="<?php echo esc_attr__('Send Email', 'civi-framework') ?>"><i class="far fa-envelope-open-text"></i></a>

                                    <?php if ($user_demo == 'yes') : ?>
                                        <a href="#" class="btn-add-to-message action tooltip" data-text="<?php echo esc_attr__('This is a "Demo" account so you not cant delete it', 'civi-framework'); ?>" data-title="<?php echo esc_attr__('Delete', 'civi-framework') ?>"><i class="far fa-trash-alt"></i></a>
                                        </a>
                                    <?php else : ?>
                                        <a href="#" class="action btn-delete tooltip" items-id="<?php echo esc_attr($id); ?>" data-title="<?php echo esc_attr__('Delete', 'civi-framework') ?>"><i class="far fa-trash-alt"></i></a>
                                    <?php endif; ?>
