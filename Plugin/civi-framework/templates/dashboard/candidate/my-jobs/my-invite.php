...
wp_enqueue_script(CIVI_PLUGIN_PREFIX . 'my-invite');
wp_localize_script(
    CIVI_PLUGIN_PREFIX . 'my-invite',
    'civi_my_invite_vars',
    array(
...
<div class="civi-my-invite entry-my-page">
                            ...
                            <td class="action-setting jobs-control">
                                ...
                                <ul class="action-dropdown">
                                    ...
                                    <?php if ($user_demo == 'yes') : ?>
                                        <li><a class="btn-add-to-message" data-text="<?php echo esc_attr__('This is a "Demo" account ,so you can not delete it', 'civi-framework'); ?>" href="#"><?php esc_html_e('Delete', 'civi-framework') ?></a></li>
                                    <?php else : ?>
