    ...
    <div class="civi-modal-content">
        ...
        <div class="civi-modal-body">
            ...
            <div class="package-warning-notice">
                ...
                <p><?php esc_html_e('Activating a new package will reset all quotas to the new package values. Your current featured services will be deducted from the new package quota.', 'civi-framework'); ?></p>
            </div>
        </div>
