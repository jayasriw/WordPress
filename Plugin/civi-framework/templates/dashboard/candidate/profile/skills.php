                    ...
                    <div class="select2-field select2-multiple">
                        ...
                        if ($term_count <= 150): ?>
                            <select data-placeholder="<?php esc_attr_e('Select skills', 'civi-framework'); ?>" multiple="multiple"
                                class="civi-select2 point-mark" name="candidate_skills[]">
                                <?php civi_get_taxonomy_by_post_id($candidate_id, $taxonomy, false); ?>
                            </select>
                        <?php else: ?>
                            <select data-placeholder="<?php esc_attr_e('Select skills', 'civi-framework'); ?>" multiple="multiple"
                                class="civi-ajax-select2 point-mark" name="candidate_skills[]" data-taxonomy="<?php echo esc_attr($taxonomy); ?>">
                                <?php
