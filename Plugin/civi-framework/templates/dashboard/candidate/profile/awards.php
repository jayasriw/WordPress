                ...
                foreach ($candidate_award_list as $index => $candidate_award) : ?>
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="date" placeholder="<?php echo $date_format; ?>" name="candidate_award_date[]" value="<?php echo esc_attr($candidate_award[CIVI_METABOX_PREFIX . 'candidate_award_date']) ?>">
                        </div>
