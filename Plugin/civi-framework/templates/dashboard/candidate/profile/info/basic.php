...
$enable_candidate_language_multiple = civi_get_option('enable_candidate_language_multiple', '0');
...
$phone_code = get_user_meta($user_id, CIVI_METABOX_PREFIX . 'phone_code', true);
$user_phone = get_user_meta($user_id, CIVI_METABOX_PREFIX . 'author_mobile_number', true);
    ...
    <div class="civi-avatar-candidate">
        <?php if (!in_array('fields_candidate_avatar', $hide_candidate_fields)) : ?>
            <div class="candidate-fields-avatar civi-fields-avatar">
                <label for="civi_select_avatar"><?php esc_html_e('Your photo', 'civi-framework'); ?></label>
                <div class="form-field">
                    <div id="civi_avatar_errors" class="errors-log"></div>
                    <div id="civi_avatar_container" class="file-upload-block preview">
                        <div id="civi_avatar_view" data-image-id="<?php echo esc_attr($candidate_avatar_id); ?>" data-image-url="<?php if (!empty($candidate_avatar_url)) {
        ...
        <?php if (!in_array('fields_candidate_thumbnail', $hide_candidate_fields)) : ?>
            <div class="candidate-fields-thumbnail civi-fields-thumbnail">
                <label for="civi_select_thumbnail"><?php esc_html_e('Cover image', 'civi-framework'); ?></label>
                <div class="form-field">
                    <div id="civi_thumbnail_errors" class="errors-log"></div>
                    <div id="civi_thumbnail_container" class="file-upload-block preview">
                        <div id="civi_thumbnail_view" data-image-id="<?php echo esc_attr($candidate_cover_image_id); ?>" data-image-url="<?php if (!empty($candidate_cover_image_url)) {
    ...
    <div class="row">
        ...
        <?php if (!in_array('fields_candidate_phone_number', $hide_candidate_fields)) : ?>
            <div class="form-group col-md-6">
                ...
                <div class="tel-group">
                    <select name="prefix_code" id="prefix_code" class="civi-select2 prefix-code">
                        <?php
                    ...
                    <?php else : ?>
                        <div class="alert alert-warning">
                            <?php if (!is_user_logged_in()) : ?>
                                <?php esc_html_e('Please log in to select categories.', 'civi-framework'); ?>
                            <?php else : ?>
                                <?php esc_html_e('Creating your candidate profile... Please refresh the page.', 'civi-framework'); ?>
                            <?php endif; ?>
                        </div>
                    <?php endif; ?>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <div class="form-select">
                        <div class="select2-field select2-multiple">
                            <select data-placeholder="<?php esc_attr_e('Select languages', 'civi-framework'); ?>" multiple="multiple" class="civi-select2 point-mark" name="candidate_languages" id="candidate_languages">
                                <?php civi_get_taxonomy_by_post_id($candidate_id, 'candidate_languages', false, false, true, 'candidate_languages_order'); ?>
                            </select>
                        </div>
        ...
        <?php if (!in_array('fields_candidate_salary', $hide_candidate_fields)) : ?>
            <div class="form-group col-md-6">
                <label for="candidate_salary_type"><?php esc_html_e('Salary type', 'civi-framework'); ?></label>
                <div class="select2-field">
                    <select name="candidate_salary_type" id="candidate_salary_type" class="civi-select2 point-mark">
                        <option <?php selected($candidate_salary_type, ''); ?> value=""><?php esc_html_e('None', 'civi-framework'); ?></option>
                        <option <?php selected($candidate_salary_type, 'hr'); ?> value="hr"><?php esc_html_e('Hourly', 'civi-framework'); ?></option>
                        <option <?php selected($candidate_salary_type, 'day'); ?> value="day"><?php esc_html_e('Daily', 'civi-framework'); ?></option>
                        <option <?php selected($candidate_salary_type, 'month'); ?> value="month"><?php esc_html_e('Monthly', 'civi-framework'); ?></option>
                        <option <?php selected($candidate_salary_type, 'year'); ?> value="year"><?php esc_html_e('Yearly', 'civi-framework'); ?></option>
                    </select>
                </div>
            </div>
        <?php endif; ?>
        ...
        <?php if (!in_array('fields_candidate_salary', $hide_candidate_fields)) : ?>
            <div class="form-group col-md-6">
                <label for="candidate_currency_display"><?php esc_html_e('Currency', 'civi-framework'); ?></label>
                <div class="select2-field">
                    <select name="candidate_currency_type" id="candidate_currency_display" class="civi-select2 point-mark">
