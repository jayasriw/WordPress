    ...
    <div class="row civi-social-network">
        <?php if ($enable_social_twitter == 1) : ?>
            <div class="form-group col-12 col-sm-6">
                <label for="candidate_twitter"><?php esc_html_e('Twitter', 'civi-framework') ?></label>
                <input
                    type="url"
        ...
        <?php if ($enable_social_linkedin == 1) : ?>
            <div class="form-group col-12 col-sm-6">
                <label for="candidate_linkedin"><?php esc_html_e('Linkedin', 'civi-framework') ?></label>
        ...
        <?php if ($enable_social_facebook == 1) : ?>
            <div class="form-group col-12 col-sm-6">
                <label for="candidate_facebook"><?php esc_html_e('Facebook', 'civi-framework') ?></label>
        ...
        <?php if ($enable_social_instagram == 1) : ?>
            <div class="form-group col-12 col-sm-6">
                <label for="candidate_instagram"><?php esc_html_e('Instagram', 'civi-framework') ?></label>
        ...
        if (is_array($civi_social_fields) && !empty($civi_social_fields)) {
            foreach ($civi_social_fields as $key => $value) {
                $candidate_social_val = isset($candidate_meta_data[CIVI_METABOX_PREFIX . 'candidate_' . $value['social_name']]) ? $candidate_meta_data[CIVI_METABOX_PREFIX . 'candidate_' . $value['social_name']][0] : '';
        ?>
                <div class="form-group col-12 col-sm-6">
                    ...
                    <input class="candidate-social-input" type="url" name="candidate_<?php echo esc_html($value['social_name']); ?>" id="candidate_<?php echo esc_html($value['social_name']); ?>"
                        ...
                        placeholder="<?php esc_attr_e($value['social_name'] . '.com/candidate', 'civi-framework') ?>">
                </div>
        <?php }
        } ?>
    </div>
    ...
    <div class="field-social-clone">
        <div class="clone-wrap">
            ...
            <div class="row field-wrap">
                <div class="form-group col-12 col-sm-6">
                    <label for="candidate_social_name_new"><?php esc_html_e('Name', 'civi-framework') ?></label>
                ...
                <div class="form-group col-12 col-sm-6">
                    <label for="candidate_social_url_new"><?php esc_html_e('Url', 'civi-framework') ?></label>
                        ...
                        <div class="clone-wrap">
                            ...
                            <div class="row field-wrap">
                                <div class="col col-md-6">
                                    <label for="candidate_social_name_<?php echo esc_attr($i); ?>"><?php esc_html_e('Name', 'civi-framework') ?></label>
                                    <input type="text" id="candidate_social_name_<?php echo esc_attr($i); ?>" name="candidate_social_name[]"
                                        value="<?php echo esc_attr($social_v1[CIVI_METABOX_PREFIX . 'candidate_social_name']); ?>"
                                        placeholder="<?php esc_attr_e('Candidate', 'civi-framework') ?>">
                                </div>
                                <div class="col col-md-6">
                                    <label for="candidate_social_url_<?php echo esc_attr($i); ?>"><?php esc_html_e('Url', 'civi-framework') ?></label>
                                    <input type="url" id="candidate_social_url_<?php echo esc_attr($i); ?>" name="candidate_social_url[]"
                                        value="<?php echo esc_attr($social_v1[CIVI_METABOX_PREFIX . 'candidate_social_url']); ?>"
                                        placeholder="<?php esc_attr_e('url.com/candidate', 'civi-framework') ?>">
                                </div>
                            </div>
                        </div>
