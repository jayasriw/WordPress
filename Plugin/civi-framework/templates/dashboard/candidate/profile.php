...
$layout = apply_filters('civi/dashboard/candidate/profile/layout', array('info', 'education', 'experience', 'skills', 'projects', 'awards'));
?>
        ...
        <div class="tab-dashboard">
            <ul class="tab-list candidate-profile-tab">
                <?php foreach ($layout as $value) {
                    ...
                    $should_show_tab = civi_is_candidate_section_visible($value, $hide_candidate_fields, $hide_candidate_group_fields);
            ...
            <div class="tab-content row">
                <form action="#" method="post" enctype="multipart/form-data" id="candidate-profile-form" class="candidate-profile-form form-dashboard  col-lg-8 col-md-7">
                    ...
                    <?php wp_nonce_field('candidate_submit_ajax_nonce', 'civi_security_candidate_submit'); ?>
                    <?php foreach ($layout as $value) {
                        switch ($value) {
                            case 'info':
                                break;
                        ...
                        $should_show_section = civi_is_candidate_section_visible($value, $hide_candidate_fields, $hide_candidate_group_fields);
                    ...
                    <div class="button-wrapper">
                        <a href="<?php echo civi_get_permalink('candidate_dashboard'); ?>" class="civi-button button-outline">
                        ...
                        <?php else : ?>
                            <button type="submit" class="btn-update-profile civi-button" name="submit_profile">
                                <span><?php esc_html_e('Update', 'civi-framework'); ?></span>
                            ...
                            <div class="tip-content post-bottom">
                                <ul class="profile-list-check">
                                    <?php foreach ($layout as $value) {
                                        ...
                                        // Check if section should be visible
                                        $should_show_check = civi_is_candidate_section_visible($value, $hide_candidate_fields, $hide_candidate_group_fields);
