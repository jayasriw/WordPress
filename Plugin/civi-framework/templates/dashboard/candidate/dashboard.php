...
$show_my_jobs = civi_get_option( 'show_my_jobs', '1' );
$show_following = civi_get_option( 'show_candidate_company', '1' );
$show_reviews = civi_get_option( 'show_candidate_reviews', '1' );
$show_meetings = civi_get_option( 'show_candidate_meetings', '1' );
?>
<div class="civi-dashboard civi-dashboard-candidate area-main-control">
    <div class="entry-my-page">
        ...
        <div class="notification-dashboard">
            <div class="row">
                <div class="col-md-7">
                    <div class="civi-chart-wrapper civi-chart-candidate">
                ...
                <div class="col-md-5">
                    <div class="jobs-dashboard-wrap">
                        <h4 class="title-jobs"><?php esc_html_e('Recently Applied jobs', 'civi-framework'); ?></h4>
