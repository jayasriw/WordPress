...
$jobs_user_skills = get_user_meta($user_id, CIVI_METABOX_PREFIX . 'jobs-skills_user', true);
            ...
            <div class="select2-field">
                ...
                if ($term_count <= 150): ?>
                    <select data-placeholder="<?php esc_attr_e('Select categories', 'civi-framework'); ?>"
                        ...
                        <?php civi_get_taxonomy($taxonomy, false, true); ?>
                    </select>
                <?php else: ?>
                    <select data-placeholder="<?php esc_attr_e('Select categories', 'civi-framework'); ?>"
            ...
            <div class="form-select">
                <div class="select2-field select2-multiple">
                    <select data-placeholder="<?php esc_attr_e('Select an option', 'civi-framework'); ?>"
                        ...
                        <?php civi_get_taxonomy('jobs-type', false, true, false, true, 'jobs_type_order'); ?>
                    </select>
                </div>
                ...
                <div class="select2-field select2-multiple">
                    ...
                    if ($term_count <= 150): ?>
                        <select data-placeholder="<?php esc_attr_e('Select skills', 'civi-framework'); ?>" multiple="multiple"
                            ...
                            <?php
                            civi_get_taxonomy($taxonomy, false, false);
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_career" class="civi-select2">
                    <?php civi_get_taxonomy('jobs-career', false, true, false, true, 'jobs_career_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_experience" class="civi-select2">
                    <?php civi_get_taxonomy('jobs-experience', false, true, false, true, 'jobs_experience_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="form-select">
                <div class="select2-field select2-multiple">
                    <select data-placeholder="<?php esc_attr_e('Select an option', 'civi-framework'); ?>"
                        ...
                        <?php civi_get_taxonomy('jobs-qualification', false, false, false, true, 'jobs_qualification_order'); ?>
                    </select>
                </div>
                <i class="fas fa-angle-down"></i>
            </div>
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_gender" class="civi-select2">
                    <?php civi_get_taxonomy('jobs-gender', false, true, false, true, 'jobs_gender_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
