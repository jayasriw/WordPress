...
$enable_add_new_job_location = civi_get_option('enable_add_new_job_location', '');
...
<div class="row">
    <?php if (!in_array('fields_jobs_location', $hide_jobs_fields)) : ?>
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
				<select name="jobs_location" class="civi-select2">
                    <?php civi_get_taxonomy_location('jobs-location','jobs-state','jobs-location-state','jobs-state-country',$jobs_data->ID); ?>
				</select>
			</div>
        </div>
		<?php if( $enable_add_new_job_location ) : ?>
			<div class="form-group col-md-6">
				<label for="jobs_new_location"><?php esc_html_e('Add New Location', 'civi-framework'); ?></label>
				<input type="text" id="jobs_new_location" name="jobs_new_location" value="" placeholder="<?php esc_attr_e('Enter new location', 'civi-framework'); ?>">
			</div>
		<?php endif; ?>
		...
		<?php if (!in_array('fields_map', $hide_jobs_fields)) : ?>
			...
			<div class="form-group col-md-6">
				<label for="jobs_longtitude"><?php esc_html_e('Marker longtitude', 'civi-framework'); ?></label>
			...
			<div class="form-group col-md-6">
				<label for="jobs_latitude"><?php esc_html_e('Marker latitude', 'civi-framework'); ?></label>
