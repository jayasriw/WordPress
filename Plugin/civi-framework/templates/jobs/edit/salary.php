        ...
        <div class="select2-field">
			<select name="jobs_salary_rate" class="civi-select2">
				...
				<option <?php if (isset($jobs_meta_data[CIVI_METABOX_PREFIX . 'jobs_salary_rate'][0])) {
					if ($jobs_meta_data[CIVI_METABOX_PREFIX . 'jobs_salary_rate'][0] == "hour") {
						echo 'selected';
					}
				} ?> value="hour"><?php esc_html_e('Per Hour', 'civi-framework'); ?></option>
				<option <?php if (isset($jobs_meta_data[CIVI_METABOX_PREFIX . 'jobs_salary_rate'][0])) {
					if ($jobs_meta_data[CIVI_METABOX_PREFIX . 'jobs_salary_rate'][0] == "day") {
						echo 'selected';
					}
				} ?> value="day"><?php esc_html_e('Per Day', 'civi-framework'); ?></option>
				<option <?php if (isset($jobs_meta_data[CIVI_METABOX_PREFIX . 'jobs_salary_rate'][0])) {
