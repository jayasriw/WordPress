...
$date_posted    = civi_get_option('enable_date_posted', '1');
$closing_date   = civi_get_option('enable_closing_date', '1');
...
<div class="block-archive-inner jobs-insights-details <?php if ($enable_toggle == '1') : ?>active<?php endif; ?>">
    ...
    <?php if ($enable_toggle == '1') : ?>
        <div class="toggle-insights">
            <a href="#" class="show-more-insights"><?php esc_html_e('Show more', 'civi-framework'); ?><i class="fas fa-angle-down"></i></a>
            <a href="#" class="hide-all-insights"><?php esc_html_e('Hide less', 'civi-framework'); ?><i class="fas fa-angle-up"></i></a>
        </div>
    <?php endif; ?>
</div>
