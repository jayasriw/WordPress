		...
		<div class="form-group col-lg-6">
			...
			<div class="select2-field">
				<select name="company_location" class="jobportal-select2">
					<?php jobportal_get_taxonomy_location('company-location', 'company-state', 'company-location-state', 'company-state-country'); ?>
				</select>
			</div>
		</div>
	...
	<?php if (!in_array('fields_company_map', $hide_company_fields)) : ?>
		<div class="form-group col-lg-6">
			...
			<div class="input-area">
				<input type="text" id="search-location" class="form-control" name="jobportal_map_address" placeholder="<?php esc_attr_e('Full Address', 'jobportal-framework'); ?>" autocomplete="off">
			</div>
		...
		<div class="form-group col-md-6">
			...
			<input type="text" id="company_longtitude" name="jobportal_longtitude" value="<?php echo $lng ?>" placeholder="<?php esc_attr_e('0.0000000', 'jobportal-framework') ?>">
		</div>
		<div class="form-group col-md-6">
			<label for="company_latitude"><?php esc_html_e('Marker latitude', 'jobportal-framework'); ?></label>
			<input type="text" id="company_latitude" name="jobportal_latitude" value="<?php echo $lat ?>" placeholder="<?php esc_attr_e('0.0000000', 'jobportal-framework') ?>">
		</div>
	<?php endif; ?>
</div>
