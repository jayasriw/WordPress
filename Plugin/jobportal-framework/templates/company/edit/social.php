...
$company_twitter = isset($company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_twitter']) ? $company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_twitter'][0] : '';
$company_linkedin = isset($company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_linkedin']) ? $company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_linkedin'][0] : '';
$company_facebook = isset($company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_facebook']) ? $company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_facebook'][0] : '';
$company_instagram = isset($company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_instagram']) ? $company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_instagram'][0] : '';
...
<div class="row">
    <?php if ($enable_social_twitter == 1) : ?>
        <div class="form-group col-12 col-sm-6">
            <label><?php esc_html_e('Twitter', 'jobportal-framework') ?></label>
            <input type="url" name="company_twitter" id="company_twitter"
                value="<?php echo esc_attr($company_twitter) ?>"
                placeholder="<?php esc_attr_e('twitter.com/company', 'jobportal-framework') ?>">
        </div>
    <?php endif; ?>
    <?php if ($enable_social_linkedin == 1) : ?>
        <div class="form-group col-12 col-sm-6">
            <label><?php esc_html_e('Linkedin', 'jobportal-framework') ?></label>
            <input type="url" name="company_linkedin" id="company_linkedin"
                value="<?php echo esc_attr($company_linkedin) ?>"
                placeholder="<?php esc_attr_e('linkedin.com/company', 'jobportal-framework') ?>">
        </div>
    <?php endif; ?>
    <?php if ($enable_social_facebook == 1) : ?>
        <div class="form-group col-12 col-sm-6">
            <label><?php esc_html_e('Facebook', 'jobportal-framework') ?></label>
            <input type="url" name="company_facebook" id="company_facebook"
                value="<?php echo esc_attr($company_facebook) ?>"
                placeholder="<?php esc_attr_e('facebook.com/company', 'jobportal-framework') ?>">
        </div>
    <?php endif; ?>
    <?php if ($enable_social_instagram == 1) : ?>
        <div class="form-group col-12 col-sm-6">
            <label><?php esc_html_e('Instagram', 'jobportal-framework') ?></label>
            <input type="url" name="company_instagram" id="company_instagram"
                value="<?php echo esc_attr($company_instagram) ?>"
                placeholder="<?php esc_attr_e('instagram.com/company', 'jobportal-framework') ?>">
        </div>
    <?php endif; ?>
</div>
...
<div class="field-social-clone">
    <div class="clone-wrap">
        ...
        <div class="row field-wrap">
            <div class="form-group col-12 col-sm-6">
                <label><?php esc_html_e('Name', 'jobportal-framework') ?></label>
                <input type="text" name="company_social_name[]"
                    placeholder="<?php esc_attr_e('Company', 'jobportal-framework') ?>">
            </div>
            <div class="form-group col-12 col-sm-6">
                <label><?php esc_html_e('Url', 'jobportal-framework') ?></label>
                <input type="url" name="company_social_url[]"
                    placeholder="<?php esc_attr_e('url.com/company', 'jobportal-framework') ?>">
            </div>
        </div>
    </div>
</div>
...
<div class="add-social-list">
    ...
    <?php
    $company_social_tab = get_post_meta($company_data->ID, JOBPORTAL_METABOX_PREFIX . 'company_social_tabs', false);
    $i = 0;
                    ...
                    <div class="clone-wrap">
                        ...
                        <div class="row field-wrap">
                            <div class="col col-md-6">
                                <label><?php esc_html_e('Name', 'jobportal-framework') ?></label>
                                <input type="text" name="company_social_name[]"
                                    value="<?php echo $social_v1[JOBPORTAL_METABOX_PREFIX . 'company_social_name']; ?>"
                                    placeholder="<?php esc_attr_e('Company', 'jobportal-framework') ?>">
                            </div>
                            <div class="col col-md-6">
                                <label><?php esc_html_e('Url', 'jobportal-framework') ?></label>
                                <input type="url" name="company_social_url[]"
                                    value="<?php echo $social_v1[JOBPORTAL_METABOX_PREFIX . 'company_social_url']; ?>"
                                    placeholder="<?php esc_attr_e('url.com/company', 'jobportal-framework') ?>">
                            </div>
                        </div>
                    </div>
