...
$company_logo_arg = get_post_meta($company_id, JOBPORTAL_METABOX_PREFIX . 'company_logo', false);
				...
				<div class="col-lg-8 col-md-7">
					<div class="submit-company-header jobportal-submit-header">
						<div class="entry-title">
							<h4><?php esc_html_e('Update company', 'jobportal-framework') ?></h4>
						</div>
					...
					<?php foreach ($layout as $value) {
						...
						if (!$is_group_hidden && $should_show_section) : ?>
							<div class="block-from" id="<?php echo 'company-submit-' . esc_attr($value); ?>">
								<h6><?php echo $name ?></h6>
								<?php jobportal_get_template('company/edit/' . $value . '.php'); ?>
							</div>
					<?php endif;
					} ?>
					...
					<div class="widget-area-init has-sticky">
						<div class="about-company-dashboard block-archive-sidebar">
							<div class="header-about">
								<h3 class="title-company-about"><?php esc_html_e('Preview', 'jobportal-framework') ?></h3>
								<a class="jobportal-button button-outline-accent" href="<?php echo get_post_permalink($company_id); ?>" target="_blank">
