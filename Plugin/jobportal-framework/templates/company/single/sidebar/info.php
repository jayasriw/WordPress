...
$hide_info_company_fields = jobportal_get_option('hide_candidate_info_company_fields', array());
...
if ($user_id == 0) {
    ...
    if ($user_id == $post_author_id) {
        $notice = '';
    } elseif (in_array("jobportal_user_candidate", (array)$current_user->roles) && $user_id != $post_author_id) {
        ...
        $notice = esc_attr__("Please access the role Candidate to view", "jobportal-framework");
    }
}
    ...
    <div class="jobs-company-sidebar block-archive-sidebar company-sidebar <?php echo implode(" ", $classes); ?>">
        ...
        <?php if (
            ...
            <p class="notice">
                ...
                <?php esc_html_e("Please login to see the full information", "jobportal-framework"); ?>
            </p>
        <?php else: ?>
    ...
    // If user is not candidate and is not author
        ...
        <div class="jobs-company-sidebar block-archive-sidebar company-sidebar <?php echo implode(" ", $classes); ?>">
            ...
            <?php if (
                ...
                <p class="notice">
                    <i class="fal fa-exclamation-circle"></i>
                    <?php esc_html_e("Please access the role Candidate to see the full information", "jobportal-framework"); ?>
                </p>
            <?php else: ?>
                <?php if (is_array($company_categories)) : ?>
                    <div class="info">
