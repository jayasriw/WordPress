...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'company-review');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'company-review',
    'jobportal_company_review_vars',
    array(
...
$company_rating = get_post_meta($company_id, JOBPORTAL_METABOX_PREFIX . 'company_rating', true);
...
<div class="company-review-details block-archive-inner" id="company-review-details">
    <h3 class="title-company"><?php esc_html_e('Review', 'jobportal-framework'); ?></h3>
    ...
    <div class="entry-overview">
        <div class="rating-bars">
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Company Culture', 'jobportal-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Company trip once a year and Team building once a month', 'jobportal-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Company trip once a year and Team building once a month', 'jobportal-framework'); ?></div>
                    </div>
                </div>
                <div class="rating-bars-inner">
                ...
                <div class="add-new-review">
                    ...
                    ?>
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Company Culture', 'jobportal-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Company trip once a year and Team building once a month', 'jobportal-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Company trip once a year and Team building once a month', 'jobportal-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="jobportal-submit-company-rating jobportal-button button-icon-right">
                            ...
                            <input type="hidden" name="action" value="jobportal_company_submit_review_ajax">
    ...
    <div class="duplicate-form-reply hide none">
        ...
        <form method="post" class="repreviewForm" action="#">
            ...
            <button type="submit" class="jobportal-submit-company-reply jobportal-button"><?php esc_html_e('Send', 'jobportal-framework'); ?></button>
            <?php wp_nonce_field('jobportal_submit_reply_ajax_nonce', 'jobportal_security_submit_reply'); ?>
            <input type="hidden" name="action" value="jobportal_company_submit_reply_ajax">
            <input type="hidden" name="company_id" value="<?php the_ID(); ?>">
