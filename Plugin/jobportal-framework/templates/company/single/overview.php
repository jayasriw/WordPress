...
if (isset($content) && !empty($content)) : ?>
    <div class="block-archive-inner company-overview-details jobportal-description-details">
        <h4 class="title-company"><?php esc_html_e('Overview', 'jobportal-framework') ?></h4>
