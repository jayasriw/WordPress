...
$id = get_the_ID();
$company_gallery     = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'company_images', true);
$attach_id         = get_post_thumbnail_id();
$show = 3;
?>
<?php if (!empty($company_gallery)) : ?>
    <div class="block-archive-inner company-gallery-details">
        <h4 class="title-company"><?php esc_html_e('Photos', 'jobportal-framework') ?></h4>
        <div class="entry-company-element">
            <div class="single-company-thumbs enable jobportal-light-gallery">
                <?php
