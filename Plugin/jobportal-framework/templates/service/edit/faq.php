...
$service_faq = get_post_meta($service_data->ID, JOBPORTAL_METABOX_PREFIX . 'service_tab_faq', false);
...
<?php if (!in_array('fields_service_faq', $hide_service_fields)) : ?>
    <div class="form-group col-md-12">
        <div class="addons-info block-from">
            <h6><?php esc_html_e('FAQs', 'jobportal-framework') ?></h6>
            <div class="jobportal-addons-wrapper">
                ...
                <div class="row">
                    <div class="group-title col-md-12">
                        ...
                        <h6 class="education">
                            <?php echo esc_html_e('Faq', 'jobportal-framework') ?>
                            <span><?php echo $index + 1 ?></span>
                        </h6>
                        <i class="fas fa-angle-up"></i>
                    </div>
                    <div class="form-group col-md-12">
                        <label><?php esc_html_e('Question', 'jobportal-framework') ?></label>
                        <input type="text" name="service_faq_title[]"
                               placeholder="<?php esc_attr_e('Enter Question', 'jobportal-framework'); ?>"
                               value="<?php echo $faqs['jobportal-service_faq_title'] ?>">
                    </div>
                    <div class="form-group col-md-12">
                        <label><?php esc_html_e('Answer', 'jobportal-framework') ?></label>
                        <textarea name="service_faq_description[]" cols="30"
                                  placeholder="<?php esc_attr_e('Enter Answer', 'jobportal-framework'); ?>"
                                  rows="7"><?php echo $faqs['jobportal-service_faq_description'] ?></textarea>
                    </div>
                </div>
                <?php endforeach;
                endif;
