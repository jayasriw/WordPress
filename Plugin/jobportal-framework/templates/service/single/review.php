...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'service-review');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'service-review',
    'jobportal_service_review_vars',
    array(
...
$service_rating = get_post_meta($service_id, JOBPORTAL_METABOX_PREFIX . 'service_rating', true);
...
?>
<div class="jobportal-block-inner block-archive-inner service-review-details" id="service-review-details">
    <h3 class="title-service"><?php esc_html_e('Review', 'jobportal-framework'); ?></h3>
        ...
        <div class="rating-bars">
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Salary & Benefits', 'jobportal-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Salary review every 6 months based on the work performance', 'jobportal-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Salary review every 6 months based on the work performance', 'jobportal-framework'); ?></div>
                    </div>
                </div>
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Work Speed', 'jobportal-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Does the speed of project completion meet the deadline?', 'jobportal-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Does the speed of project completion meet the deadline?', 'jobportal-framework'); ?></div>
                    </div>
                </div>
                <div class="rating-bars-inner">
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Skill Development', 'jobportal-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Well trained and dedicated to being able to catch the pace smoothly.', 'jobportal-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Well trained and dedicated to being able to catch the pace smoothly.', 'jobportal-framework'); ?></div>
                    </div>
                </div>
            ...
            <div class="rating-bars-item">
                <div class="rating-bars-name">
                    <?php esc_html_e('Work Satisfaction', 'jobportal-framework'); ?>
                    <div class="tip" data-tip-content="<?php esc_html_e('Our office is located with creative, open workspaces and a high-quality engaging environment.', 'jobportal-framework'); ?>">
                        <div class="tip-content"><?php esc_html_e('Our office is located with creative, open workspaces and a high-quality engaging environment.', 'jobportal-framework'); ?></div>
                    </div>
                </div>
                <div class="rating-bars-inner">
                        ...
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Salary & Benefits', 'jobportal-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Salary review every 6 months based on the work performance', 'jobportal-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Salary review every 6 months based on the work performance', 'jobportal-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Work Speed', 'jobportal-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Does the speed of project completion meet the deadline?', 'jobportal-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Does the speed of project completion meet the deadline?', 'jobportal-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Skill Development', 'jobportal-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Well trained and dedicated to being able to catch the pace smoothly.', 'jobportal-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Well trained and dedicated to being able to catch the pace smoothly.', 'jobportal-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                    <span><?php esc_html_e('Work Satisfaction', 'jobportal-framework'); ?></span>
                                    <div class="tip" data-tip-content="<?php esc_html_e('Our office is located with creative, open workspaces and a high-quality engaging environment.', 'jobportal-framework'); ?>">
                                        <div class="tip-content"><?php esc_html_e('Our office is located with creative, open workspaces and a high-quality engaging environment.', 'jobportal-framework'); ?></div>
                                    </div>
                                </div>
                            ...
                            <button type="submit" class="jobportal-submit-service-rating jobportal-button button-icon-right">
                                <span><?php esc_html_e('Submit Review', 'jobportal-framework'); ?></span></button>
                            <?php wp_nonce_field('jobportal_submit_review_ajax_nonce', 'jobportal_security_submit_review'); ?>
                            <input type="hidden" name="action" value="jobportal_service_submit_review_ajax">
                    ...
                    ?>
                        <form method="post" class="reviewForm" enctype="multipart/form-data" action="#">
                            <div class="form-group star-rating">
                                ...
                                <fieldset class="rate">
                                    <input type="radio" id="rating_salary5" name="rating_salary" <?php if ($my_review_service_salary_rating === 5) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="5" /><label for="rating_salary5" title="5 stars"></label>
                                    <input type="radio" id="rating_salary4" name="rating_salary" <?php if ($my_review_service_salary_rating === 4) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="4" /><label for="rating_salary4" title="4 stars"></label>
                                    <input type="radio" id="rating_salary3" name="rating_salary" <?php if ($my_review_service_salary_rating === 3) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="3" /><label for="rating_salary3" title="3 stars"></label>
                                    <input type="radio" id="rating_salary2" name="rating_salary" <?php if ($my_review_service_salary_rating === 2) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="2" /><label for="rating_salary2" title="2 stars"></label>
                                    <input type="radio" id="rating_salary1" name="rating_salary" <?php if ($my_review_service_salary_rating === 1) {
                                                                                                        echo 'checked';
                            ...
                            <div class="form-group star-rating">
                                ...
                                <fieldset class="rate">
                                    <input type="radio" id="rating_service5" name="rating_service" <?php if ($my_review_service_service_rating === 5) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="5" /><label for="rating_service5" title="5 stars"></label>
                                    <input type="radio" id="rating_service4" name="rating_service" <?php if ($my_review_service_service_rating === 4) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="4" /><label for="rating_service4" title="4 stars"></label>
                                    <input type="radio" id="rating_service3" name="rating_service" <?php if ($my_review_service_service_rating === 3) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="3" /><label for="rating_service3" title="3 stars"></label>
                                    <input type="radio" id="rating_service2" name="rating_service" <?php if ($my_review_service_service_rating === 2) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="2" /><label for="rating_service2" title="2 stars"></label>
                                    <input type="radio" id="rating_service1" name="rating_service" <?php if ($my_review_service_service_rating === 1) {
                                                                                                        echo 'checked';
                                                                                                    } ?> value="1" /><label for="rating_service1" title="1 star"></label>
                                </fieldset>
                            </div>
                            <div class="form-group star-rating">
                                <div class="rate-title">
                                ...
                                <fieldset class="rate">
                                    <input type="radio" id="rating_skill5" name="rating_skill" <?php if ($my_review_service_skill_rating === 5) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="5" /><label for="rating_skill5" title="5 stars"></label>
                                    <input type="radio" id="rating_skill4" name="rating_skill" <?php if ($my_review_service_skill_rating === 4) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="4" /><label for="rating_skill4" title="4 stars"></label>
                                    <input type="radio" id="rating_skill3" name="rating_skill" <?php if ($my_review_service_skill_rating === 3) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="3" /><label for="rating_skill3" title="3 stars"></label>
                                    <input type="radio" id="rating_skill2" name="rating_skill" <?php if ($my_review_service_skill_rating === 2) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="2" /><label for="rating_skill2" title="2 stars"></label>
                                    <input type="radio" id="rating_skill1" name="rating_skill" <?php if ($my_review_service_skill_rating === 1) {
                                                                                                    echo 'checked';
                            ...
                            <div class="form-group star-rating">
                                ...
                                <fieldset class="rate">
                                    <input type="radio" id="rating_work5" name="rating_work" <?php if ($my_review_service_work_rating === 5) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="5" /><label for="rating_work5" title="5 stars"></label>
                                    <input type="radio" id="rating_work4" name="rating_work" <?php if ($my_review_service_work_rating === 4) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="4" /><label for="rating_work4" title="4 stars"></label>
                                    <input type="radio" id="rating_work3" name="rating_work" <?php if ($my_review_service_work_rating === 3) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="3" /><label for="rating_work3" title="3 stars"></label>
                                    <input type="radio" id="rating_work2" name="rating_work" <?php if ($my_review_service_work_rating === 2) {
                                                                                                    echo 'checked';
                                                                                                } ?> value="2" /><label for="rating_work2" title="2 stars"></label>
                                    <input type="radio" id="rating_work1" name="rating_work" <?php if ($my_review_service_work_rating === 1) {
                                                                                                    echo 'checked';
                            ...
                            <button type="submit" class="jobportal-submit-service-rating jobportal-button button-icon-right">
                                <span><?php esc_html_e('Update Review', 'jobportal-framework'); ?></span></button>
                            <?php wp_nonce_field('jobportal_submit_review_ajax_nonce', 'jobportal_security_submit_review'); ?>
                            <input type="hidden" name="action" value="jobportal_service_submit_review_ajax">
                            <input type="hidden" name="service_id" value="<?php the_ID(); ?>">
                        </form>
    ...
    <div class="duplicate-form-reply hide none">
        ...
        <form method="post" class="repreviewForm" action="#">
            ...
            <button type="submit" class="jobportal-submit-service-reply jobportal-button"><?php esc_html_e('Send', 'jobportal-framework'); ?></button>
            <?php wp_nonce_field('jobportal_submit_reply_ajax_nonce', 'jobportal_security_submit_reply'); ?>
            <input type="hidden" name="action" value="jobportal_service_submit_reply_ajax">
            <input type="hidden" name="service_id" value="<?php the_ID(); ?>">
