...
$candidate_package_number_service = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'candidate_package_number_service', true);
                ...
                <div class="col-lg-8 col-md-7">
                    <div class="submit-service-header jobportal-submit-header">
                        <div class="entry-title">
                            <h4><?php esc_html_e('Create New Service', 'jobportal-framework') ?></h4>
                        </div>
                        <div class="button-wrapper">
                            ...
                            <?php if (($has_candidate_package && $candidate_package_number_service > 0 && $package_status == 1) || $candidate_paid_submission_type !== 'candidate_per_package') { ?>
                                <button type="submit" class="btn-submit-service jobportal-button" name="submit_service">
                                    <span><?php esc_html_e('Post service', 'jobportal-framework'); ?></span>
                    ...
                    <?php foreach ($layout as $value) { ?>
                        <div id="tab-<?php echo $value; ?>" class="tab-info">
                            <?php jobportal_get_template('service/submit/' . $value . '.php'); ?>
                        </div>
                    <?php } ?>

                    <?php wp_nonce_field('jobportal_service_submit_ajax_nonce', 'jobportal_security_service_submit'); ?>
