...
$jobs_user_select_apply = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'jobs_user_select_apply', true);
$jobs_user_apply_email = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'jobs_user_apply_email', true);
$jobs_user_apply_external = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'jobs_user_apply_external', true);
$jobs_user_apply_call_to = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'jobs_user_apply_call_to', true);
        ...
        <div class="jobportal-section-apply-select form-group col-md-6" id="call-to">
            ...
            <div class="tel-group">
                <select name="prefix_code" class="jobportal-select2 prefix-code">
                    ...
                    $selected_prefix = JobPortal_Helper::get_prefix_key_from_phone($jobs_user_apply_call_to, $prefix_code, $default_phone);
                ...
                $input_value = !empty($jobs_user_apply_call_to) ? preg_replace('/^' . preg_quote($default_phone_code, '/') . '0+/', $default_phone_code, preg_replace('/[^0-9+]/', '', $jobs_user_apply_call_to)) : $default_phone_code;
                ?>
