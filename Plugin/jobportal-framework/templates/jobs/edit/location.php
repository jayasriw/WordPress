...
$jobs_location = get_post_meta($jobs_data->ID, JOBPORTAL_METABOX_PREFIX . 'jobs_location', true);
    ...
    <?php if (!in_array('fields_jobs_location', $hide_jobs_fields)) : ?>
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
				<select name="jobs_location" class="jobportal-select2">
                    <?php jobportal_get_taxonomy_location('jobs-location','jobs-state','jobs-location-state','jobs-state-country',$jobs_data->ID); ?>
				</select>
			</div>
        </div>
		...
		<?php if (!in_array('fields_map', $hide_jobs_fields)) : ?>
			...
			<div class="form-group col-md-6">
				...
				<input type="text" id="jobs_longtitude" name="jobportal_longtitude" value="<?php echo $lng ?>"
			...
			<div class="form-group col-md-6">
				...
				<input type="text" id="jobs_latitude" name="jobportal_latitude" value="<?php echo $lat ?>"
					placeholder="<?php esc_attr_e('0.0000000', 'jobportal-framework') ?>">
			</div>
		<?php endif; ?>
    <?php endif; ?>
