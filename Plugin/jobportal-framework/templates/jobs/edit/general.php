...
$jobs_user_days_closing = isset($jobs_meta_data[JOBPORTAL_METABOX_PREFIX . 'jobs_days_closing'][0]) ? $jobs_meta_data[JOBPORTAL_METABOX_PREFIX . 'jobs_days_closing'][0] : '';
...
if (!$jobs_user_days_closing && $jobs_id) {
	...
	if ($enable_jobs_expires == '1') {
		...
		$jobs_user_days_closing = jobportal_get_option('jobs_number_days', true);
	}
}
            ...
            <div class="select2-field">
                ...
                if ($term_count <= 150): ?>
                    <select data-placeholder="<?php esc_attr_e('Select categories', 'jobportal-framework'); ?>"
                        ...
                        <?php jobportal_get_taxonomy_by_post_id($job_id, $taxonomy, true); ?>
                    </select>
                <?php else: ?>
                    <select data-placeholder="<?php esc_attr_e('Select categories', 'jobportal-framework'); ?>"
            ...
            <div class="form-select">
                <div class="select2-field select2-multiple">
                    <select data-placeholder="<?php esc_attr_e('Select an option', 'jobportal-framework'); ?>"
                        ...
                        <?php jobportal_get_taxonomy_by_post_id($jobs_data->ID, 'jobs-type', true, false, true, 'jobs_type_order'); ?>
                    </select>
                </div>
                ...
                <div class="select2-field select2-multiple">
                    ...
                    if ($term_count <= 150): ?>
                        <select data-placeholder="<?php esc_attr_e('Select skills', 'jobportal-framework'); ?>" multiple="multiple"
                            ...
                            <?php jobportal_get_taxonomy_by_post_id($job_id, $taxonomy, false); ?>
                        </select>
                    <?php else: ?>
                        <select data-placeholder="<?php esc_attr_e('Select skills', 'jobportal-framework'); ?>" multiple="multiple"
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_career" class="jobportal-select2">
                    <?php jobportal_get_taxonomy_by_post_id($jobs_data->ID, 'jobs-career', false, false, true, 'jobs_career_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_experience" class="jobportal-select2">
                    <?php jobportal_get_taxonomy_by_post_id($jobs_data->ID, 'jobs-experience', false, false, true, 'jobs_experience_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
            ...
            <div class="form-select">
                <div class="select2-field select2-multiple">
                    <select data-placeholder="<?php esc_attr_e('Select an option', 'jobportal-framework'); ?>"
                        ...
                        <?php jobportal_get_taxonomy_by_post_id($jobs_data->ID, 'jobs-qualification', false, false, true, 'jobs_qualification_order'); ?>
                    </select>
                </div>
                <i class="fas fa-angle-down"></i>
            </div>
            ...
            <div class="select2-field">
                <select name="jobs_quantity" class="jobportal-select2">
                    <?php for ($quantity = 0; $quantity <= 10; $quantity++) {
                        ...
                        <?php } else { ?>
                            <option <?php if (isset($jobs_meta_data[JOBPORTAL_METABOX_PREFIX . 'jobs_quantity']) && $jobs_meta_data[JOBPORTAL_METABOX_PREFIX . 'jobs_quantity'][0] == $quantity) {
                                        echo 'selected';
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="jobs_gender" class="jobportal-select2">
                    <?php jobportal_get_taxonomy_by_post_id($jobs_data->ID, 'jobs-gender', false, false, true, 'jobs_gender_order'); ?>
                </select>
            </div>
        </div>
    <?php endif; ?>
