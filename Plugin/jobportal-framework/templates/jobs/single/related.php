...
<?php if ($enable_single_jobs_related && !empty($jobs)) : ?>
    <div class="jobs-related-details">
        <div class="header-related">
            <h4 class="title-jobs"><?php esc_html_e('Similar jobs', 'jobportal-framework') ?></h4>
            <a href="<?php echo get_post_type_archive_link('jobs') ?>"
               class="jobportal-button button-border-bottom"><?php esc_html_e('View all jobs', 'jobportal-framework') ?></a>
        </div>
        <div class="related-inner">
            <?php echo jobportal_get_jobs_by_category(3, 3, $categories,$jobs_id); ?>
        </div>
    </div>
<?php endif; ?>
