...
$check_company_package = jobportal_get_field_check_candidate_package('contact_company');
$jobs_id = get_the_ID();
...
$hide_contact_company_fields = jobportal_get_option('hide_candidate_contact_company_fields', array());
...
if ($user_id == 0) {
    $notice = esc_attr__("Please login to view", "jobportal-framework");
} elseif (in_array("jobportal_user_candidate", (array)$current_user->roles)) {
    $notice = ($check_company_package == -1 || $check_company_package == 0)
        ? esc_attr__("Please renew the package to view", "jobportal-framework")
        : '';
} else {
    $notice = esc_attr__("Please access the role Candidate and purchase the package to view", "jobportal-framework");
}
    ...
    <div class="jobs-company-sidebar block-archive-sidebar company-sidebar <?php echo implode(" ", $classes); ?>">
        <div class="company-header">
            ...
            <?php if (get_the_title($company_id)) : ?>
                <div class="name">
                    ...
                    <p><a href="<?php echo get_post_permalink($company_id) ?>"><?php esc_html_e('View company profile', 'jobportal-framework') ?></a></p>
                </div>
            <?php endif; ?>
        </div>
        <?php if ($all_fields_hidden) : ?>
            <h3 class="title-company"><?php esc_html_e('Information', 'jobportal-framework'); ?></h3>
            <p class="notice">
        ...
        <?php else: ?>
            <ul class="tab-company">
                <li class="tab-item"><a href="#tab-sidebar-overview"><?php esc_html_e('Overview', 'jobportal-framework'); ?></a></li>
                <li class="tab-item">
                    <a href="#tab-sidebar-jobs"><?php esc_html_e('Jobs', 'jobportal-framework'); ?>
            ...
            <div class="tab-content">
                <div class="tab-info-company" id="tab-sidebar-overview">
                    ...
                    ?>
                        <a href="#" class="jobportal-button button-outline btn-add-to-message button-block" data-text="<?php echo $notice; ?>">
                            <?php esc_html_e('Visit ', 'jobportal-framework'); ?><?php echo $name_website ?><i class="fas fa-external-link"></i>
                        </a>
                    <?php endif; ?>
                    <?php jobportal_get_template('company/messages.php', array('company_id' => $company_id)); ?>
