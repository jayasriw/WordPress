...
$jobs_id = get_the_ID();
$closing_date    = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'closing_date', true);
$jobs_quantity  = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_quantity', true);
...
$enable_toggle   = jobportal_get_option('enable_toggle_show_more_apply', '1');
...
$jobs_salary_minimum = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_salary_minimum', true);
$jobs_salary_maximum = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_salary_maximum', true);
$jobs_maximum_price = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_maximum_price', true);
$jobs_minimum_price = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_minimum_price', true);
...
$jobs_days_closing =  get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_days_closing', true);
$date_posted    = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'date_posted', true);
$closing_date   = get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'closing_date', true);
$current_date = get_the_date('Y-m-d',$jobs_id);
$expiration_date = date('Y-m-d', strtotime($current_date . '+' . $jobs_days_closing . ' days'));
$expiration_date = jobportal_convert_date_format($expiration_date);
...
?>
<div class="jobs-insights-sidebar block-archive-sidebar <?php echo implode(" ", $classes); ?> <?php if ($enable_toggle == '1') : ?>active<?php endif; ?>">
    <h4 class="title-jobs"><?php esc_html_e('Job role insights', 'jobportal-framework') ?></h4>
    <ul class="list-jobs-insights-sidebar">
        <?php if ($date_posted == '1') : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Date posted', 'jobportal-framework') ?></p>
        ...
        <?php if ($closing_date == '1' && $date_posted == '1' && $expiration_date >= $public_date) : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Closing date', 'jobportal-framework') ?></p>
        ...
        <?php if (is_array($jobs_location)) : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Hiring location', 'jobportal-framework') ?></p>
        ...
        <?php if (($jobs_salary_active && $jobs_salary_show == 'range' && $jobs_salary_minimum !== '' && $jobs_salary_maximum !== '')
            ...
            <li class="list-item salary">
                ...
                <div class="info">
                    ...
                    <p class="details-info">
                        <?php echo jobportal_get_salary_jobs($jobs_id); ?>
                    </p>
                </div>
            </li>
        <?php endif; ?>
        <?php if (is_array($jobs_career)) : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Career level', 'jobportal-framework') ?></p>
                    <p class="details-info">
        ...
        <?php if (is_array($jobs_experience)) : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Experience', 'jobportal-framework') ?></p>
                    <p class="details-info">
        ...
        <?php if ($jobs_quantity !== '') : ?>
            <li class="list-item">
                ...
                <div class="info">
                    <p class="title-info"><?php esc_html_e('Quantity', 'jobportal-framework') ?></p>
                    <p class="details-info"><?php echo $jobs_quantity ?> <?php esc_html_e('person', 'jobportal-framework') ?></p>
                </div>
            </li>
        <?php endif; ?>
    ...
    <?php if ($enable_toggle == '1') : ?>
        <div class="toggle-insights-sidebar">
            <a href="#" class="show-more-insights-sidebar"><?php esc_html_e('Show more', 'jobportal-framework'); ?><i class="fas fa-angle-down"></i></a>
            <a href="#" class="hide-all-insights-sidebar"><?php esc_html_e('Hide less', 'jobportal-framework'); ?><i class="fas fa-angle-up"></i></a>
        </div>
    <?php endif; ?>
</div>
