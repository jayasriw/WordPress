...
$jobs_gallery     = get_post_meta($id, JOBPORTAL_METABOX_PREFIX . 'jobs_images', true);
$attach_id         = get_post_thumbnail_id($id);
$show = 3;
?>
<?php if (!empty($jobs_gallery)) : ?>
    <div class="block-archive-inner jobs-gallery-details">
        <h4 class="title-jobs"><?php esc_html_e('Photos', 'jobportal-framework') ?></h4>
        <div class="entry-jobs-element">
            <div class="single-jobs-thumbs enable jobportal-light-gallery">
                <?php
