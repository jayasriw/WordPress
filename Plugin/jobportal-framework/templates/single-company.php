...
/**
 * @Hook: jobportal_single_company_before
 *
 * @hooked single_company_thumbnail
 */
do_action('jobportal_single_company_before');
...
<?php while (have_posts()) : the_post(); ?>
    ...
    <?php jobportal_get_template_part('content', 'single-company'); ?>
...
<?php
/**
 * @hooked jobportal_sidebar_company
 */
do_action('jobportal_sidebar_company');
?>
...
<?php
/**
 * @Hook: jobportal_single_company_after
 *
 * @hooked related_company
 */
do_action('jobportal_single_company_after');
