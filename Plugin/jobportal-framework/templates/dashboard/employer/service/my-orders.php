...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'employer-service-order');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'employer-service-order',
                                    ...
                                    <?php switch ($status) {
                                        case 'transferring': ?>
                                            <li><a class="btn-completed" order-id="<?php echo esc_attr($order_id); ?>"
                                                   href="#"><?php esc_html_e('Complete', 'jobportal-framework') ?></a></li>
                                            <li><a class="btn-order-refund"  order-id="<?php echo esc_attr($order_id); ?>"
                                                   href="#form-service-order-refund"><?php esc_html_e('Refund', 'jobportal-framework') ?></a></li>
                                            <?php break;
                                        case 'pending': ?>
                                            <li><a class="btn-order-refund" order-id="<?php echo esc_attr($order_id); ?>"
                                                   href="#form-service-order-refund"><?php esc_html_e('Refund', 'jobportal-framework') ?></a></li>
