...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'invite-candidate');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'invite-candidate',
    'jobportal_invite_candidate_vars',
    array(
...
<div class="jobportal-invite-candidate">
