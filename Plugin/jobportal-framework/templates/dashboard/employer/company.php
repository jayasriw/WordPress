...
if (!empty($company_id)) {
    jobportal_get_template('company/edit.php');
} else {
    global $current_user;
    ...
    wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'company-dashboard');
    wp_localize_script(
        JOBPORTAL_PLUGIN_PREFIX . 'company-dashboard',
        'jobportal_company_dashboard_vars',
        array(
            'ajax_url'    => JOBPORTAL_AJAX_URL,
            'not_company'   => esc_html__('No companies found', 'jobportal-framework'),
            "delete_company" => wp_create_nonce("delete_company"),
        )
    );
    $args = array(
        'post_type'           => 'company',
...
?>
    ...
    <div class="entry-my-page company-dashboard">
        <div class="entry-title">
            <h4><?php esc_html_e('Companies', 'jobportal-framework') ?></h4>
        </div>
                ...
                <table class="table-dashboard" id="my-company">
                    <thead>
                        <tr>
                            ...
                            <th><?php esc_html_e('Category', 'jobportal-framework') ?></th>
                            <th><?php esc_html_e('Active Jobs', 'jobportal-framework') ?></th>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="action-setting company-control">
                                    ...
                                    <ul class="action-dropdown">
                                        <li><a class="btn-edit" href="<?php echo esc_url($company_dashboard_link); ?>?company_id=<?php echo esc_attr($id); ?>"><?php esc_html_e('Edit', 'jobportal-framework'); ?></a></li>
                                        ...
                                        <?php else : ?>
                                            <li><a class="btn-delete" company-id="<?php echo esc_attr($id); ?>" href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </td>
                            </tr>
        ...
        <?php } ?>
        <a href="<?php echo get_permalink(jobportal_get_option('jobportal_submit_company_page_id')); ?>" class="jobportal-button">
            <i class="far fa-plus"></i><?php esc_html_e('Add new company', 'jobportal-framework') ?>
        </a>
    </div>
<?php } ?>
