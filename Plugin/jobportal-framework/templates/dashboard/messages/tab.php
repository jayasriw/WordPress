...
$data_list_all = jobportal_get_data_list_message(false);
...
<div class="tab-mess">
    <div class="mess-tab-head">
        <ul class="tab-list-mess">
            ...
            <li class="tab-item tab-unread"><a href="#tab-unread"><?php esc_html_e('Unread', 'jobportal-framework'); ?><span>(<?php echo esc_html($total_unread); ?>)</span></a>
            </li>
        </ul>
        <span class="mess-refresh">
            <i class="far fa-sync fa-spin"></i>
            <span><?php esc_html_e('Refresh', 'jobportal-framework'); ?></span>
        </span>
    </div>
    <div class="tab-content custom-scrollbar">
        <div class="tab-info" id="tab-all" data-paged="1" data-max-pages="<?php echo esc_attr($max_pages_all); ?>" data-status="all">
            <?php jobportal_get_template('dashboard/messages/list-user.php', array(
