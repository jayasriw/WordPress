...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'my-invite');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'my-invite',
    'jobportal_my_invite_vars',
    array(
...
<div class="jobportal-my-invite entry-my-page">
    ...
    <?php if ($data->have_posts()) { ?>
        <div class="table-dashboard-wapper">
            <table class="table-dashboard" id="my-invite">
                <thead>
                    <tr>
                        <th><?php esc_html_e('Job Title', 'jobportal-framework') ?></th>
                        ...
                        <tr>
                            ...
                            <td class="action-setting jobs-control">
                                ...
                                <ul class="action-dropdown">
                                    <li><a class="btn-apply" href="<?php echo get_the_permalink($id); ?>" target="_blank"><?php esc_html_e('Apply Now', 'jobportal-framework') ?></a></li>
                                    <?php if ($user_demo == 'yes') : ?>
                                        <li><a class="btn-add-to-message" data-text="<?php echo esc_attr__('This is a "Demo" account ,so you can not delete it', 'jobportal-framework'); ?>" href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                                    <?php else : ?>
                                        <li><a class="btn-delete" jobs-id="<?php echo esc_attr($id); ?>" href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                                    <?php endif; ?>
                                </ul>
                            </td>
                        </tr>
