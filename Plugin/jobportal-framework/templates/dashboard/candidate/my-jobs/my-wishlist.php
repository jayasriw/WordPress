...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'my-wishlist');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'my-wishlist',
    'jobportal_my_wishlist_vars',
    array(
...
<div class="jobportal-my-wishlist entry-my-page">
