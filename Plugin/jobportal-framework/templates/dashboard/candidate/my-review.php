...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'my-review');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'my-review',
    'jobportal_my_review_vars',
    array(
...
<div class="entry-my-page jobportal-my-review">
    <div class="entry-title">
        <h4><?php esc_html_e('My Reviews', 'jobportal-framework') ?></h4>
    </div>
    <div class="search-dashboard-wrapper">
        <div class="search-left">
            <div class="action-search">
                <input class="search-control" type="text" name="company_search" placeholder="<?php esc_attr_e('Find by name', 'jobportal-framework') ?>">
        ...
        <div class="search-right">
            ...
            <div class="select2-field">
				<select class="search-control action-sorting jobportal-select2" name="company_sort_by">
            ...
            <table class="table-dashboard" id="my-review">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e('My Rating', 'jobportal-framework') ?></th>
                        <th><?php esc_html_e('Review Date', 'jobportal-framework') ?></th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                        ...
                        <tr>
                            ...
                            <td class="action-setting company-control">
                                ...
                                <ul class="action-dropdown">
                                    <li><a class="btn-edit" href="<?php echo get_the_permalink($company_id) . '/#company-review-details' ?>"><?php esc_html_e('Edit', 'jobportal-framework') ?></a></li>
                                    <?php if ($user_demo == 'yes') : ?>
                                        <li><a class="btn-add-to-message" href="#" data-text="<?php echo esc_attr__('This is a "Demo" account so you not cant delete it', 'jobportal-framework'); ?>">
                                                <?php esc_html_e('Delete', 'jobportal-framework'); ?>
                                            </a></li>
                                    <?php else : ?>
                                        <li><a class="btn-delete" comment-id="<?php echo esc_attr($comment_id); ?>" href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                                    <?php endif; ?>
                                </ul>
                            </td>
                        </tr>
