...
switch ($field['type']) {
    ...
    ?>
        <div class="form-group col-12">
            <label><?php esc_html_e($field['title']); ?></label>
            <textarea name="<?php echo esc_attr($field['id']); ?>" rows="6" id="<?php echo esc_attr($field['id']); ?>" class="form-control"><?php if (isset($candidate_meta_data[$field['id']])) {
                                                                                                                                                echo sanitize_text_field($candidate_meta_data[$field['id']][0]);
                                                                                                                                            } ?></textarea>
        </div>
    <?php
        ...
        <div class="form-group col-lg-6">
            ...
            <div class="select2-field">
                <select name="<?php echo esc_attr($field['id']); ?>"
                    id="<?php echo esc_attr($field['id']); ?>" class="form-control jobportal-select2">
                    <?php
            ...
            <div class="jobportal-field-<?php echo esc_attr($field['id']); ?>">
                ...
                foreach ($field['options'] as $opt_value) :
                    if (in_array($opt_value, $candidate_field)) : ?>
                        <label class="checkbox-inline inline"><input class="custom-checkbox"
                                type="checkbox"
                                name="<?php echo esc_attr($field['id']); ?>[]"
