    ...
    <div class="jobportal-modal-content">
        ...
        <div class="jobportal-modal-body">
            ...
            <div class="package-warning-notice">
                ...
                <p><?php esc_html_e('Activating a new package will reset all quotas to the new package values. Your current featured services will be deducted from the new package quota.', 'jobportal-framework'); ?></p>
            </div>
        </div>
