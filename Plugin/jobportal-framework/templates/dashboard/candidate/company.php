...
wp_enqueue_script(JOBPORTAL_PLUGIN_PREFIX . 'my-follow');
wp_localize_script(
    JOBPORTAL_PLUGIN_PREFIX . 'my-follow',
    'jobportal_my_follow_vars',
    array(
...
<div class="jobportal-my-follow entry-my-page">
    ...
    <div class="search-dashboard-wrapper">
        <div class="search-left">
            <div class="action-search">
                <input class="search-control" type="text" name="company_search" placeholder="<?php esc_attr_e('Search company title', 'jobportal-framework') ?>">
            ...
            <table class="table-dashboard" id="my-follow">
                <thead>
                    <tr>
                        ...
                        <th><?php esc_html_e('Founded Date', 'jobportal-framework') ?></th>
                    </tr>
                </thead>
                <tbody>
