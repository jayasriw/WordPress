...
if (isset($_POST['submit'])) {
    ...
    if (!isset($_POST['_wpnonce']) || !wp_verify_nonce($_POST['_wpnonce'], 'jobportal_verify_id_form_nonce')) {
        ...
        ?>
            <div class="row">
                ...
                <div class="form-group col-md-6">
                    <div class="candidate-fields-verify-id-before jobportal-fields-verify-id-before">
                        ...
                        <div class="form-field">
                            ...
                            <div id="jobportal_verify_id_before_container" class="file-upload-block preview">
                                <div id="jobportal_verify_id_before_view" data-image-id="<?php echo $candidate_verify_id_before_id; ?>" data-image-url="<?php if (!empty($candidate_verify_id_before_url)) {
                ...
                <div class="form-group col-md-6">
                    <div class="candidate-fields-verify-id-after jobportal-fields-verify-id-after">
                        ...
                        <div class="form-field">
                            ...
                            <div id="jobportal_verify_id_after_container" class="file-upload-block preview">
                                <div id="jobportal_verify_id_after_view" data-image-id="<?php echo $candidate_verify_id_after_id; ?>" data-image-url="<?php if (!empty($candidate_verify_id_after_url)) {
            ...
            <div class="form-submit">
                <input type="hidden" name="_wpnonce" value="<?php echo wp_create_nonce('jobportal_verify_id_form_nonce'); ?>" required />
