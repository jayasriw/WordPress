...
$check_package_employer = jobportal_get_field_check_employer_package('info');
$hide_info_candidate_fields = jobportal_get_option('hide_company_candidate_info_fields', array());
...
if (in_array("jobportal_user_employer", (array)$current_user->roles)) {
    $notice =  esc_attr__("Please renew the package to view", "jobportal-framework");
} else {
    $notice =  esc_attr__("Please access the role Employer and purchase the package to view", "jobportal-framework");
}
?>
        ...
        <?php if (in_array("jobportal_user_employer", (array)$current_user->roles)) { ?>
            <div class="candidate-sidebar block-archive-sidebar candidate-sidebar <?php echo implode(" ", $classes); ?>">
                ...
                <p class="notice">
                    ...
                    <?php esc_html_e("Please renew the package to see the full information", "jobportal-framework"); ?>
                </p>
            </div>
        <?php } else { ?>
            <div class="candidate-sidebar block-archive-sidebar candidate-sidebar <?php echo implode(" ", $classes); ?>">
                ...
                <p class="notice">
                    <i class="fal fa-exclamation-circle"></i>
                    <?php esc_html_e("Please access the role Employer and purchase the package to view full information", "jobportal-framework"); ?>
                </p>
            </div>
        <?php } ?>
    <?php else: ?>
        <div class="candidate-sidebar block-archive-sidebar candidate-sidebar <?php echo implode(" ", $classes); ?>">
            ...
            <?php
            do_action('jobportal/candidate/single/sidebar/info/after');
            ?>
        </div>
    <?php endif; ?>
<?php } ?>
