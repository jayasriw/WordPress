<?php
/**
 * Package Impact Warning Modal Template
 *
 * This template displays a modal warning when user tries to switch packages
...
<div id="jobportal-package-impact-modal" class="jobportal-modal jobportal-package-impact-modal" style="display: none;">
        ...
        <div class="jobportal-modal-body">
            ...
            <div class="jobportal-impact-section jobportal-impact-cleanup" style="display: none;">
                ...
                <p class="jobportal-impact-cleanup-note">
                    <?php esc_html_e('Latest items will be removed/cancelled first.', 'jobportal-framework'); ?>
                </p>
            </div>
