...
// LOGO WIDGET
//==============================================================================
if (!class_exists('JobPortal_Widget_Products')) {
    class JobPortal_Widget_Products extends JobPortal_Widget
    {
        public function __construct()
        {
            $this->widget_cssclass = 'widget-products';
            $this->widget_description = esc_html__("Products", 'jobportal-framework');
            $this->widget_id = 'jobportal_products';
            $this->widget_name = esc_html__('JobPortal - Products', 'jobportal-framework');
            $this->settings = array(
                'title' => array(
                    'type'  => 'text',
                    'std'   => esc_html__('Products', 'jobportal-framework'),
                    'label' => esc_html__('Title', 'jobportal-framework')
                ),
                'number_products' => array(
                    'type'  => 'number',
                    'std'   => '6',
                    'label' => esc_html__('Number of products to show', 'jobportal-framework')
                ),
                'filter_products' => array(
                    ...
                    'options' => array(
                        'new_items'    => esc_html__('Newest', 'jobportal-framework'),
                        'featured'     => esc_html__('Featured', 'jobportal-framework'),
                        'on_sale'      => esc_html__('Sale', 'jobportal-framework'),
                        'best_sellers' => esc_html__('Best Sellers', 'jobportal-framework'),
                    )
                ),
                'sort_by' => array(
                    'type'    => 'select',
