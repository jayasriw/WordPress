...
class Widget_Service extends Widget_Base
{
	...
	{
		return 'jobportal-service';
	}

	public function get_title()
	{
		return esc_html__('Service', 'jobportal-framework');
	}

	public function get_icon()
	{
		return 'jobportal-badge eicon-cogs';
	}
	...
	{
		return [JOBPORTAL_PLUGIN_PREFIX . 'el-service'];
	}

	public function get_style_depends()
	{
		return [JOBPORTAL_PLUGIN_PREFIX . 'service'];
	}
	...
	private function register_layout_section()
	{
		...
		$this->add_control(
			'enable_tab',
			[
				'label' => esc_html__('Enable Tab', 'jobportal-framework'),
		...
		$repeater->add_control(
			...
			[
				...
				'placeholder' => esc_html__('Enter title tab', 'jobportal-framework'),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => array(
					...
					'top_rate' => esc_html__('Top rate', 'jobportal-framework'),
				),
				'label_block' => true,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'title' => esc_html__('Featured', 'jobportal-framework'),
						'type' => 'featured',
					],
					[
						'title' => esc_html__('Newest', 'jobportal-framework'),
						'type' => 'newest',
					],
					[
						'title' => esc_html__('Top rate', 'jobportal-framework'),
						'type' => 'top_rate',
					],
				],
				'condition' => [
	...
	private function register_tab_style_section()
	{
		$this->start_controls_section(
			'section_tab_style',
			[
				'label' => esc_html__('Tab', 'jobportal-framework'),
		...
		$this->add_control(
			...
			[
				...
				'default' => 'fullfield',
				'options' => [
					'fullfield' => esc_html__('Fullfield', 'jobportal-framework'),
					'underline' => esc_html__('Underline', 'jobportal-framework'),
				],
			]
		);

		$this->add_responsive_control('nav_h_align', [
			'label' => esc_html__('Alignment horizontal', 'jobportal-framework'),
	...
	private function register_layout_style_section()
	{
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .jobportal-service-item',
			]
		);
		...
		$this->add_control('box_padding', [
			...
			'size_units' => ['px', '%'],
			'selectors' => [
				'{{WRAPPER}} .jobportal-service-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
		...
		$this->add_control('layout_border_radius', [
			...
			'size_units' => ['px', '%'],
			'selectors' => [
				'{{WRAPPER}} .jobportal-service-item' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
			],
		]);
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'jobportal-service');
		$args = array(
