...
class Widget_Candidate_Category extends Widget_Base
{
	...
	{
		return 'jobportal-candidate-category';
	}

	public function get_title()
	{
		return esc_html__('Candidate Category', 'jobportal-framework');
	}
	...
	{
		return [JOBPORTAL_PLUGIN_PREFIX . 'candidate-category'];
	}
	...
	private function register_layout_section()
	{
		...
		$this->add_control('layout', [
            ...
            'options' => [
                'layout-01' => esc_html__('Layout 01', 'jobportal-framework'),
                'layout-02' => esc_html__('Layout 02', 'jobportal-framework'),
            ],
            'default' => 'layout-01',
        ]);
		...
		$repeater->add_control(
			'icon_item_color',
			[
				'label' => esc_html__('Icon Color', 'jobportal-framework'),
		...
		$repeater->add_control(
			'icon_item_bg_color',
			[
				'label' => esc_html__('Icon Background Color', 'jobportal-framework'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
		...
		$repeater->add_control(
			'item_color',
			[
				'label' => esc_html__('Color', 'jobportal-framework'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
