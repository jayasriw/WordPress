...
class Widget_Package extends Widget_Base
{
    ...
    {
        return 'jobportal-badge eicon-price-table';
    }
    ...
    {
        return [JOBPORTAL_PLUGIN_PREFIX . 'package'];
    }
    ...
    private function add_layout_section()
    {
        ...
        $this->add_control('for', [
            'label' => esc_html__('For', 'jobportal-framework'),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'package' => esc_html__('Employer', 'jobportal-framework'),
                'candidate_package' => esc_html__('Candidate', 'jobportal-framework'),
            ],
            'default' => 'package',
        ]);
        ...
        $this->add_control('layout', [
            ...
            'options' => [
                ...
                '02' => esc_html__('Layout 02', 'jobportal-framework'),
                '03' => esc_html__('Layout 03', 'jobportal-framework'),
            ],
            'default' => '01',
            'prefix_class' => 'jobportal-package-layout-',
        ]);
        $this->add_control('price_decimals', [
            'label' => esc_html__('Price Decimals', 'jobportal-framework'),
        ...
        $this->add_control('employer_title', [
            'label'       => esc_html__('Title Package', 'jobportal-framework'),
    ...
    protected function render()
    {
        ...
        $this->add_render_attribute('wrapper', 'class', 'jobportal-package jobportal-package-wrap');
                                        ...
                                        if ($user_demo == 'yes') { ?>
                                            <?php if ($user_package_id == $package_id && $d1 > $d2) { ?>
                                                <a href="#" class="jobportal-button button-block btn-add-to-message"
                                                    ...
                                                    <?php esc_html_e('Package Activated', 'jobportal-framework'); ?></a>
                                            <?php } else { ?>
                                                <a href="#" class="jobportal-button button-outline button-block btn-add-to-message"
                                                    data-text="<?php echo esc_attr__('This is a "Demo" account, so you can not change it', 'jobportal-framework'); ?>">
                                                    <?php esc_html_e('Get Started', 'jobportal-framework'); ?></a>
                                            <?php } ?>
                                        <?php } else { ?>
                                            <?php if ($user_package_id == $package_id && $d1 > $d2) { ?>
                                                <a href="<?php echo esc_url($payment_process_link); ?>" class="jobportal-button button-block"><?php esc_html_e('Package Activated', 'jobportal-framework'); ?></a>
                                            <?php } else { ?>
                                                <a href="<?php echo esc_url($payment_process_link); ?>" class="jobportal-button button-outline button-block"><?php esc_html_e('Get Started', 'jobportal-framework'); ?></a>
                                            <?php } ?>
                                        <?php } ?>
                                    </div>
                                <?php } ?>
                            ...
                            <div class="jobportal-package-item panel panel-default <?php echo esc_attr($is_current); ?> <?php echo esc_attr($is_featured); ?>">
                                        ...
                                        <?php } else { ?>
                                            <?php if ($user_candidate_package_id == $candidate_package_id && $d1 > $d2) { ?>
                                                <a href="<?php echo esc_url($payment_process_link); ?>"
                                                    class="jobportal-button button-block"><?php esc_html_e('Package Activated', 'jobportal-framework'); ?></a>
                                            <?php } else { ?>
                                                <a href="<?php echo esc_url($payment_process_link); ?>"
                                                    class="jobportal-button button-outline button-block"><?php esc_html_e('Get Started', 'jobportal-framework'); ?></a>
                                            <?php } ?>
                                        <?php } ?>
                                    </div>
                                <?php } ?>
                                <ul class="list-group custom-scrollbar">
                                    ...
                                    <?php foreach ($field_package as $field) :
                                        ...
                                        switch ($field) {
                                            case 'jobs_apply':
                                                $name_singular = __('Apply for %s job', 'jobportal-framework');
                                                $name_plural = __('Apply for %s jobs', 'jobportal-framework');
                                                $is_check = false;
                                                break;
                                            case 'jobs_wishlist':
                                                $name_singular = __('Wishlist %s job', 'jobportal-framework');
                                                $name_plural = __('Wishlist %s jobs', 'jobportal-framework');
                                                $is_check = false;
                                                break;
                                            case 'company_follow':
                                                $name_singular = __('Follow %s company', 'jobportal-framework');
                                                $name_plural = __('Follow %s companies', 'jobportal-framework');
                                                $is_check = false;
                                                break;
