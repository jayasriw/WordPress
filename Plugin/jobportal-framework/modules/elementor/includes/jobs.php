...
class Widget_Jobs extends Widget_Base
{
	...
	{
		return 'jobportal-jobs';
	}

	public function get_title()
	{
		return esc_html__('Jobs', 'jobportal-framework');
	}
	...
	{
		return [JOBPORTAL_PLUGIN_PREFIX . 'el-jobs-pagination'];
	}

	public function get_style_depends()
	{
		return [JOBPORTAL_PLUGIN_PREFIX . 'jobs'];
	}
	...
	private function register_query_section()
	{
		...
		$this->add_control(
			'enable_pagination',
			[
				'label' => esc_html__('Enable Pagination', 'jobportal-framework'),
				'type' => Controls_Manager::SWITCHER,
				'default' => '',
				'condition' => [
					'enable_slider' => '',
		...
		$this->add_control(
			'type_pagination',
			[
				'label' => esc_html__('Type Pagination', 'jobportal-framework'),
				'type' => Controls_Manager::SELECT,
				'default' => 'number',
				'options' => [
					'number' => esc_html__('Number', 'jobportal-framework'),
					'loadmore' => esc_html__('Loadmore', 'jobportal-framework'),
				],
				'condition' => [
					'enable_pagination!' => '',
					'enable_slider' => '',
		...
		$taxonomies = array(
			...
			esc_html__("Location", 'jobportal-framework') => "jobs-location",
	...
	protected function render()
	{
		...
		$this->add_render_attribute('wrapper', 'class', 'jobportal-jobs');
