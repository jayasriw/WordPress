...
class Widget_Service_Category extends Widget_Base
{
    ...
    {
        return 'jobportal-service-category';
    }

    public function get_title()
    {
        return esc_html__('Service Category', 'jobportal-framework');
    }
    ...
    {
        return [JOBPORTAL_PLUGIN_PREFIX . 'service-category'];
    }
    ...
    private function register_layout_section()
    {
        ...
        $this->add_responsive_control('content_v_align', [
            'label' => esc_html__('Alignment vertical', 'jobportal-framework'),
            ...
            'options' => array(
                ...
                'center' => [
                    'title' => esc_html__('Middle', 'jobportal-framework'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => [
                    [
                        'text' => esc_html__('Service Category #1', 'jobportal-framework'),
                    ],
                    [
                        'text' => esc_html__('Service Category #2', 'jobportal-framework'),
                    ],
                    [
                        'text' => esc_html__('Service Category #3', 'jobportal-framework'),
                    ],
                    [
                        'text' => esc_html__('Service Category #3', 'jobportal-framework'),
                    ],
                    ...
                    if (!empty($service_slug)) {
                        ...
                        if ($cate && !is_wp_error($cate) && !empty($cate->term_id)) {
                            ...
                            if (function_exists('jobportal_get_term_post_count_for_sidebar')) {
                                $term_count = jobportal_get_term_post_count_for_sidebar($cate->term_id, 'service-categories');
                            } else {
                        ...
                        <div class="cate-inner">
                            ...
                            <div class="cate-content">
                                ...
                                <?php if ($settings['show_count'] == 'yes' && isset($term_count)) : ?>
                                    <p class="cate-count"><?php echo sprintf(_n('%s service', '%s services', $term_count, 'jobportal-framework'), number_format_i18n($term_count)); ?></p>
                                <?php endif; ?>
                            </div>
