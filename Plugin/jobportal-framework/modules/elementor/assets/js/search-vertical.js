(function ($) {
    ...
    var VerticalSearchHandler = function ($scope, $) {
        var search_vertical = $scope.find('.jobportal-search-vertical');
        ...
        search_vertical.find('.jobportal-ajax-select2').select2({
        ...
        search_vertical.find('.jobportal-select2').select2({
            minimumResultsForSearch: -1,
            width: '100%'
        });

        search_vertical.find('.jobportal-clear-top-filter').on('click', function() {
    ...
    $(window).on("elementor/frontend/init", function () {
        elementorFrontend.hooks.addAction(
            "frontend/element_ready/jobportal-search-vertical.default",
