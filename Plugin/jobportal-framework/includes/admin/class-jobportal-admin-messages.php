...
if (!class_exists('JobPortal_Admin_Messages')) {
    /**
     * Class JobPortal_Admin_Messages
     */
    class JobPortal_Admin_Messages
    {
        ...
        public function register_custom_column_titles($columns)
        {
            ...
            $columns['messages_content']  = esc_html__('Content', 'jobportal-framework');
        ...
        public function display_custom_column($column)
        {
            ...
            switch ($column) {
                case 'thumb':
                    $creator_message = get_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'creator_message', true);
        ...
        public function messages_filter($query)
        {
            ...
            if ($pagenow == 'edit.php' && isset($q_vars['post_type']) && $q_vars['post_type'] == $post_type) {
                $messages_user = isset($_GET['messages_user']) ? jobportal_clean(wp_unslash($_GET['messages_user'])) : '';
                if ($messages_user !== '') {
                    ...
                    $filter_arr[] = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'messages_user_id',
                        'value' => $user_id,
                        'compare' => 'IN',
                    );
                }
