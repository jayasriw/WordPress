...
if (!class_exists('JobPortal_Ajax')) {

    /**
     * Class JobPortal_Ajax
     */
    class JobPortal_Ajax
    {
        /**
        ...
        public function preview_job()
        {
            ...
            check_ajax_referer('jobportal_ajax_nonce', 'security', false);

            ob_start();
            $post_id = isset($_REQUEST['id']) ? jobportal_clean(wp_unslash($_REQUEST['id'])) : '';
            $company_id_meta = get_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'jobs_select_company');
            ...
            if ($social_options === null) {
                $social_options = array(
                    'twitter' => jobportal_get_option('enable_social_twitter', '1'),
                    'linkedin' => jobportal_get_option('enable_social_linkedin', '1'),
                    'facebook' => jobportal_get_option('enable_social_facebook', '1'),
                    'instagram' => jobportal_get_option('enable_social_instagram', '1'),
                );
            }
            ...
            if ($company_id !== '') {
                ...
                $company_logo = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_logo']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_logo'] : array();
                $company_categories = get_the_terms($company_id, 'company-categories');
                $company_founded = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_founded']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_founded'] : array();
                $company_phone = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_phone']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_phone'] : array();
                $company_email = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_email']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_email'] : array();
                $company_size = get_the_terms($company_id, 'company-size');
                $company_website = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_website']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_website'] : array();
                $company_twitter = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_twitter']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_twitter'] : array();
                $company_facebook = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_facebook']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_facebook'] : array();
                $company_instagram = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_instagram']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_instagram'] : array();
                $company_linkedin = isset($company_meta[JOBPORTAL_METABOX_PREFIX . 'company_linkedin']) ? $company_meta[JOBPORTAL_METABOX_PREFIX . 'company_linkedin'] : array();
...
?>
                        ...
                        <div class="preview-tabs">
                            <ul class="tab-nav">
                                <li><a href="#job-detail"
                                        class="is-active"><?php esc_html_e('Job Detail', 'jobportal-framework'); ?></a></li>
                                <?php
                                if ($company_id !== '') {
                                ?>
                                    <li>
                                        <a href="#company-overview"><?php esc_html_e('Company Overview', 'jobportal-framework'); ?></a>
                                    </li>
                                <?php
                                }
                                ?>
                                    ...
                                    <div class="company-overview">
                                        ...
                                        <?php if (!empty($mycompany->post_content)) : ?>
                                            <div class="content"><?php echo $mycompany->post_content; ?><a
                                                    href="#"><?php esc_html_e('Read more', 'jobportal-framework'); ?></a>
                                            </div>
                                        <?php endif; ?>
                                                ...
                                                <div class="list-cate">
                                                    <?php foreach ($company_categories as $categories) {
                                                        ...
                                                        <a href="<?php echo esc_url($cate_link); ?>"
                                                            class="cate jobportal-link-bottom">
                                        ...
                                        ?>
                                            <a href="<?php echo $company_website[0]; ?>"
                                                class="jobportal-button button-outline button-block button-visit"
                                                target="_blank"><?php esc_html_e('Visit ', 'jobportal-framework'); ?><?php echo $name_website ?>
         ...
         */
        public function jobportal_jobs_archive_ajax()
        {
            // Optional nonce check for defense in depth (non-fatal)
            check_ajax_referer('jobportal_ajax_nonce', 'security', false);

            $title = isset($_REQUEST['title']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['title'])) : '';
            $item_amount = isset($_REQUEST['item_amount']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $sort_by = isset($_REQUEST['sort_by']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['sort_by'])) : '';
            $categories = isset($_REQUEST['categories']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['categories'])) : '';
            if (!empty($categories)) {
            ...
            $types = isset($_REQUEST['types']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['types'])) : [];
            $has_map_val = isset($_REQUEST['has_map_val']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['has_map_val'])) : '';
            $experience = isset($_REQUEST['experience']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['experience'])) : '';
            $career = isset($_REQUEST['career']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['career'])) : '';
            $skills = isset($_REQUEST['skills']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['skills'])) : '';
            $gender = isset($_REQUEST['gender']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['gender'])) : '';
            $qualification = isset($_REQUEST['qualification']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['qualification'])) : '';
            $salary_min = isset($_REQUEST['salary_min']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['salary_min'])) : '';
            $salary_max = isset($_REQUEST['salary_max']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['salary_max'])) : '';
            $data_salary_max = isset($_REQUEST['data_salary_max']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['data_salary_max'])) : '';
            $current_term = isset($_REQUEST['current_term']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['current_term'])) : '';
            $type_term = isset($_REQUEST['type_term']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['type_term'])) : '';
            $location = isset($_REQUEST['location']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['location'])) : '';
            $location_country = isset($_REQUEST['location_country']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['location_country'])) : '';
            $location_state = isset($_REQUEST['location_state']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['location_state'])) : '';
            $location_city = isset($_REQUEST['location_city']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['location_city'])) : '';
            $radius_cities = isset($_REQUEST['radius_cities']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['radius_cities'])) : '';
            $jobs_layout = isset($_REQUEST['jobs_layout']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['jobs_layout'])) : '';
            $jobs_posting_date = isset($_REQUEST['jobs_posting_date']) ? JobPortal_Helper::jobportal_clean(wp_unslash($_REQUEST['jobs_posting_date'])) : '';
            ...
            if (!empty($sort_by)) {
                switch ($sort_by) {
                    case 'featured':
                        $args['meta_key'] = JOBPORTAL_METABOX_PREFIX . 'jobs_featured';
            ...
            if (!empty($title)) {
                $enable_jobs_show_des = jobportal_get_option('enable_jobs_show_des', '0');
                $search_columns = ($enable_jobs_show_des == '1')
                    ? array('post_title', 'post_content')
                    : array('post_title');

                // Check active search plugin
                if (class_exists('JobPortal_Search') && JobPortal_Search::get_active_search_plugin()) {
                    $args['s'] = $title;
                ...
                } elseif (class_exists('JobPortal_Search') && JobPortal_Search::is_fulltext_enabled() && JobPortal_Search::fulltext_index_exists()) {
                    $args['s'] = $title;
            ...
            if (!$is_full_range && $salary_min !== '' && $salary_max !== '') {
                if ($salary_min == 0 || $salary_min === '0') {
                    ...
                    $meta_query[] = array(
                        'relation' => 'OR',
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'jobs_salary_minimum',
                            'value' => array(intval($salary_min), intval($salary_max)),
                            'type' => 'NUMERIC',
                            'compare' => 'BETWEEN',
                        ),
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'jobs_salary_maximum',
                            'value' => array(intval($salary_min), intval($salary_max)),
                            'type' => 'NUMERIC',
                            'compare' => 'BETWEEN',
                        ),
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'jobs_minimum_price',
                            'value' => array(intval($salary_min), intval($salary_max)),
                            'type' => 'NUMERIC',
                            'compare' => 'BETWEEN',
                        ),
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'jobs_maximum_price',
                            'value' => array(intval($salary_min), intval($salary_max)),
                            'type' => 'NUMERIC',
                            'compare' => 'BETWEEN',
                        ),
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'jobs_salary_show',
                            'value' => 'agree',
                            'compare' => '='
                        ),
                    );
            ...
            if (!empty($radius_cities) && $radius_cities !== 0 && !empty($location)) {
                ...
                if (!empty($taxonomies)) {
                    $resultsCities = jobportal_find_nearby_cities($location, intval($radius_cities));
            ...
            if (class_exists('JobPortal_Search')) {
                $args = JobPortal_Search::optimize_args($args);
            }
            ...
            if (!empty($total_post)) {
                if (!empty($title)) {
                    $count_post = sprintf(esc_html__('%1$s jobs for "%2$s"', 'jobportal-framework'), '<span class="count">' . $total_post . '</span>', $title);
                } else {
                    $count_post = sprintf(_n('%s jobs', '%s jobs', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                }
            } else {
                $count_post = esc_html__('0 job', 'jobportal-framework');
            }

            if (!empty($current_term)) {
                $count_post = sprintf(_n('%s jobs', '%s jobs', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                if (empty($total_post)) {
                    $count_post = sprintf(__('%s jobs', 'jobportal-framework'), $total_post);
                }
            }

            // Pagination
            $max_num_pages = $data->max_num_pages;
            $pagination_type = jobportal_get_option('jobs_pagination_type', 'loadmore');
            if ($pagination_type == 'number') {
                $pagination = paginate_links(apply_filters('jobportal_pagination_args', array(
                    'total' => $max_num_pages,
                    'current' => $paged,
                    'mid_size' => 1,
                    'type' => 'array',
                    'prev_text' => __('<i class="fal fa-chevron-left"></i>', 'jobportal-framework'),
                    'next_text' => __('<i class="fal fa-chevron-right"></i>', 'jobportal-framework'),
                )));
            } else {
                $pagination = '<a class="page-numbers next" href="#"><span>' . __('Load More', 'jobportal-framework') . '</span><span class="btn-loading"><i class="fal fa-spinner fa-spin large"></i></span></a>';
            }
                ...
                while ($data_map->have_posts()) : $data_map->the_post();
                    ...
                    if ($lat !== null && $lng !== null) {
                        ...
                        if (!empty($company_logo[0]['url'])) {
                            ...
                            $marker_icon = JOBPORTAL_PLUGIN_URL . 'assets/images/map-marker-icon.png';
                        }
                        ...
                        $jobs_url = JOBPORTAL_PLUGIN_URL . 'assets/images/map-marker-icon.png';
                        $default_marker = jobportal_get_option('marker_icon', '');
                        if ($default_marker != '') {
         ...
         * Company Archive
         */
        public function jobportal_company_archive_ajax()
        {
            // Optional nonce check for defense in depth (non-fatal)
            check_ajax_referer('jobportal_ajax_nonce', 'security', false);

            $title = isset($_REQUEST['title']) ? jobportal_clean(wp_unslash($_REQUEST['title'])) : '';
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $sort_by = isset($_REQUEST['sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['sort_by'])) : '';
            $has_map_val = isset($_REQUEST['has_map_val']) ? jobportal_clean(wp_unslash($_REQUEST['has_map_val'])) : '';
            $current_term = isset($_REQUEST['current_term']) ? jobportal_clean(wp_unslash($_REQUEST['current_term'])) : '';
            $type_term = isset($_REQUEST['type_term']) ? jobportal_clean(wp_unslash($_REQUEST['type_term'])) : '';
            $size = isset($_REQUEST['size']) ? jobportal_clean(wp_unslash($_REQUEST['size'])) : '';
            $rating = isset($_REQUEST['rating']) ? jobportal_clean(wp_unslash($_REQUEST['rating'])) : '';
            $range_min = isset($_REQUEST['range_min']) ? jobportal_clean(wp_unslash($_REQUEST['range_min'])) : '';
            $range_max = isset($_REQUEST['range_max']) ? jobportal_clean(wp_unslash($_REQUEST['range_max'])) : '';
            $founded = isset($_REQUEST['founded']) ? jobportal_clean(wp_unslash($_REQUEST['founded'])) : '';
            $location = isset($_REQUEST['location']) ? jobportal_clean(wp_unslash($_REQUEST['location'])) : '';
            $location_country = isset($_REQUEST['location_country']) ? jobportal_clean(wp_unslash($_REQUEST['location_country'])) : '';
            $location_state = isset($_REQUEST['location_state']) ? jobportal_clean(wp_unslash($_REQUEST['location_state'])) : '';
            $location_city = isset($_REQUEST['location_city']) ? jobportal_clean(wp_unslash($_REQUEST['location_city'])) : '';
            $radius_cities = isset($_REQUEST['radius_cities']) ? jobportal_clean(wp_unslash($_REQUEST['radius_cities'])) : '';
            $categories = isset($_REQUEST['categories']) ? jobportal_clean(wp_unslash($_REQUEST['categories'])) : '';
            $company_layout = isset($_REQUEST['company_layout']) ? jobportal_clean(wp_unslash($_REQUEST['company_layout'])) : '';
            ...
            if (!empty($title)) {
                $enable_company_show_des = jobportal_get_option('enable_company_show_des', '0');
            ...
            if (!empty($rating)) {
                if (in_array('rating_5', $rating)) {
                    $rating_five = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'company_rating',
                        'value' => 5,
                        'type' => 'NUMERIC',
                        'compare' => '==',
                    );
            ...
            if (!empty($range_min) && !empty($range_max)) {
                $meta_query[] = array(
                    'key' => JOBPORTAL_METABOX_PREFIX . 'company_founded',
            ...
            if (!empty($sort_by)) {
                ...
                if ($sort_by == 'rating') {
                    $args['meta_key'] = JOBPORTAL_METABOX_PREFIX . 'company_rating';
            ...
            if (!empty($total_post)) {
                if (!empty($title)) {
                    $count_post = sprintf(esc_html__('%1$s companies for "%2$s"', 'jobportal-framework'), '<span class="count">' . $total_post . '</span>', $title);
                } else {
                    $count_post = sprintf(_n('%s companies', '%s companies', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                }
            } else {
                $count_post = esc_html__('0 company', 'jobportal-framework');
            }

            if (!empty($current_term)) {
                $count_post = sprintf(_n('%s companies', '%s companies', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                if (empty($total_post)) {
                    $count_post = sprintf(__('%s companies', 'jobportal-framework'), $total_post);
                }
            }

            $pagination_type = jobportal_get_option('company_pagination_type', 'loadmore');
            if ($pagination_type == 'number') {
                $pagination = paginate_links(apply_filters('jobportal_pagination_args', array(
                    'total' => $max_num_pages,
                    'current' => $paged,
            ...
            if ($total_post > 0 && (!empty($has_map_val) || $enable_company_show_map == 1)) {
                ...
                while ($data_map->have_posts()) : $data_map->the_post();
                    ...
                    $map_zoom_level = jobportal_get_option('map_zoom_level', '15');

                    $company_address = isset($company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_address']) ? $company_meta_data[JOBPORTAL_METABOX_PREFIX . 'company_address'][0] : '';
                    ...
                    if ($lat !== null && $lng !== null) {
                        ...
                        jobportal_get_template('content-company.php', array(
                            'company_id' => $company_id,
                        ...
                        if (empty($company_url)) {
                            $company_url = JOBPORTAL_PLUGIN_URL . 'assets/images/map-marker-icon.png';
                            $default_marker = jobportal_get_option('marker_icon', '');
                            if ($default_marker != '') {
                                if (is_array($default_marker) && $default_marker['url'] != '') {
         ...
         *  Candidate Archive
         */
        public function jobportal_candidate_archive_ajax()
        {
            // Optional nonce check for defense in depth (non-fatal)
            check_ajax_referer('jobportal_ajax_nonce', 'security', false);
            ...
            $location_city = isset($_REQUEST['location_city']) ? jobportal_clean(wp_unslash($_REQUEST['location_city'])) : '';
            $radius_cities = isset($_REQUEST['radius_cities']) ? jobportal_clean(wp_unslash($_REQUEST['radius_cities'])) : '';
            $candidate_layout = isset($_REQUEST['candidate_layout']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_layout'])) : '';
            ...
            $args = array(
                ...
                'ignore_sticky_posts' => 1,
                'post_status'         => 'publish',
                'meta_key'            => 'jobportal-candidate_featured',
                'orderby'             => array(
                    'meta_value_num' => 'DESC',
                    'date' => 'DESC'
                ),
            ...
            // Search logic
            if (!empty($title)) {
                $enable_candidate_show_des = jobportal_get_option('enable_candidate_show_des', '0');
            ...
            if (!empty($sort_by)) {
                ...
                if ($sort_by == 'rating') {
                    $args['meta_key'] = JOBPORTAL_METABOX_PREFIX . 'candidate_rating';
                    $args['orderby'] = 'meta_value_num';
                    $args['order'] = 'DESC';
                }
            }
            ...
            if (!empty($rating)) {
                ...
                if (in_array('rating_5', $rating)) {
                    $rating_queries[] = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'candidate_rating',
                        'value' => 5,
                        'type' => 'NUMERIC',
                        'compare' => '==',
                    );
            ...
            if (!empty($meta_query)) {
                ...
                $args['meta_query'] = array(
                    ...
                    array(
                        'relation' => 'OR',
                        array(
                            'key'     => 'jobportal-candidate_featured',
                            'compare' => 'EXISTS',
                        ),
                        array(
                            'key'     => 'jobportal-candidate_featured',
            ...
            if (!empty($total_post)) {
                $count_post = sprintf(_n('%s candidates', '%s candidates', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
            } else {
                $count_post = esc_html__('0 candidate', 'jobportal-framework');
            }

            if (!empty($current_term)) {
                $count_post = sprintf(_n('%s candidates', '%s candidates', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                if (empty($total_post)) {
                    $count_post = sprintf(__('%s candidates', 'jobportal-framework'), $total_post);
                }
            }

            $archive_candidate_layout = jobportal_get_option('archive_candidate_layout', 'layout-list');
            if (!empty($title) && $archive_candidate_layout == 'layout-list') {
                $count_post = sprintf(esc_html__('%1$s candidates for "%2$s"', 'jobportal-framework'), '<span>' . $total_post . '</span>', $title);
            }

            $max_num_pages = $data->max_num_pages;
            $pagination_type = jobportal_get_option('candidate_pagination_type', 'loadmore');
            if ($pagination_type == 'number') {
                $pagination = paginate_links(apply_filters('jobportal_pagination_args', array(
                    'total' => $max_num_pages,
                    'current' => $paged,
            ...
            $enable_candidate_show_map = jobportal_get_option('enable_candidate_show_map');
            ...
            if ($total_post > 0 && (!empty($has_map_val) || $enable_candidate_show_map == 1)) {
                ...
                while ($data_map->have_posts()) : $data_map->the_post();
                    ...
                    $candidate_address = isset($candidate_meta_data[JOBPORTAL_METABOX_PREFIX . 'candidate_address']) ? $candidate_meta_data[JOBPORTAL_METABOX_PREFIX . 'candidate_address'][0] : '';
                    ...
                    if ($lat !== null && $lng !== null) {
                        ...
                        jobportal_get_template('content-candidate.php', array(
                        ...
                        if (empty($candidate_url)) {
                            $candidate_url = JOBPORTAL_PLUGIN_URL . 'assets/images/map-marker-icon.png';
                            $default_marker = jobportal_get_option('marker_icon', '');
                            if ($default_marker != '') {
                                if (is_array($default_marker) && $default_marker['url'] != '') {
         ...
         * Service Archive
         */
        public function jobportal_service_archive_ajax()
        {
            $title = isset($_REQUEST['title']) ? jobportal_clean(wp_unslash($_REQUEST['title'])) : '';
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            ...
            $radius_cities = isset($_REQUEST['radius_cities']) ? jobportal_clean(wp_unslash($_REQUEST['radius_cities'])) : '';
            $categories = isset($_REQUEST['categories']) ? jobportal_clean(wp_unslash($_REQUEST['categories'])) : '';
            $skills = isset($_REQUEST['skills']) ? jobportal_clean(wp_unslash($_REQUEST['skills'])) : '';
            $language = isset($_REQUEST['language']) ? jobportal_clean(wp_unslash($_REQUEST['language'])) : '';
            $price_min = isset($_REQUEST['price_min']) ? jobportal_clean(wp_unslash($_REQUEST['price_min'])) : '';
            $price_max = isset($_REQUEST['price_max']) ? jobportal_clean(wp_unslash($_REQUEST['price_max'])) : '';
            $time_type = isset($_REQUEST['time_type']) ? jobportal_clean(wp_unslash($_REQUEST['time_type'])) : '';
            $language_level = isset($_REQUEST['language_level']) ? jobportal_clean(wp_unslash($_REQUEST['language_level'])) : '';
            $service_layout = isset($_REQUEST['service_layout']) ? jobportal_clean(wp_unslash($_REQUEST['service_layout'])) : '';
            ...
            $args = array(
                ...
                'post_type' => 'service',
                'paged' => $paged,
                'meta_key' => JOBPORTAL_METABOX_PREFIX . 'service_featured',
            ...
            if (!empty($title)) {
                $enable_service_show_des = jobportal_get_option('enable_service_show_des', '0');
            ...
            if (!empty($location) && ($radius_cities == 0 || empty($radius_cities))) {
                $location_term = JobPortal_Location_Search::find_location_term($location, 'service-location');
            ...
            if (!empty($rating)) {
                if ((is_array($rating) && in_array('rating_five', $rating)) || $rating == 'rating_five') {
                    $rating_five = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'service_rating',
                        'value' => 5,
                        'type' => 'NUMERIC',
                        'compare' => '==',
                    );
            ...
            if (!empty($time_type)) {
                if (empty($price_min) && empty($price_max)) {
                    $meta_query[] = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'service_time_type',
                        'value' => $time_type,
                        'compare' => '=',
                    );
                }
                ...
                if (!empty($price_min) && empty($price_max)) {
                    $meta_query[] = array(
                        'relation' => 'AND',
                        array(
                            'key' => JOBPORTAL_METABOX_PREFIX . 'service_price',
                            'value' => $price_min,
                            'type' => 'NUMERIC',
                            'compare' => '>=',
                        ),
            ...
            if (!empty($language_level)) {
                ...
                if ((is_array($language_level) && in_array('basic', $language_level)) || $language_level == 'basic') {
                    $basic = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'service_language_level',
                        'value' => 'basic',
                        'compare' => '=',
                    );
                }
            ...
            if (!empty($sort_by)) {
                ...
                if ($sort_by == 'rating') {
                    $args['meta_key'] = JOBPORTAL_METABOX_PREFIX . 'service_rating';
                    $args['orderby'] = 'meta_value_num';
                    $args['order'] = 'DESC';
                }
            }
            ...
            if (!empty($total_post)) {
                if (!empty($title)) {
                    $count_post = sprintf(esc_html__('%1$s services for "%2$s"', 'jobportal-framework'), '<span class="count">' . $total_post . '</span>', $title);
                } else {
                    $count_post = sprintf(_n('%s services', '%s services', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                }
            } else {
                $count_post = esc_html__('0 service', 'jobportal-framework');
            }

            if (!empty($current_term)) {
                $count_post = sprintf(_n('%s services', '%s services', $total_post, 'jobportal-framework'), '<span class="count">' . esc_html($total_post) . '</span>');
                if (empty($total_post)) {
                    $count_post = sprintf(__('%s services', 'jobportal-framework'), $total_post);
                }
            }

            $pagination_type = jobportal_get_option('service_pagination_type', 'loadmore');
            if ($pagination_type == 'number') {
                $pagination = paginate_links(apply_filters('jobportal_pagination_args', array(
                    'total' => $max_num_pages,
                    'current' => $paged,
            ...
            $enable_service_show_map = jobportal_get_option('enable_service_show_map');
            $has_map = !empty($_GET['has_map']) ? jobportal_clean(wp_unslash($_GET['has_map'])) : 1;
            if ($total_post > 0 && ($has_map || $enable_service_show_map == '1')) {
                ...
                while ($data_map->have_posts()) : $data_map->the_post();
                    ...
                    $service_address = isset($service_meta_data[JOBPORTAL_METABOX_PREFIX . 'service_address']) ? $service_meta_data[JOBPORTAL_METABOX_PREFIX . 'service_address'][0] : '';
                    ...
                    jobportal_get_template('content-service.php', array(
                    ...
                    if (empty($service_url)) {
                        $service_url = JOBPORTAL_PLUGIN_URL . 'assets/images/map-marker-icon.png';
                        $default_marker = jobportal_get_option('marker_icon', '');
                        if ($default_marker != '') {
                            if (is_array($default_marker) && $default_marker['url'] != '') {
         ...
         * Jobs Filter
         */
        public function jobportal_filter_jobs_dashboard()
        {
            nocache_headers();
            ...
            check_ajax_referer('jobportal_ajax_nonce', 'security');

            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $jobs_search = isset($_REQUEST['jobs_search']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_search'])) : '';
            $jobs_status = isset($_REQUEST['jobs_status']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_status'])) : '';
            $sort_by = isset($_REQUEST['jobs_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_sort_by'])) : '';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            $package_num_featured_jobs = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'package_number_featured', $user_id);
            ...
            $package_unlimited_listing = get_post_meta($user_package_id, JOBPORTAL_METABOX_PREFIX . 'package_unlimited_listing', true);

            if (!empty($item_id)) {
                $jobs = get_post($item_id);
                if ($action_click == 'mark-featured') {
                    if ($package_unlimited_featured_job !== '1' && $package_num_featured_jobs > 0) {
                        update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_number_featured', $package_num_featured_jobs - 1);
                    }
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'jobs_featured', 1);
                }
                ...
                if ($action_click == 'mark-filled') {
                    ...
                    wp_update_post($data);
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'jobs_featured', 0);
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'enable_jobs_expires', 1);
                }
                ...
                if ($action_click == 'extend') {
                    ...
                    wp_update_post($data);
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'enable_jobs_expires', 0);
                }
            }
            ...
            $default_jobs_days = jobportal_get_option('jobs_number_days', true);
            ...
            if ($total_post > 0) {
                while ($data->have_posts()) : $data->the_post();
                    ...
                    $jobs_days_single = isset($job_meta[JOBPORTAL_METABOX_PREFIX . 'jobs_days_closing'][0]) ? $job_meta[JOBPORTAL_METABOX_PREFIX . 'jobs_days_closing'][0] : '';
                    $enable_jobs_expires = isset($job_meta[JOBPORTAL_METABOX_PREFIX . 'enable_jobs_expires'][0]) ? $job_meta[JOBPORTAL_METABOX_PREFIX . 'enable_jobs_expires'][0] : '';
                    $jobs_featured = isset($job_meta[JOBPORTAL_METABOX_PREFIX . 'jobs_featured'][0]) ? $job_meta[JOBPORTAL_METABOX_PREFIX . 'jobs_featured'][0] : '';
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            ...
                            $applicants_count = jobportal_total_applications_jobs_id($id);
                            ?>
                                    ...
                                    switch ($status) {
                                        case 'publish':
                                            if ($paid_submission_type == 'per_package') {
                                                ...
                                                if ($check_package != -1 && $check_package != 0) { ?>
                                                    <li><a class="btn-edit"
                                                            href="<?php echo esc_url($jobs_dashboard_link); ?>?pages=edit&jobs_id=<?php echo esc_attr($id); ?>"><?php esc_html_e('Edit', 'jobportal-framework'); ?></a>
                                                    </li>
                                                <?php }
                                                ...
                                                if ($user_demo == 'yes') { ?>
                                                    ...
                                                    if ($check_package != -1 && $check_package != 0) { ?>
                                                        <li><a class="btn-pause" jobs-id="<?php echo esc_attr($id); ?>"
                                                                href="<?php echo get_the_permalink($id); ?>"><?php esc_html_e('Paused', 'jobportal-framework') ?></a>
                                                        </li>
                                                    <?php }
                                                    ...
                                                    if (($package_unlimited_featured_job == '1' || $package_num_featured_jobs > 0) && $jobs_featured != 1 && $check_package != -1 && $check_package != 0) { ?>
                                                        <li><a class="btn-mark-featured"
                                                                ...
                                                                href="<?php echo get_the_permalink($id); ?>"><?php esc_html_e('Mark featured', 'jobportal-framework') ?></a>
                                                        </li>
                                                    <?php }

                                                    if ($check_package != -1 && $check_package != 0) { ?>
                                                        <li><a class="btn-mark-filled" jobs-id="<?php echo esc_attr($id); ?>"
                                                                href="<?php echo get_the_permalink($id); ?>"><?php esc_html_e('Mark Filled', 'jobportal-framework') ?></a>
                                                        </li>
                                                <?php }
                                                } ?>

                                                <li>
                                                    <a href="<?php echo get_the_permalink($id); ?>"><?php esc_html_e('View detail', 'jobportal-framework') ?></a>
                                                </li>
                                            <?php } else { ?>
                                                <li><a class="btn-edit"
                                                        href="<?php echo esc_url($jobs_dashboard_link); ?>?pages=edit&jobs_id=<?php echo esc_attr($id); ?>"><?php esc_html_e('Edit', 'jobportal-framework'); ?></a>
                                        ...
                                        ?>
                                            ...
                                            <li><a class="btn-show" jobs-id="<?php echo esc_attr($id); ?>"
                                                    href="<?php echo get_the_permalink($id); ?>"><?php esc_html_e('Continue', 'jobportal-framework'); ?></a>
                                            </li>
                                    <?php
                                    } ?>
                                </ul>
                                ...
                                <?php if ($extend_expired_jobs == 1) : ?>
                                    ...
                                    <ul class="action-dropdown">
                                        <li><a class="btn-extend"
                                                jobs-id="<?php echo esc_attr($id); ?>"><?php esc_html_e('Extend', 'jobportal-framework'); ?></a>
                                        </li>
                                    </ul>
                                <?php else: ?>
                                    <a href="#" class="icon-setting btn-add-to-message"
                                        data-text="<?php echo esc_attr__('Jobs has expired so you can not change it', 'jobportal-framework'); ?>"><i
         ...
         * Employer Order
         */
        public function jobportal_employer_order_service()
        {
            ...
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $service_search = isset($_REQUEST['service_search']) ? jobportal_clean(wp_unslash($_REQUEST['service_search'])) : '';
            $service_status = isset($_REQUEST['service_status']) ? jobportal_clean(wp_unslash($_REQUEST['service_status'])) : '';
            $sort_by = isset($_REQUEST['service_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['service_sort_by'])) : '';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $content_refund = isset($_REQUEST['content_refund']) ? jobportal_clean(wp_unslash($_REQUEST['content_refund'])) : '';
            $service_payment = isset($_REQUEST['service_payment']) ? jobportal_clean(wp_unslash($_REQUEST['service_payment'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            if (!empty($item_id)) {
                if ($action_click == 'completed') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_payment_status', 'completed');
                    if (!empty($currency_sign_default)) {
                        $price = get_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_price', true);
                        $author_id = get_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_author_id', true);
                        ...
                        $withdraw_price = get_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_total_price', true);
                        if (empty($withdraw_price)) {
                            $withdraw_price = 0;
                        }
                        $withdraw_price = $withdraw_price + $total_price;
                        update_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_total_price', $withdraw_price);
                    }
                }
                if ($action_click == 'refund') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_payment_status', 'refund');
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_refund_payment_method', $service_payment);
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_refund_content', $content_refund);
                }
            }
            ...
            if ($total_post > 0) {
                while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    <tr>
                        ...
                        <td class="price">
                            <?php echo jobportal_get_format_money($total_price); ?>
                        </td>
                        <td class="start-time">
                                    ...
                                    <?php switch ($status) {
                                        case 'transferring': ?>
                                            <li><a class="btn-completed" order-id="<?php echo esc_attr($order_id); ?>"
                                                    href="#"><?php esc_html_e('Completed', 'jobportal-framework') ?></a>
                                            </li>
                                            <li><a class="btn-order-refund"
                                                    order-id="<?php echo esc_attr($order_id); ?>"
                                                    href="#form-service-order-refund"><?php esc_html_e('Refund', 'jobportal-framework') ?></a>
                                            </li>
                                        <?php break;
                                        case 'pending': ?>
                                            <li><a class="btn-order-refund"
                                        ...
                                        case 'refund': ?>
                                            ...
                                            <?php else: ?>
                                                <li><a class="btn-add-to-message" href="#"
                                                        data-text="<?php echo esc_attr__('Refund reason text is empty'); ?>"><?php esc_html_e('View reason', 'jobportal-framework'); ?></a>
                                                </li>
                                            <?php endif; ?>
                                    <?php break;
                                    } ?>
         ...
         * Candidate Order
         */
        public function jobportal_candidate_order_service()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            if (!empty($item_id)) {
                if ($action_click == 'transferring') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_payment_status', 'transferring');
                }
                if ($action_click == 'canceled') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_order_payment_status', 'canceled');
                }
            }
                                    ...
                                    <?php switch ($status) {
                                        case 'inprogress': ?>
                                            ...
                                            <li><a class="btn-canceled" item-id="<?php echo esc_attr($order_id); ?>"
                                                    href="#"><?php esc_html_e('Canceled', 'jobportal-framework') ?></a></li>
                                        <?php break;
                                        case 'refund': ?>
                                            <?php if (!empty($service_refund_content)) : ?>
                                                <li><a class="btn-view-reason"
         ...
         * Wallet service
         */
        public function jobportal_candidate_wallet_service()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $wallet_method = isset($_REQUEST['wallet_method']) ? jobportal_clean(wp_unslash($_REQUEST['wallet_method'])) : '';
            $wallet_status = isset($_REQUEST['wallet_status']) ? jobportal_clean(wp_unslash($_REQUEST['wallet_status'])) : '';
            $wallet_sort_by = isset($_REQUEST['wallet_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['wallet_sort_by'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            if ($total_post > 0) {
                while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    $payment_method = get_post_meta($withdraw_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_payment_method', true);
                    $price = get_post_meta($withdraw_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_price', true);
                    $status = get_post_meta($withdraw_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_status', true);
                    $request_date = get_the_date(get_option('date_format'));
                    $process_date = get_post_meta($withdraw_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_process_date', true);
                    if (empty($process_date)) {
                        $process_date = '...';
                    } else {
                        $process_date = jobportal_convert_date_format($process_date);
                    }
                    if ($payment_method == 'wire_transfer') {
                        $method = esc_html__('Wire Transfer', 'jobportal-framework');
                    } elseif ($payment_method == 'stripe') {
                        $method = esc_html__('Stripe', 'jobportal-framework');
                    } elseif ($payment_method == 'paypal') {
                        $method = esc_html__('Paypal', 'jobportal-framework');
                    }
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php elseif ($status == 'completed') : ?>
                                <span class="label label-open"><?php esc_html_e('Completed', 'jobportal-framework') ?></span>
                            <?php endif; ?>
                        </td>
                        <td class="price">
                            <?php echo jobportal_get_format_money($price); ?>
                        </td>
                        <td>
         ...
         * Submit withdraw
         */
        public function jobportal_submit_withdraw()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('You must be logged in.', 'jobportal-framework'),
                ));
                wp_die();
            }

            // Security: Verify nonce
            check_ajax_referer('jobportal_withdraw_nonce', 'nonce');

            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => esc_html__('You must be logged in.', 'jobportal-framework'))));
            }

            // Security: Verify nonce
            check_ajax_referer('jobportal_ajax_nonce', 'security');

            $withdraw_price = isset($_REQUEST['withdraw_price']) ? jobportal_clean(wp_unslash($_REQUEST['withdraw_price'])) : '10';
            $withdraw_payment = isset($_REQUEST['withdraw_payment']) ? jobportal_clean(wp_unslash($_REQUEST['withdraw_payment'])) : '1';

            global $current_user;
            $user_id = $current_user->ID;
            $user_name = $current_user->display_name;
            $author_payout_paypal = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_paypal', true);
            $author_payout_stripe = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_stripe', true);
            $author_payout_card_number = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_number', true);
            $author_payout_card_name = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_name', true);
            $author_payout_bank_transfer_name = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_bank_transfer_name', true);
            ...
            $total_price = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_total_price', true);
            ...
            if ($withdraw_price == '') {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Please enter the amount of money', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($withdraw_price > $total_price) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('The amount to withdraw is larger than the available amount', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($withdraw_payment == 'paypal' && empty($author_payout_paypal) && $enable_paypal === '1') {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Please enter full payout information paypal', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($withdraw_payment == 'stripe' && empty($author_payout_stripe && $enable_stripe === '1')) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Please enter full payout information stripe', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($withdraw_payment == 'wire_transfer' && $enable_bank === '1' && (empty($author_payout_card_number) || empty($author_payout_card_name) || empty($author_payout_bank_transfer_name))) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Please enter full payout information wire transfer', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if (!empty($custom_payout)) :
                foreach ($custom_payout as $field) :
                    if (!empty($field['name'])) :
                        $author_payout = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_custom_' . $field['id'], true);
                        $field['name_id'] = str_replace(' ', '-', $field['name']);
                        if ($withdraw_payment == $field['name_id'] && empty($author_payout)) {
                            echo json_encode(array(
                                'success' => false,
                                'message' => sprintf(__('Please enter full payout information %s', 'jobportal-framework'), $field['name'])
                            ));
                            wp_die();
                        }
                    endif;
            ...
            if (isset($post_title)) {
                ...
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'user_total_price_withdraw', $total_price);
                update_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_status', 'pending');
                update_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_user_id', $user_id);
                update_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_payment_method', $withdraw_payment);
                update_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_price', $withdraw_price);
                update_post_meta($post_id, JOBPORTAL_METABOX_PREFIX . 'service_withdraw_total_price', $total_price);
            }
         ...
         * Applicants Filter
         */
        public function jobportal_filter_applicants_dashboard()
        {
            nocache_headers();
            ...
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $applicants_search = isset($_REQUEST['applicants_search']) ? jobportal_clean(wp_unslash($_REQUEST['applicants_search'])) : '';
            $sort_by = isset($_REQUEST['applicants_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['applicants_sort_by'])) : '';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $jobs_id = isset($_REQUEST['applicants_jobs_id']) ? jobportal_clean(wp_unslash($_REQUEST['applicants_jobs_id'])) : '';
            $filter_jobs = isset($_REQUEST['applicants_filter_jobs']) ? jobportal_clean(wp_unslash($_REQUEST['applicants_filter_jobs'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            if (!empty($item_id)) {
                if ($action_click == 'approved') {
                    $email_candidate = get_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'applicants_email', true);
                    $employer_name = get_the_author_meta('display_name', $user_id);
                    $approved_jobs_id = get_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'applicants_jobs_id', true);
                    ...
                    jobportal_send_email($email_candidate, 'mail_approved_applicants', $args_mail);

                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'applicants_status', 'approved');
                }

                if ($action_click == 'rejected') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'applicants_status', 'rejected');
                }
            }
            ...
            if (!empty($jobs_id)) {
                ...
                if (!empty($applicants_search)) {
                    $meta_query[] = array(
                        'key' => JOBPORTAL_METABOX_PREFIX . 'applicants_author',
                ...
                $args_jobs = apply_filters(
                    'jobportal/dashboard/employer/applicants/args_jobs',
                    array(
                        'post_type'           => 'jobs',
                        'post_status'         => 'publish',
                        'ignore_sticky_posts' => 1,
                            ...
                            <div class="list-action">
                                <?php if (!empty(get_the_author())) { ?>
                                    <a href="#" class="action icon-video tooltip btn-reschedule-meetings"
                                        ...
                                        data-title="<?php esc_attr_e('Meetings', 'jobportal-framework') ?>"><i
                                ...
                                <a href="<?php echo esc_url($applicants_cv); ?>" class="action icon-download tooltip"
                                    data-title="<?php esc_attr_e('Download CV', 'jobportal-framework') ?>"><i
                                    ...
                                    <ul class="action-dropdown">
                                        <?php if (empty($applicants_status)) { ?>
                                            <li><a class="btn-approved" applicants-id="<?php echo esc_attr($id); ?>"
                                                    href="#"><?php esc_html_e('Approved', 'jobportal-framework') ?></a></li>
                                            <li><a class="btn-rejected" applicants-id="<?php echo esc_attr($id); ?>"
                                                    href="#"><?php esc_html_e('Rejected', 'jobportal-framework') ?></a></li>
                                            <?php } else {
                                            if ($applicants_status == 'approved') { ?>
                                                <li><a class="btn-rejected"
                                                        applicants-id="<?php echo esc_attr($id); ?>"
                                                        href="#"><?php esc_html_e('Rejected', 'jobportal-framework') ?></a>
                                                </li>
                                            <?php } else { ?>
                                                <li><a class="btn-approved"
                                                        applicants-id="<?php echo esc_attr($id); ?>"
                                                        href="#"><?php esc_html_e('Approved', 'jobportal-framework') ?></a>
                                                </li>
                                        <?php }
                                        } ?>
                                    </ul>
         ...
         * Read mess
         */
        public function jobportal_read_mess_ajax_load()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'read_mess', 'yes');
         ...
         * Realy mess
         */
        public function jobportal_realy_mess_ajax_load()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $title = isset($_REQUEST['title']) ? jobportal_clean(wp_unslash($_REQUEST['title'])) : '';
            $content = isset($_REQUEST['content']) ? jobportal_clean(wp_unslash($_REQUEST['content'])) : '';
            $jobs_id = isset($_REQUEST['jobs_id']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_id'])) : '';
            ...
            jobportal_get_data_ajax_notification($item_id, 'add-message');

            if (isset($messages_id)) {
                update_post_meta($messages_id, JOBPORTAL_METABOX_PREFIX . 'creator_message', $creator_message);
                update_post_meta($messages_id, JOBPORTAL_METABOX_PREFIX . 'recipient_message', $jobs_id);
                update_post_meta($messages_id, JOBPORTAL_METABOX_PREFIX . 'reply_message', $reply_message);
                update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'reply_mess', 'yes');
            }
         ...
         * My Wishlist
         */
        public function jobportal_filter_my_wishlist()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $my_wishlist = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_wishlist', true);
            if (!empty($item_id)) {
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_wishlist', $my_wishlist);
            ...
            if ($total_post > 0) {
                ...
                while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    $jobs_categories = get_the_terms($id, 'jobs-categories');
                    $jobs_location = get_the_terms($id, 'jobs-location');
                    $jobs_select_company = get_post_meta($id, JOBPORTAL_METABOX_PREFIX . 'jobs_select_company');
                    $company_id = isset($jobs_select_company[0]) ? $jobs_select_company[0] : '';
                    $company_logo = get_post_meta($company_id, JOBPORTAL_METABOX_PREFIX . 'company_logo');
                    $public_date = get_the_date('Y-m-d');
                    ?>
                        ...
                        <td class="action-setting jobs-control">
                            ...
                            <ul class="action-dropdown">
                                <li><a class="btn-delete" jobs-id="<?php echo esc_attr($id); ?>"
                                        href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                            </ul>
                        </td>
                    </tr>
                <?php endwhile;
         ...
         * Employer Wishlist
         */
        public function jobportal_filter_employer_wishlist()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $service_wishlist = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'service_wishlist', true);
            if (!empty($item_id)) {
                if ($action_click == 'delete') {
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'service_wishlist', $service_wishlist);
            ...
            if ($total_post > 0) {
                ...
                while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    $current_user_posts = get_posts($args_candidate);
                    $candidate_id = !empty($current_user_posts) ? $current_user_posts[0]->ID : '';
                    $service_featured = intval(get_post_meta($service_id, JOBPORTAL_METABOX_PREFIX . 'service_featured', true));

                    $currency_sign_default = jobportal_get_option('currency_sign_default');
                    $number_start_price = get_post_meta($service_id, JOBPORTAL_METABOX_PREFIX . 'service_price', true);
                    $start_price = jobportal_get_format_money($number_start_price);
                    ?>
                    <tr>
                        <td>
                            <div class="service-header">
                            ...
                            <ul class="action-dropdown">
                                <?php if ($user_demo == 'yes') : ?>
                                    <li><a class="btn-add-to-message"
                                            data-text="<?php echo esc_attr__('This is a "Demo" account so you not cant delete it', 'jobportal-framework'); ?>"
                                            href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                                <?php else : ?>
         ...
         * My Follow
         */
        public function jobportal_filter_my_follow()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $company_search = isset($_REQUEST['company_search']) ? jobportal_clean(wp_unslash($_REQUEST['company_search'])) : '';
            $sort_by = isset($_REQUEST['company_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['company_sort_by'])) : '';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_follow', $my_follow);
            ...
            if ($total_post > 0) {
                ...
                while ($data->have_posts()) : $data->the_post();
                    ...
                    $company_logo = get_post_meta($id, JOBPORTAL_METABOX_PREFIX . 'company_logo');
                    $public_date = get_the_date('Y-m-d');
                ?>
                    <tr>
                        <td>
         ...
         * My Invite
         */
        public function jobportal_filter_my_invite()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $my_invite = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', true);
            if (!empty($item_id)) {
                if ($action_click == 'delete') {
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', $my_invite);
                        ...
                        <td class="action-setting jobs-control">
                            ...
                            <ul class="action-dropdown">
                                <li><a class="btn-apply" href="<?php echo get_the_permalink($id); ?>"
                                        target="_blank"><?php esc_html_e('Apply Now', 'jobportal-framework') ?></a></li>
                                <li><a class="btn-delete" jobs-id="<?php echo esc_attr($id); ?>"
                                        href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                            </ul>
                        </td>
         ...
         * My Review
         */
        public function jobportal_filter_my_review()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
                ...
                ?>
                    <tr>
                        ...
                        <td class="action-setting company-control">
                            ...
                            <ul class="action-dropdown">
                                <li><a class="btn-edit"
                                        href="<?php echo get_the_permalink($company_id) . '/#company-review-details' ?>"><?php esc_html_e('Edit', 'jobportal-framework') ?></a>
                                </li>
         ...
         */
        public function jobportal_filter_company_dashboard()
        {
            nocache_headers();
            ...
            if ($total_post > 0) {
                ...
                while ($data->have_posts()) : $data->the_post();
                    ...
                    $company_categories = get_the_terms($id, 'company-categories');
                    $company_logo = get_post_meta($id, JOBPORTAL_METABOX_PREFIX . 'company_logo');
                    $meta_company = jobportal_posts_company($id);
                    $company_dashboard_link = jobportal_get_permalink('company_dashboard');
                ?>
                    <tr>
                        <td class="info-user">
                            <?php
                        ...
                        <td class="action-setting company-control">
                            ...
                            <ul class="action-dropdown">
                                <li><a class="btn-edit"
                                        href="<?php echo esc_url($company_dashboard_link); ?>?company_id=<?php echo esc_attr($id); ?>"><?php esc_html_e('Edit', 'jobportal-framework'); ?></a>
                                </li>
                                <li><a class="btn-delete" company-id="<?php echo esc_attr($id); ?>"
                                        href="#"><?php esc_html_e('Delete', 'jobportal-framework') ?></a></li>
                            </ul>
         ...
         * Company Related
         */
        public function jobportal_company_related()
        {
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '4';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $company_id = isset($_REQUEST['company_id']) ? jobportal_clean(wp_unslash($_REQUEST['company_id'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
         ...
         */
        public function jobportal_filter_candidates_dashboard()
        {
            nocache_headers();
            ...
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $candidates_search = isset($_REQUEST['candidates_search']) ? jobportal_clean(wp_unslash($_REQUEST['candidates_search'])) : '';
            $sort_by = isset($_REQUEST['candidates_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['candidates_sort_by'])) : '';
            $candidates_id = isset($_REQUEST['candidates_id']) ? jobportal_clean(wp_unslash($_REQUEST['candidates_id'])) : '';
            $follow_company = isset($_REQUEST['follow_company']) ? jobportal_clean(wp_unslash($_REQUEST['follow_company'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $author_id = isset($_REQUEST['author_id']) ? jobportal_clean(wp_unslash($_REQUEST['author_id'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            $my_follow = get_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'my_follow', true);
            if ($action_click == 'delete') {
            ...
            update_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'my_follow', $my_follow);
                        ...
                        <td class="action-setting">
                            <div class="list-action">
                                <a href="<?php echo esc_url(get_the_permalink($id)); ?>" target="_blank"
                                    ...
                                    data-title="<?php echo esc_attr__('View', 'jobportal-framework') ?>"><i
                                        class="far fa-eye"></i></i></a>
                                <a href="mailto: <?php esc_html_e($candidate_email); ?>"
                                    class="action icon-gmail tooltip"
                                    data-title="<?php echo esc_attr__('Send Email', 'jobportal-framework') ?>"><i
                                ...
                                <a href="#" class="action btn-delete tooltip"
                                    ...
                                    data-title="<?php echo esc_attr__('Delete', 'jobportal-framework') ?>"><i
         ...
         */
        public function jobportal_filter_follow_candidate()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '10';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $candidate_search = isset($_REQUEST['candidate_search']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_search'])) : '';
            $sort_by = isset($_REQUEST['candidate_sort_by']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_sort_by'])) : '';
            $item_id = isset($_REQUEST['item_id']) ? jobportal_clean(wp_unslash($_REQUEST['item_id'])) : '';
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'follow_candidate', $follow_candidate);
                            ...
                            <div class="info-details">
                                <h3>
                                    ...
                                    <?php if ($candidate_featured == 1) : ?>
                                        <span class="tooltip"
                                            data-title="<?php echo esc_attr__('Featured', 'jobportal-framework') ?>"><i
         ...
         */
        public function jobportal_filter_invite_candidate()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            $action_click = isset($_REQUEST['action_click']) ? jobportal_clean(wp_unslash($_REQUEST['action_click'])) : '';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            $list_jobs = isset($_REQUEST['list_jobs']) ? jobportal_clean(wp_unslash($_REQUEST['list_jobs'])) : '';
            ...
            $invite_candidate = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'invite_candidate', true);
            ...
            update_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', $my_invite);
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'invite_candidate', $invite_candidate);
         ...
         * My Apply
         */
        public function jobportal_filter_my_apply()
        {
            ...
            wp_get_current_user();
            $user_id = $current_user->ID;
            $jobs_id = get_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'applicants_jobs_id');
            if (!empty($jobs_id)) {
            ...
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_apply', $my_apply);
            ...
            if ($total_post > 0) {
                ...
                while ($data->have_posts()) : $data->the_post();
                    ...
                    $jobs_id = get_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_jobs_id');
                    if (!empty($jobs_id)) {
                        $jobs_id = intval($jobs_id[0]);
                    }
                    global $current_user;
                ...
                ?>
                    <tr>
                        ...
                        <td class="status">
                            <?php echo jobportal_applicants_status($applicants_id) ?>
                        </td>
                        <td class="table-time">
         ...
         * Service Filter
         */
        public function jobportal_filter_my_service()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                wp_die(json_encode(array('success' => false, 'message' => 'Unauthorized')));
            ...
            if (!empty($item_id)) {
                ...
                if ($action_click == 'featured') {
                    update_post_meta($item_id, JOBPORTAL_METABOX_PREFIX . 'service_featured', 1);
                    $number_featured = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'candidate_package_number_service_featured', $user_id);
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'candidate_package_number_service_featured', $number_featured - 1);
                }
            }
                ...
                while ($data->have_posts()) : $data->the_post(); ?>
                    ...
                    <tr>
                        ...
                        <td class="action-setting service-control">
                            ...
                            <ul class="action-dropdown">
                                <?php
                                $service_dashboard_link = jobportal_get_permalink('service_dashboard');
                                $candidate_package_number_service_featured = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'candidate_package_number_service_featured', $user_id);
                                $user_demo = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'user_demo', $user_id);
                                switch ($status) {
                                    case 'publish':
                                ?>
                                        <li><a class="btn-edit"
                                                href="<?php echo esc_url($service_dashboard_link); ?>?service_id=<?php echo esc_attr($service_id); ?>"><?php esc_html_e('Edit', 'jobportal-framework'); ?></a>
                                        </li>
                                        <?php if ($user_demo == 'yes') { ?>
                                            <li><a class="btn-add-to-message" href="#"
                                                    data-text="<?php echo esc_attr__('This is a "Demo" account, so you can not change it', 'jobportal-framework'); ?>"><?php esc_html_e('Paused', 'jobportal-framework'); ?></a>
                                            </li>
                                        <?php } else { ?>
                                            <?php if ($check_candidate_package !== -1 && $check_candidate_package !== 0) { ?>
                                                <li><a class="btn-pause" service-id="<?php echo esc_attr($service_id); ?>"
                                                        href="<?php echo get_the_permalink($service_id); ?>"><?php esc_html_e('Paused', 'jobportal-framework') ?></a>
                                                </li>
                                            <?php }
                                            if ($candidate_package_number_service_featured > 0 && $service_featured !== 1 && $check_candidate_package !== -1 && $check_candidate_package !== 0) { ?>
                                                <li><a class="btn-featured"
                                                        ...
                                                        href="<?php echo get_the_permalink($service_id); ?>"><?php esc_html_e('Featured', 'jobportal-framework') ?></a>
                                                </li>
                                            <?php } ?>
                                        <?php } ?>
                                    <?php
                                    ...
                                    ?>
                                        ...
                                        <?php if ($check_candidate_package !== -1 && $check_candidate_package !== 0) { ?>
                                            <li><a class="btn-show" service-id="<?php echo esc_attr($service_id); ?>"
                                                    href="<?php echo get_the_permalink($service_id); ?>"><?php esc_html_e('Continue', 'jobportal-framework'); ?>
                                                </a>
                                            </li>
                                <?php }
                                        break;
         ...
         * Update profile
         */
        public function jobportal_update_profile_ajax()
        {
            global $current_user;
            wp_get_current_user();
            $user_id = $current_user->ID;
            ...
            check_ajax_referer('jobportal_update_profile_ajax_nonce', 'jobportal_security_update_profile');
            $user_firstname = isset($_POST['user_firstname']) ? jobportal_clean(wp_unslash($_POST['user_firstname'])) : '';
            $user_lastname = isset($_POST['user_lastname']) ? jobportal_clean(wp_unslash($_POST['user_lastname'])) : '';
            $user_email = isset($_POST['user_email']) ? jobportal_clean(wp_unslash($_POST['user_email'])) : '';
            $author_mobile_number = isset($_POST['author_mobile_number']) ? jobportal_clean(wp_unslash($_POST['author_mobile_number'])) : '';
            ...
            if (!empty($_POST['user_firstname']) && !empty($_POST['user_lastname'])) {
                $type_name_candidate = jobportal_get_option('type_name_candidate');
            ...
            if (!empty($_POST['author_mobile_number'])) {
                ...
                if (0 < strlen(trim(preg_replace('/[\s\#0-9_\-\+\/\(\)\.]/', '', $author_mobile_number)))) {
                    echo json_encode(array(
                        'success' => false,
                        'message' => esc_html__('The phone number you entered is not valid. Please try again.', 'jobportal-framework')
                    ));
                    wp_die();
                }
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_mobile_number', $author_mobile_number);
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_mobile_number');
            }

            // Update Phone Code
            if (!empty($_POST['phone_code'])) {
                $phone_code = sanitize_text_field(wp_unslash($_POST['phone_code']));
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'phone_code', $phone_code);
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'phone_code');
            }
            ...
            if (!empty($_POST['user_email'])) {
                ...
                if (!$user_email) {
                    echo json_encode(array(
                        'success' => false,
                        'message' => esc_html__('The Email you entered is not valid. Please try again.', 'jobportal-framework')
                    ));
                    wp_die();
                } else {
                    ...
                    if ($email_exists) {
                        if ($email_exists != $user_id) {
                            echo json_encode(array(
                                'success' => false,
                                'message' => esc_html__('This Email is already used by another user. Please try a different one.', 'jobportal-framework')
                            ));
                            wp_die();
                        }
                    } else {
            ...
            echo json_encode(array(
                'success' => true,
                'message' => esc_html__('Profile updated', 'jobportal-framework')
            ));
            wp_die();
        }
         ...
         * Change password
         */
        public function jobportal_change_password_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'message' => esc_html__('You must be logged in.', 'jobportal-framework')));
            ...
            check_ajax_referer('jobportal_change_password_ajax_nonce', 'jobportal_security_change_password');
            global $current_user;
            wp_get_current_user();
            $user_id = $current_user->ID;

            $oldpass = isset($_POST['oldpass']) ? jobportal_clean(wp_unslash($_POST['oldpass'])) : '';
            $newpass = isset($_POST['newpass']) ? jobportal_clean(wp_unslash($_POST['newpass'])) : '';
            $confirmpass = isset($_POST['confirmpass']) ? jobportal_clean(wp_slash($_POST['confirmpass'])) : '';


            if ($newpass == '' || $confirmpass == '') {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('New password or confirm password is blank', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($newpass !== $confirmpass) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Passwords do not match', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if (strlen($newpass) < 6 || strlen($confirmpass) < 6) {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Please set a password with a length of more than 6 characters', 'jobportal-framework')
                ));
                wp_die();
            }
            ...
            if ($user && wp_check_password($oldpass, $user->data->user_pass, $user_id)) {
                ...
                echo json_encode(array(
                    'success' => true,
                    'message' => esc_html__('Change password successfully!', 'jobportal-framework')
                ));
            } else {
                echo json_encode(array(
                    'success' => false,
                    'message' => esc_html__('Old password is not correct', 'jobportal-framework')
                ));
            }
            wp_die();
        }
         ...
         * Update payout
         */
        public function jobportal_update_payout_ajax()
        {
            $payout_paypal = isset($_REQUEST['payout_paypal']) ? jobportal_clean(wp_unslash($_REQUEST['payout_paypal'])) : '';
            $payout_stripe = isset($_REQUEST['payout_stripe']) ? jobportal_clean(wp_unslash($_REQUEST['payout_stripe'])) : '';
            $payout_card_number = isset($_REQUEST['payout_card_number']) ? jobportal_clean(wp_unslash($_REQUEST['payout_card_number'])) : '';
            $payout_card_name = isset($_REQUEST['payout_card_name']) ? jobportal_clean(wp_unslash($_REQUEST['payout_card_name'])) : '';
            $payout_bank_transfer_name = isset($_REQUEST['payout_bank_transfer_name']) ? jobportal_clean(wp_unslash($_REQUEST['payout_bank_transfer_name'])) : '';
            $custom_field = isset($_REQUEST['custom_field']) ? jobportal_clean(wp_unslash($_REQUEST['custom_field'])) : '';
            $enable_paypal = jobportal_get_option('enable_payout_paypal');
            $enable_stripe = jobportal_get_option('enable_payout_stripe');
            $enable_bank = jobportal_get_option('enable_payout_bank_transfer');
            ...
            check_ajax_referer('jobportal_update_payout_ajax_nonce', 'jobportal_security_update_payout');

            if (!empty($payout_paypal)) {
                if ($enable_paypal === '1') {
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_paypal', $payout_paypal);
                }
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_paypal');
            }

            if (!empty($payout_stripe)) {
                if ($enable_stripe === '1') {
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_stripe', $payout_stripe);
                }
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_stripe');
            }

            if (!empty($payout_card_number)) {
                if ($enable_bank === '1') {
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_number', $payout_card_number);
                }
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_number');
            }

            if (!empty($payout_card_name)) {
                if ($enable_bank === '1') {
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_name', $payout_card_name);
                }
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_card_name');
            }

            if (!empty($payout_bank_transfer_name)) {
                if ($enable_bank === '1') {
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_bank_transfer_name', $payout_bank_transfer_name);
                }
            } else {
                delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_bank_transfer_name');
            }

            if (!empty($custom_field)) :
                foreach ($custom_field as $key => $field) :
                    if (!empty($field)) {
                        update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_custom_' . $key, $field);
                    } else {
                        delete_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'author_payout_custom_' . $key);
                    }
                endforeach;
            endif;
            ...
            echo json_encode(array(
                'success' => true,
                'message' => esc_html__('You have successfully submitted your information', 'jobportal-framework')
            ));
         ...
         * Chart Jobs
         */
        public function jobportal_chart_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'message' => esc_html__('You must be logged in.', 'jobportal-framework')));
            ...
            check_ajax_referer('jobportal_chart_nonce', 'security');

            $number_days = isset($_REQUEST['number_days']) ? jobportal_clean(wp_unslash($_REQUEST['number_days'])) : '7';
            $jobs_id = isset($_REQUEST['jobs_id']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_id'])) : '';
            ...
            $values_view = jobportal_view_jobs_date($jobs_id, $number_days);
            $values_apply = jobportal_total_jobs_apply($jobs_id, $number_days);

            $return = array(
                'labels' => $labels,
                'values_view' => $values_view,
                'values_apply' => $values_apply,
                'label_view' => esc_html__('Page View', 'jobportal-framework'),
                'label_apply' => esc_html__('Apply Click', 'jobportal-framework'),
            );
         ...
         * Chart Employer
         */
        public function jobportal_chart_employer_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'message' => esc_html__('You must be logged in.', 'jobportal-framework')));
            ...
            $views_values = jobportal_total_view_jobs($number_days);
         ...
         * Chart Candidate
         */
        public function jobportal_chart_candidate_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'message' => esc_html__('You must be logged in.', 'jobportal-framework')));
            ...
            $views_values = jobportal_total_view_candidate($number_days);
        ...
        {
            if (!(defined('JOBPORTAL_DISABLE_APPLY_NONCE') && JOBPORTAL_DISABLE_APPLY_NONCE)) {
                $nonce = isset($_REQUEST['security']) ? wp_unslash($_REQUEST['security']) : '';
                if (empty($nonce) || !wp_verify_nonce($nonce, 'job_apply_nonce')) {
                    wp_send_json_error(array(
                        'added' => false,
                        'success' => false,
                        'message' => esc_html__('Invalid or expired nonce', 'jobportal-framework')
                    ), 403);
                }
            }
            ...
            if (empty($jobs_id) || get_post_status($jobs_id) === false) {
                wp_send_json_error(array(
                    'added' => false,
                    'success' => false,
                    'message' => esc_html__('Invalid job', 'jobportal-framework')
                ), 404);
            }
            ...
            if ($enable_apply_login === '1' && !$is_logged_in) {
                wp_send_json_error(array(
                    'added' => false,
                    'success' => false,
                    'message' => esc_html__('Login required to apply', 'jobportal-framework')
                ), 401);
            }
            ...
            $candidate_current_position = isset($_REQUEST['candidate_current_position']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_current_position'])) : '';
            $candidate_categories = isset($_REQUEST['candidate_categories']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_categories'])) : '';
            $candidate_dob = isset($_REQUEST['candidate_dob']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_dob'])) : '';
            $candidate_age = isset($_REQUEST['candidate_age']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_age'])) : '';
            $candidate_gender = isset($_REQUEST['candidate_gender']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_gender'])) : '';
            $candidate_languages = isset($_REQUEST['candidate_languages']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_languages'])) : '';
            $candidate_qualification = isset($_REQUEST['candidate_qualification']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_qualification'])) : '';
            $candidate_yoe = isset($_REQUEST['candidate_yoe']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_yoe'])) : '';
            ...
            $user_id = $current_user->ID;
            $user_name = $current_user->display_name;
            $enable_required_upload_cv = jobportal_get_option('enable_required_upload_cv');
            ...
            if ($is_logged_in) {
                ...
                if (empty($candidate_id)) {
                    wp_send_json_error(array(
                        'added' => false,
                        'success' => false,
                        'message' => esc_html__('Candidate profile not found', 'jobportal-framework')
                    ), 403);
                }
                ...
                if ($candidate_author !== (int) $user_id) {
                    wp_send_json_error(array(
                        'added' => false,
                        'success' => false,
                        'message' => esc_html__('Not allowed to apply as this candidate', 'jobportal-framework')
                    ), 403);
                }
                if (empty($email)) {
            ...
            if ($cv_url_invalid) {
                wp_send_json_error(array(
                    'added' => false,
                    'success' => false,
                    'message' => esc_html__('Invalid CV URL.', 'jobportal-framework')
                ), 400);
            }
            ...
            if ($type_apply == 'email') {
                if ($message === '') {
                    $missing_fields[] = esc_html__('message', 'jobportal-framework');
                }
                if ($email === '' || !is_email($email)) {
                    $missing_fields[] = esc_html__('valid email', 'jobportal-framework');
                }
                if ($phone === '') {
                    $missing_fields[] = esc_html__('phone', 'jobportal-framework');
                }
                if ($enable_required_upload_cv != '0' && $cv_url === '') {
                    $missing_fields[] = esc_html__('CV', 'jobportal-framework');
                }
            } else {
                if ($message === '') {
                    $missing_fields[] = esc_html__('message', 'jobportal-framework');
            ...
            if ($type_apply === 'email' && is_array($show_field_jobs_apply) && !empty($show_field_jobs_apply)) {
                if (in_array('position', $show_field_jobs_apply) && empty($candidate_current_position)) {
                    $missing_fields[] = esc_html__('current position', 'jobportal-framework');
                }
                if (in_array('categories', $show_field_jobs_apply) && empty($candidate_categories)) {
                    $missing_fields[] = esc_html__('categories', 'jobportal-framework');
                }
                if (in_array('date', $show_field_jobs_apply)) {
                    if (empty($candidate_dob)) {
                        $missing_fields[] = esc_html__('date of birth', 'jobportal-framework');
                        ...
                        if ($dob_timestamp !== false && $dob_timestamp > $today_timestamp) {
                            wp_send_json_error(array(
                                'added' => false,
                                'success' => false,
                                'message' => esc_html__('Date of birth cannot be in the future. Please select a past or today\'s date.', 'jobportal-framework')
                            ), 400);
                        }
                    }
                }
                if (in_array('age', $show_field_jobs_apply) && empty($candidate_age)) {
                    $missing_fields[] = esc_html__('age', 'jobportal-framework');
                }
                if (in_array('gender', $show_field_jobs_apply) && empty($candidate_gender)) {
                    $missing_fields[] = esc_html__('gender', 'jobportal-framework');
                }
                if (in_array('languages', $show_field_jobs_apply) && empty($candidate_languages)) {
                    $missing_fields[] = esc_html__('languages', 'jobportal-framework');
                }
                if (in_array('qualification', $show_field_jobs_apply) && empty($candidate_qualification)) {
                    $missing_fields[] = esc_html__('qualification', 'jobportal-framework');
                }
                if (in_array('experience', $show_field_jobs_apply) && empty($candidate_yoe)) {
                    $missing_fields[] = esc_html__('experience', 'jobportal-framework');
                }
            }
            ...
            if (!$user_employer || !isset($user_employer->user_email)) {
                wp_send_json_error(array(
                    'added' => false,
                    'success' => false,
                    'message' => esc_html__('Invalid job posting. Please contact support.', 'jobportal-framework')
                ), 400);
            }

            $user_employer_email = $user_employer->user_email;
            $jobs_apply_email = !empty(get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_apply_email')) ? get_post_meta($jobs_id, JOBPORTAL_METABOX_PREFIX . 'jobs_apply_email')[0] : '';
            ...
            if (!empty($missing_fields)) {
                ...
                wp_send_json_error(array(
                    'added' => false,
                    'success' => false,
                    'message' => sprintf(esc_html__('Please fill required fields: %s', 'jobportal-framework'), $missing_list)
                ), 400);
            } else {
                ...
                if (isset($jobs_id)) {
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_jobs_id', $jobs_id);
                }

                if (isset($date_applicants)) {
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_date', $date_applicants);
                }

                if ($type_apply == 'email') {
                    if (isset($phone)) {
                        update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_phone', $phone);
                    }

                    if (isset($email)) {
                        update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_email', $email);
                    }
                }

                if (isset($message)) {
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_message', $message);
                }

                if (isset($cv_url)) {
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_cv', $cv_url);
                }

                if (isset($type_apply)) {
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_type', $type_apply);
                }
                ...
                if ($is_logged_in) {
                    ...
                    if ($user_id > 0) {
                        update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_author', $user_name);
                    }

                    jobportal_get_data_ajax_notification($jobs_id, 'add-apply');

                    jobportal_number_candidate_package_ajax('jobs_apply');
                    ...
                    $jobs_dashboard_url = jobportal_get_permalink('jobs_dashboard');
                    $employer_applicants_url = $jobs_dashboard_url
                        ...
                        : home_url('/');
                    $job_apply_link_html = '<a href="' . esc_url($employer_applicants_url) . '">' . esc_html__('View application', 'jobportal-framework') . '</a>';
                    ...
                    if ($type_apply == 'email' || $type_apply == 'internal') {
                        jobportal_send_email($email, 'mail_candidate_apply', $args_mail);
                        jobportal_send_email($user_employer_email, 'mail_employer_apply', $args_mail);
                    }
                } else {
                    $user_name_nlogin = esc_html__('User not logged in', 'jobportal-framework');
                    update_post_meta($applicants_id, JOBPORTAL_METABOX_PREFIX . 'applicants_author', $user_name_nlogin);

                    // For non-logged-in users, use "Unregistered user" as applicant name
                    $applicant_name_nlogin = esc_html__('Unregistered user', 'jobportal-framework');
                    ...
                    if ($type_apply == 'email' || $type_apply == 'internal') {
                        jobportal_send_email($user_employer_email, 'mail_employer_apply', $args_mail);
                        jobportal_send_email($email, 'mail_candidate_apply_nlogin', $args_mail_nlogin);
                    }
                }
                ...
                echo json_encode(array(
                    'added' => true,
                    'success' => true,
                    'message' => esc_html__('You have applied successfully', 'jobportal-framework')
                ));
            }
         ...
         * Wishlist Jobs
         */
        public function jobportal_add_to_wishlist()
        {
            // Security: Verify nonce
            check_ajax_referer('jobportal_wishlist_nonce', 'nonce');
            ...
            if ($user_id > 0) {
                ...
                jobportal_number_candidate_package_ajax('jobs_wishlist');
                ...
                $show_package_jobs_wishlist = get_post_meta($candidate_package_id, JOBPORTAL_METABOX_PREFIX . 'show_package_jobs_wishlist', true);
                $candidate_package_number_jobs_wishlist = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'candidate_package_number_jobs_wishlist', true);
                $show_option_jobs_wishlist = jobportal_get_option('enable_candidate_package_jobs_wishlist');
                ...
                if ($show_option_jobs_wishlist == 1 && $show_package_jobs_wishlist == '1' && ($candidate_package_number_jobs_wishlist < 0 || $check_package == false)) {
                    ...
                    $my_favorites = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_wishlist', true);
                    ...
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_wishlist', $my_favorites);

                    if ($added) {
                        jobportal_get_data_ajax_notification($jobs_id, 'add-wishlist');
                        $ajax_response = array('added' => true, 'message' => esc_html__('Added', 'jobportal-framework'));
                    }
                    if ($removed) {
                        $ajax_response = array(
                            'added' => false,
                            'message' => esc_html__('Removed', 'jobportal-framework')
                        );
                    }
                }
            } else {
                $ajax_response = array(
                    'added' => false,
                    'message' => esc_html__('You are not login', 'jobportal-framework')
                );
            }
         ...
         * Wishlist Service
         */
        public function jobportal_service_wishlist()
        {
            // Security: Verify nonce
            check_ajax_referer('jobportal_service_wishlist_nonce', 'nonce');
            ...
            if ($user_id > 0) {
                ...
                if ($removed) {
                    $ajax_response = array('added' => false, 'message' => esc_html__('Removed', 'jobportal-framework'));
                }
            } else {
                $ajax_response = array(
                    'added' => false,
         ...
         * Service Addons
         */
        public function jobportal_service_addons()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array(
            ...
            // Security: Verify nonce
            check_ajax_referer('jobportal_service_addons_nonce', 'nonce');

            $service_id = isset($_REQUEST['service_id']) ? jobportal_clean(wp_unslash($_REQUEST['service_id'])) : '';
            $price_total = isset($_REQUEST['price_total']) ? jobportal_clean(wp_unslash($_REQUEST['price_total'])) : '';
            $price_addons = isset($_REQUEST['price_addons']) ? jobportal_clean(wp_unslash($_REQUEST['price_addons'])) : '';

            global $current_user;
            $user_id = $current_user->ID;

            if (!empty($service_id)) {
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_addons_service_id', $service_id);
            }
            ...
            if ($price_total > 0) {
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_addons_price_total', $price_total);
            }

            if ($price_addons > 0) {
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_addons_price_addons', $price_addons);
            } else {
                update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_addons_price_addons', 0);
            }
         ...
         * Follow Company
         */
        public function jobportal_add_to_follow()
        {
            // Security: Verify nonce
            check_ajax_referer('jobportal_follow_nonce', 'nonce');
            ...
            if ($user_id > 0) {
                ...
                jobportal_number_candidate_package_ajax('company_follow');
                $candidate_package_id = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'candidate_package_id', $user_id);
                $check_package = jobportal_check_candidate_package();
                $show_package_company_candidate_follow = get_post_meta($candidate_package_id, JOBPORTAL_METABOX_PREFIX . 'show_package_company_candidate_follow', true);
                ...
                if ($show_package_company_candidate_follow == '1' && ($candidate_package_number_company_follow < 0 || $check_package == false)) {
                    ...
                    if ($added) {
                        jobportal_get_data_ajax_notification($company_id, 'add-follow-company');
                        $ajax_response = array('added' => true, 'message' => esc_html__('Added', 'jobportal-framework'));
                    }
                    if ($removed) {
                        $ajax_response = array(
         ...
         * Follow Company
         */
        public function jobportal_add_to_invite()
        {
            // Security: Verify nonce
            check_ajax_referer('jobportal_invite_nonce', 'nonce');
            ...
            if (!$candidate_id || get_post_type($candidate_id) !== 'candidate') {
                wp_send_json_error(array(
                    'success' => false,
                    'message' => esc_html__('Invalid candidate', 'jobportal-framework')
                ));
            }
            ...
            $employer_invite = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', true);
            if (!is_array($employer_invite)) {
                $employer_invite = array();
            }

            // Fetch Meta for Candidate (for the badge logic)
            $candidate_invite = get_user_meta($candidate_user_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', true);
            ...
            if (!empty($jobs_id)) {
                ...
                jobportal_get_data_ajax_notification($candidate_id, 'add-invite');
            } else {
                 if (!empty($list_jobs)) {
            ...
            if (!empty($candidate_email)) {
                jobportal_send_email($candidate_email, 'mail_job_invite', $args);
            } else {
                wp_send_json_error(array(
                    'success' => false,
                    'message' => esc_html__('Candidate email not found', 'jobportal-framework')
                ));
            }
            ...
            update_user_meta($author_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', $employer_invite);
            update_user_meta($candidate_user_id, JOBPORTAL_METABOX_PREFIX . 'my_invite', $candidate_invite);
            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'invite_candidate', $invite_candidate);
         ...
         * Follow Candidate
         */
        public function jobportal_add_to_follow_candidate()
        {
            // Security: Verify nonce
            check_ajax_referer('jobportal_follow_candidate_nonce', 'nonce');
            ...
            if ($user_id > 0) {
                ...
                if ($paid_submission_type == 'per_package' && $enable_company_package_follow === '1' && $show_package_follow === '1' && ($company_package_number_candidate_follow <= 0 || ($check_package == -1 || $check_package == 0))) {
                    ...
                    if ($added) {
                        jobportal_get_data_ajax_notification($candidate_id, 'add-follow-candidate');
                        if (is_numeric($company_package_number_candidate_follow) && $company_package_number_candidate_follow - 1 >= 0) {
                            update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_number_candidate_follow', $company_package_number_candidate_follow - 1);
                        }
                        $ajax_response = array('added' => true, 'message' => esc_html__('Added', 'jobportal-framework'));
                    }
                    if ($removed) {
         ...
         */
        public function jobportal_candidate_download_cv()
        {
            check_ajax_referer('jobportal_download_cv_candidate_nonce', 'nonce');
            global $current_user;
            wp_get_current_user();
            $user_id = apply_filters('jobportal_modify_user_id', $current_user->ID);

            if ($user_id > 0) {
                $download_cv_candidate = get_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'download_cv_candidate', true);
                $paid_submission_type = jobportal_get_option('paid_submission_type');
                $package_id = get_the_author_meta(JOBPORTAL_METABOX_PREFIX . 'package_id', $user_id);
                $jobportal_profile = new JobPortal_Profile();
                $check_package = $jobportal_profile->user_package_available($user_id);
                ...
                if ($download_cv_candidate < 1 && $paid_submission_type == 'per_package' && $enable_company_package_download_cv === '1' && $show_package_download_cv === '1' && ($company_package_number_download_cv <= 0 || ($check_package == -1 || $check_package == 0))) {
                    ...
                    update_user_meta($user_id, JOBPORTAL_METABOX_PREFIX . 'package_number_download_cv', $company_package_number_download_cv - 1);
         ...
         * upload thumbnail
         */
        public function jobportal_thumbnail_upload_ajax()
        {
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_thumbnail_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
                echo json_encode($ajax_response);
                wp_die();
            }
            ...
            $submitted_file = $_FILES['jobportal_thumbnail_upload_file']; // WPCS: sanitization ok, input var ok.
            ...
            if (isset($uploaded_image['file'])) {
                ...
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Image upload failed!', 'jobportal-framework')
                );
                echo json_encode($ajax_response);
                wp_die();
            }
         ...
         */
        public function jobportal_thumbnail_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_POST['removeNonce']) ? jobportal_clean(wp_unslash($_POST['removeNonce'])) : '';
            $user_id = isset($_POST['user_id']) ? jobportal_clean(wp_unslash($_POST['user_id'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_thumbnail_allow_upload')) {
                $json_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check fails', 'jobportal-framework')
                );
            ...
            if ($user_id) {
                update_user_meta($user_id, 'author_avatar_image_url', JOBPORTAL_THEME_URI . '/assets/images/default-user-image.png');
            }
            $ajax_response = array(
                'success' => $success,
         ...
         * upload avatar
         */
        public function jobportal_avatar_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_avatar_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_avatar_upload_file']; // WPCS: sanitization ok, input var ok.
        ...
        public function jobportal_verify_id_before_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_verify_id_before_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_verify_id_before_upload_file']; // WPCS: sanitization ok, input var ok.
        ...
        public function jobportal_verify_id_after_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_verify_id_after_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_verify_id_after_upload_file']; // WPCS: sanitization ok, input var ok.
        ...
        public function jobportal_verify_id_selfie_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_verify_id_selfie_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_verify_id_selfie_upload_file']; // WPCS: sanitization ok, input var ok.
         ...
         * Remove avatar img
         */
        public function jobportal_avatar_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
        ...
        public function jobportal_verify_id_before_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            if ($user_id) {
                update_user_meta($user_id, 'author_verify_id_before_image_url', JOBPORTAL_THEME_URI . '/assets/images/default-user-image.png');
            }
            $ajax_response = array(
                'success' => $success,
        ...
        public function jobportal_verify_id_after_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            if ($user_id) {
                update_user_meta($user_id, 'author_verify_id_after_image_url', JOBPORTAL_THEME_URI . '/assets/images/default-user-image.png');
            }
            $ajax_response = array(
                'success' => $success,
        ...
        public function jobportal_verify_id_selfie_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            if ($user_id) {
                update_user_meta($user_id, 'author_verify_id_selfie_image_url', JOBPORTAL_THEME_URI . '/assets/images/default-user-image.png');
            }
            $ajax_response = array(
                'success' => $success,
         ...
         * upload custom_image
         */
        public function jobportal_custom_image_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            $custom_image_id = isset($_REQUEST['custom_image_id']) ? jobportal_clean(wp_unslash($_REQUEST['custom_image_id'])) : '';

            if (!wp_verify_nonce($nonce, 'jobportal_custom_image_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_custom_image_upload_file_' . $custom_image_id]; // WPCS: sanitization ok, input var ok.
         ...
         */
        public function jobportal_custom_image_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
         ...
         * upload gallery
         */
        public function jobportal_gallery_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            if (!wp_verify_nonce($nonce, 'jobportal_gallery_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_gallery_upload_file']; // WPCS: sanitization ok, input var ok.
         ...
         * Remove gallery img
         */
        public function jobportal_gallery_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
         ...
         */
        public function jobportal_candidate_print_ajax()
        {
            // Security: Verify nonce
            if (! isset($_REQUEST['nonce']) || ! wp_verify_nonce($_REQUEST['nonce'], 'jobportal_candidate_print_nonce')) {
                wp_die(esc_html__('Security check failed', 'jobportal-framework'));
            }
            $candidate_id = isset($_REQUEST['candidate_id']) ? jobportal_clean(wp_unslash($_REQUEST['candidate_id'])) : '';
            if (empty($candidate_id)) {
                return;
            }
            $isRTL = 'false';
            ...
            jobportal_get_template('candidate/print.php', array('candidate_id' => $candidate_id, 'isRTL' => $isRTL));
            wp_die();
        }
         ...
         * Select Country
         */
        public function jobportal_select_country()
        {
            $country = isset($_REQUEST['country']) ? jobportal_clean(wp_unslash($_REQUEST['country'])) : '';
            $post_type = isset($_REQUEST['post_type']) ? jobportal_clean(wp_unslash($_REQUEST['post_type'])) : '';
         ...
         * Select State
         */
        public function jobportal_select_state()
        {
            $state = isset($_REQUEST['state']) ? jobportal_clean(wp_unslash($_REQUEST['state'])) : '';
            $post_type = isset($_REQUEST['post_type']) ? jobportal_clean(wp_unslash($_REQUEST['post_type'])) : '';
         ...
         * Elementor
         */
        public function jobportal_el_jobs_pagination_ajax()
        {
            $item_amount = isset($_REQUEST['item_amount']) ? jobportal_clean(wp_unslash($_REQUEST['item_amount'])) : '4';
            $paged = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '1';
            $page = isset($_REQUEST['paged']) ? jobportal_clean(wp_unslash($_REQUEST['paged'])) : '';
            $layout = isset($_REQUEST['layout']) ? jobportal_clean(wp_unslash($_REQUEST['layout'])) : '';
            $type_pagination = isset($_REQUEST['type_pagination']) ? jobportal_clean(wp_unslash($_REQUEST['type_pagination'])) : '';
            $include_ids = isset($_REQUEST['include_ids']) ? jobportal_clean(wp_unslash($_REQUEST['include_ids'])) : '';
            $type_query = isset($_REQUEST['type_query']) ? jobportal_clean(wp_unslash($_REQUEST['type_query'])) : '';
            $orderby = isset($_REQUEST['orderby']) ? jobportal_clean(wp_unslash($_REQUEST['orderby'])) : '';
            $jobs_categories = isset($_REQUEST['jobs_categories']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_categories'])) : '';
            $jobs_skills = isset($_REQUEST['jobs_skills']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_skills'])) : '';
            $jobs_type = isset($_REQUEST['jobs_type']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_type'])) : '';
            $jobs_location = isset($_REQUEST['jobs_location']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_location'])) : '';
            $jobs_career = isset($_REQUEST['jobs_career']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_career'])) : '';
            $jobs_experience = isset($_REQUEST['jobs_experience']) ? jobportal_clean(wp_unslash($_REQUEST['jobs_experience'])) : '';
...
<?php }
        ...
        public function jobportal_apply_package_coupon()
        {
            $jobportal_package_id = isset($_REQUEST['jobportal_package_id']) ? jobportal_clean(wp_unslash($_REQUEST['jobportal_package_id'])) : '';
            $jobportal_coupon = isset($_REQUEST['jobportal_coupon']) ? jobportal_clean(wp_unslash($_REQUEST['jobportal_coupon'])) : '';
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';

            // Check nonce
            if (!wp_verify_nonce($nonce, 'jobportal_apply_package_coupon')) {
                echo json_encode(array('success' => false, 'message' => __('Nonce is wrong', 'jobportal-framework')));
                wp_die();
            }

            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'message' => __('You must be logged in.', 'jobportal-framework')));
                wp_die();
            }

            if (empty($jobportal_package_id)) {
                echo json_encode(array('success' => false, 'message' => __('Package is empty', 'jobportal-framework')));
                wp_die();
            }

            $package = get_post($jobportal_package_id);
            ...
            if ($post_type == 'package') {
                ...
                $package_price = get_post_meta($package_id, JOBPORTAL_METABOX_PREFIX . 'candidate_package_price', true);
            }


            if (empty($jobportal_coupon)) {
                echo json_encode(array('success' => false, 'package_price' => jobportal_get_format_money($package_price, '', null, true), 'message' => __('Coupon is empty', 'jobportal-framework')));
                wp_die();
            }
            ...
            $args = [
                ...
                'title'          => $jobportal_coupon, // Match the post title
                'meta_query'     => [
                    [
                        'key'     => JOBPORTAL_METABOX_PREFIX . 'package_selected', // The meta key you're looking for
            ...
            if (is_wp_error($query)) {
                echo json_encode(array('success' => false, 'package_price' => jobportal_get_format_money($package_price, '', null, true), 'message' => __('Coupon not available.', 'jobportal-framework')));
                wp_die();
            }
            ...
            if ($query->have_posts()) {
                while ($query->have_posts()) {
                    $query->the_post();
                    $coupon_type = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_type', true);
                    $coupon_limit = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_limit', true);
                    $coupon_used = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_used', true) ? get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_used', true) : 0;
                    $coupon_uses = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_uses', true);
                    $coupon_date = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'coupon_date', true);
                    $amount = get_post_meta(get_the_ID(), JOBPORTAL_METABOX_PREFIX . 'amount', true);

                    if ($coupon_limit == 'uses' && intval($coupon_used) >= intval($coupon_uses)) {
                        echo json_encode(array('success' => false, 'package_price' => jobportal_get_format_money($package_price, '', null, true), 'message' => __('Coupon limit reached.', 'jobportal-framework')));
                        wp_die();
                    }

                    if ($coupon_limit == 'date' && $coupon_date < date('Y-m-d')) {
                        echo json_encode(array('success' => false, 'package_price' => jobportal_get_format_money($package_price, '', null, true), 'message' => __('Coupon expired.', 'jobportal-framework')));
                        wp_die();
                    }
                    ...
                    update_user_meta(get_current_user_id(), JOBPORTAL_METABOX_PREFIX . 'package_coupon', $amount);
                    update_user_meta(get_current_user_id(), JOBPORTAL_METABOX_PREFIX . 'package_coupon_id', get_the_ID());
                }
            }

            wp_reset_postdata(); // Reset global post object
            $package_price_with_coupon = jobportal_get_format_money(($package_price - intval($amount)), '', null, true);
            $package_price_format = jobportal_get_format_money($package_price, '', null, true);
            ...
            if ($amount > 0) {
                ...
                echo json_encode(
                    array(
                        ...
                        'stripe_price' => $stripe_price,
                        'package_price_with_coupon' => $package_price_with_coupon,
                        'message' => __('The coupon does not exist or is not applicable when purchasing this package.', 'jobportal-framework')
                    )
                );
            }
         ...
         * upload mess_image
         */
        public function jobportal_mess_image_upload_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
            ...
            $nonce = isset($_REQUEST['nonce']) ? jobportal_clean(wp_unslash($_REQUEST['nonce'])) : '';
            $mess_image_id = isset($_REQUEST['mess_image_id']) ? jobportal_clean(wp_unslash($_REQUEST['mess_image_id'])) : '';

            if (!wp_verify_nonce($nonce, 'jobportal_mess_image_allow_upload')) {
                $ajax_response = array(
                    'success' => false,
                    'reason' => esc_html__('Security check failed!', 'jobportal-framework')
                );
            ...
            $submitted_file = $_FILES['jobportal_mess_image_upload_file_' . $mess_image_id]; // WPCS: sanitization ok, input var ok.
         ...
         */
        public function jobportal_mess_image_remove_ajax()
        {
            // Security: Check if user is logged in
            if (!is_user_logged_in()) {
                echo json_encode(array('success' => false, 'reason' => 'Unauthorized'));
        ...
        * Ajax select2
        */
        public function jobportal_ajax_select2()
        {
        ...
        public function jobportal_ajax_ui()
        {
            $q = isset($_GET['q']) ? wp_unslash($_GET['q']) : '';
            $page = isset($_GET['page']) ? intval($_GET['page']) : 1;
            $taxonomy = isset($_GET['taxonomy']) ? sanitize_text_field($_GET['taxonomy']) : '';
         ...
         */
        public function jobportal_check_old_package_before_activate()
        {
            check_ajax_referer('jobportal_candidate_package_ajax_nonce', 'nonce');
            ...
            if (!$user_id) {
                wp_send_json_error(array('message' => esc_html__('User not logged in', 'jobportal-framework')));
                wp_die();
            }

            // Use transient cache for 30 seconds to avoid repeated queries
            $cache_key = 'jobportal_active_package_info_' . $user_id;
            ...
            $active_package_info = $jobportal_candidate_package->get_active_package_info($user_id);
         ...
         */
        public function jobportal_check_old_employer_package_before_activate()
        {
            check_ajax_referer('jobportal_employer_package_ajax_nonce', 'nonce');
            ...
            // Use transient cache for 30 seconds to avoid repeated queries
            $cache_key = 'jobportal_active_employer_package_info_' . $user_id;
            $cached_result = get_transient($cache_key);
            ...
            $active_package_info = $jobportal_package->get_active_package_info($user_id);
