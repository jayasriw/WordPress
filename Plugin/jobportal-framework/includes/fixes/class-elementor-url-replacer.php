...
class JobPortal_Elementor_URL_Replacer
{
    ...
    public function __construct()
    {
        ...
        // Add AJAX handler
        add_action('wp_ajax_jobportal_elementor_replace_urls', [$this, 'ajax_replace_urls']);
    ...
    public function add_admin_menu()
    {
        ...
        add_submenu_page(
            ...
            'Elementor URL Replace',
            'manage_options',
            'jobportal-elementor-url-replace',
            [$this, 'admin_page']
        );
    }
    ...
    public function add_admin_bar_link($wp_admin_bar)
    {
        ...
        $wp_admin_bar->add_node([
            'id'    => 'jobportal-fix-urls',
            'title' => '🔧 JobPortal Fix URLs',
            'href'  => admin_url('tools.php?page=jobportal-elementor-url-replace'),
            'meta'  => [
    ...
    public function admin_page()
    {
        ...
        <div class="wrap">
            ...
            <div class="card" style="max-width: 800px;">
                ...
                <div style="background: #f0f6fc; padding: 15px; border-left: 4px solid #0073aa; margin: 15px 0;">
                    ...
                    <ul style="margin: 10px 0;">
                        ...
                        <li><code>https://jobportal.example.com/freelance/wp-content/uploads/sites/2/</code> → <code><?php echo $current_site_url; ?>/wp-content/uploads/</code></li>
                    </ul>
                </div>

                <p class="submit">
                    <button type="button" class="button-primary button-large" onclick="jobportalQuickFixSites2()" style="padding: 10px 20px;">
            ...
            <div class="card" style="max-width: 800px; margin-top: 20px;">
                ...
                <p class="submit">
                    <button type="button" class="button-secondary" onclick="jobportalCustomReplace()">
                        Replace Custom URLs
                    </button>
                </p>
            </div>
        ...
        <script>
        function jobportalQuickFixSites2() {
            ...
            fetch(ajaxurl, {
                ...
                body: 'action=jobportal_elementor_replace_urls&type=quick_fix_sites2&_wpnonce=<?php echo wp_create_nonce('jobportal_elementor_replace'); ?>'
            })
        ...
        function jobportalCustomReplace() {
            ...
            fetch(ajaxurl, {
                ...
                body: 'action=jobportal_elementor_replace_urls&type=custom&old_url=' + encodeURIComponent(oldUrl) + '&new_url=' + encodeURIComponent(newUrl) + '&_wpnonce=<?php echo wp_create_nonce('jobportal_elementor_replace'); ?>'
            })
            .then(response => response.json())
            .then(data => {
                button.innerHTML = originalText;
    ...
    {
        if (!check_ajax_referer('jobportal_elementor_replace', '_wpnonce', false)) {
            ...
            switch ($type) {
                case 'quick_fix_sites2':
                    $replacements = [
                        ...
                        'https://jobportal.example.com/freelance/wp-content/uploads/sites/2/' => $current_site_url . '/wp-content/uploads/',
                        'https://jobportal.example.com/wp-content/uploads/sites/2/' => $current_site_url . '/wp-content/uploads/',
                    ];
...
JobPortal_Elementor_URL_Replacer::instance();
