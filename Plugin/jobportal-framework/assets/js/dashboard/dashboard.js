...
(function ($) {
  ...
  DASHBOARD = {
    ...
    svg: function () {
      ...
      var colorAccent = $(".jobportal-nav-dashboard").data("accent") || "#007456";
      var colorSecondary = $(".jobportal-nav-dashboard").data("secondary") || "#999";

      function setSvgColor($li, color) {
        var $object = $li.find("object.jobportal-svg");
        if ($object.length) {
          try {
      ...
      $nav.find("object.jobportal-svg").off("load.svg").on("load.svg", function () {
        var $li = $(this).closest(".nav-item");
        if ($li.hasClass("active")) {
          setSvgColor($li, colorAccent);
        } else {
      ...
      $close.on('click', function () {
        ...
        if ($close.find("i").hasClass("fas fa-arrow-right")) {
          ...
          if ($("body").hasClass("rtl")) {
            $(".page-dashboard #jobportal-content-dashboard").css(
              "padding-right",
              "290px"
            );
          } else {
    ...
    scroll_top: function () {
      ...
      var submit = $(".jobportal-submit-header");
    ...
    toggle_password: function () {
      $(".jobportal-toggle-password").on('click', function () {
    ...
    form_popup: function () {
      $(".form-popup").each(function () {
        if ($(this).is("#form-invite-popup")) {
          ...
          var btn_popup = "#jobportal-add-messages";
          ...
          var form_popup = "#jobportal-form-setting-meetings";
    ...
    select_tabs: function () {
      $(".jobportal-section-salary-select").hide();
      ...
      //Apply
      $(".jobportal-section-apply-select").hide();
    ...
    about_jobs: function () {
      ...
      function getThousandSeparator() {
        var thousand_sep = (typeof theme_vars !== 'undefined' ? theme_vars.thousand_separator : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.thousand_separator : '');
      ...
      $salary_show
        .on('change', function () {
          var html = "",
            ...
            text_min = (typeof theme_vars !== 'undefined' ? theme_vars.salary_text_minimum : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.salary_text_minimum : '') || $label_price.data("text-min"),
            text_max = (typeof theme_vars !== 'undefined' ? theme_vars.salary_text_maximum : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.salary_text_maximum : '') || $label_price.data("text-max"),
            text_agree = (typeof theme_vars !== 'undefined' ? theme_vars.salary_text_negotiable : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.salary_text_negotiable : '') || $label_price.data("text-agree"),
            salary_rate = $salary_rate.find("option:selected").val(),
            salary_currency = $salary_currency.find("option:selected").val(),
            currency_position = (typeof theme_vars !== 'undefined' ? theme_vars.currency_position : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.currency_position : '');
      ...
      $salary_minimum
        .on('input', function () {
          var value = $(this).val();
          var decimal_separator = (typeof theme_vars !== 'undefined' ? theme_vars.decimal_separator : '') || (typeof jobportal_submit_vars !== 'undefined' ? jobportal_submit_vars.decimal_separator : '') || '.';
      ...
      $company_website
        .on('keyup', function () {
          ...
          if (
            ...
            $about.find(".jobportal-check-company").addClass("active");
          } else {
            $about.find(".jobportal-check-company").removeClass("active");
          }
        })
        .trigger("keyup");
