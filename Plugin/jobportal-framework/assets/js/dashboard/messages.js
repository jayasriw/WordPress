      ...
      $("body").on("click", "#btn-send-messages", function (e) {
        ...
        var $this = $(this),
          ...
          content_message = form_popup
            ...
            .val(),
          creator_message = $("#jobportal-add-messages").data("author-id"),
          recipient_message = $("#jobportal-add-messages").data("post-current");
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {
            action: "jobportal_send_messages",
    ...
    list_user: function () {
      ...
      $("body").on("click", ".messages-dashboard .tab-info li", function (e) {
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {
            action: "jobportal_messages_list_user",
    ...
    write_mess: function () {
      $("body").on("click", "#btn-write-message", function (e) {
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {
            action: "jobportal_write_messages",
          ...
          success: function (data) {
            if (data.success == true) {
              ...
              $(".content-write #jobportal_mess_file_view").children().remove();
    ...
    ajax_load_mess: function () {
      ...
      function ajax_load(message_id = "", action_click = "") {
        $.ajax({
          ...
          dataType: "json",
          data: {
            action: "jobportal_refresh_messages",
            message_id: message_id,
    ...
    load_more_messages: function () {
      $(document).on("click", ".load-more-messages .btn-load-more", function (e) {
        ...
        $.ajax({
          ...
          dataType: "json",
          data: {
            action: "jobportal_load_more_messages",
            paged: nextPage,
            posts_per_page: 10,
