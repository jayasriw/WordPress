jQuery(document).ready(function () {
    var api_key = jobportal_openstreet_map_single_vars.api_key,
        lng = parseFloat(jobportal_openstreet_map_single_vars.lng),
        lat = parseFloat(jobportal_openstreet_map_single_vars.lat),
        map_zoom = jobportal_openstreet_map_single_vars.map_zoom,
        map_style = jobportal_openstreet_map_single_vars.map_style,
        map_marker = jobportal_openstreet_map_single_vars.map_marker;
