jQuery(document).ready(function () {
    ...
    var api_key = jobportal_map_box_single_vars.api_key,
        lng = jobportal_map_box_single_vars.lng,
        lat = jobportal_map_box_single_vars.lat,
        map_zoom = jobportal_map_box_single_vars.map_zoom,
        map_style = jobportal_map_box_single_vars.map_style,
        map_marker = jobportal_map_box_single_vars.map_marker;
