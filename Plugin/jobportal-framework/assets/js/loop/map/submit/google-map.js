jQuery(document).ready(function () {
    ...
    function initGoogleMap() {
        ...
        var api_key = jobportal_google_map_submit_vars.api_key,
            lng = jobportal_google_map_submit_vars.lng,
            lat = jobportal_google_map_submit_vars.lat,
            map_style = jobportal_google_map_submit_vars.map_style,
            map_type = jobportal_google_map_submit_vars.map_type,
            form_submit = jobportal_google_map_submit_vars.form_submit;
    ...
    function controlMarker() {
        map.addListener('click', function(event) {
            if( jQuery('body .lock-marker').length == 0 ) {
                ...
                jQuery('input[name="jobportal_map_location"]').val(event.latLng.lat() + ',' + event.latLng.lng());
            }
        });
    ...
    function initAutocomplete() {
        ...
        autocomplete.addListener('place_changed', function() {
            ...
            jQuery('input[name="jobportal_map_location"]').val(lat + ',' + lng);
            jQuery('input[name="jobportal_longtitude"]').val(lng);
            jQuery('input[name="jobportal_latitude"]').val(lat);
            jQuery('input[name="jobportal_map_address"]').val(formattedAddress);
