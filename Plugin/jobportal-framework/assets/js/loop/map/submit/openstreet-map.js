jQuery(document).ready(function () {
    ...
    var api_key = jobportal_openstreet_map_submit_vars.api_key,
        lng = jobportal_openstreet_map_submit_vars.lng,
        lat = jobportal_openstreet_map_submit_vars.lat,
        map_zoom = jobportal_openstreet_map_submit_vars.map_zoom,
        map_style = jobportal_openstreet_map_submit_vars.map_style,
        map_marker = jobportal_openstreet_map_submit_vars.map_marker,
        form_submit = jobportal_openstreet_map_submit_vars.form_submit;


    var lat = parseFloat(lat),
        lng = parseFloat(lng),
        location = jQuery(form_submit).find('input[name="jobportal_map_location"]'),
        address = jQuery(form_submit).find('input[name="jobportal_map_address"]'),
        longtitude = jQuery(form_submit).find('input[name="jobportal_longtitude"]'),
        latitude = jQuery(form_submit).find('input[name="jobportal_latitude"]');
