(function ($) {
  "use strict";
  var ajax_url = jobportal_mess_image_vars.ajax_url,
    mess_image_title = jobportal_mess_image_vars.mess_image_title,
    mess_image_type = jobportal_mess_image_vars.mess_image_type,
    mess_image_file_size = jobportal_mess_image_vars.mess_image_file_size,
    mess_image_id = jobportal_mess_image_vars.mess_image_id,
    mess_image_upload_nonce = jobportal_mess_image_vars.mess_image_upload_nonce;

  jQuery(document).ready(function () {
    var init_mess_image_uploaders = function () {
      $(".jobportal-fields-mess_image").each(function () {
        var $this = $(this);
        ...
        var uploader_mess_image = new plupload.Uploader({
          browse_button: "jobportal_select_mess_image_" + mess_image_id,
          file_data_name: "jobportal_mess_image_upload_file_" + mess_image_id,
          drop_element: "jobportal_mess_image_view_" + mess_image_id,
          container: "jobportal_mess_image_container_" + mess_image_id,
          url:
            ajax_url +
            "?action=jobportal_mess_image_upload_ajax&nonce=" +
        ...
        uploader_mess_image.bind("UploadProgress", function (up, file) {
          $("#jobportal_select_mess_image_" + mess_image_id).html(
        ...
        if ($image_id && $image_url) {
          var $html =
            ...
            "</div>" +
            "</figure>";
          $("#jobportal_mess_image_view_" + mess_image_id).html($html);
          $("#jobportal_add_mess_image_" + mess_image_id).hide();
        }

        uploader_mess_image.bind(
          "FileUploaded",
          function (up, file, ajax_response) {
            $("#jobportal_drop_mess_image_" + mess_image_id).html(
              '<button type="button" class="tooltip" id="jobportal_select_mess_image_' +
                mess_image_id +
      ...
      $("body").on(
        ...
        function (e) {
          ...
          var $this = $(this),
            icon_delete = $this,
            mess_image = $this
              .closest("#jobportal_mess_image_view_" + mess_image_id)
              .find(".media-thumb-wrap"),
            attachment_id = $this.data("attachment-id"),
            $drop = $("#jobportal_drop_mess_image_" + mess_image_id);
          ...
          $.ajax({
            ...
            dataType: "json",
            data: {
              action: "jobportal_mess_image_remove_ajax",
            ...
            success: function (response) {
              if (response.success) {
                ...
                $("#jobportal_add_mess_image_" + mess_image_id).show();
              }
              icon_delete.html('<i class="fal fa-spinner fa-spin large"></i>');
