(function ($) {
  "use strict";
  var ajax_url = jobportal_upload_cv_vars.ajax_url,
  ...
  $(document).ready(function () {
    var featured_image = function () {
      ...
      uploader_featured_image.bind("UploadProgress", function (up, file) {
        $("#jobportal_select_cv i").removeClass("far fa-arrow-from-bottom large");
        $("#jobportal_select_cv i").addClass("fal fa-spinner fa-spin large");
      });
        ...
        function (up, file, ajax_response) {
          ...
          if (response.success) {
            ...
            var $html =
              ...
              response.title +
              "</span>";
            $("#jobportal_select_cv i").addClass("far fa-arrow-from-bottom large");
