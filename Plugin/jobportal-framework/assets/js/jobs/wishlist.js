...
(function ($) {
	...
	WISHLIST = {
		init: function () {
			...
			$("body").on("click", ".jobportal-add-to-wishlist", function (e) {
				e.preventDefault();
				if (!$(this).hasClass("on-handle")) {
					...
					$.ajax({
						...
						dataType: "json",
						data: {
							action: "jobportal_add_to_wishlist",
							jobs_id: jobs_id,
							nonce: jobportal_ajax_nonce.wishlist,
						},
						beforeSend: function () {
							$this
								.find(".icon-heart")
						...
						success: function (data) {
							if (data.added) {
								...
								$this
									.parents(".jobportal-jobs-item")
									.removeClass("removed-wishlist");
							} else {
								save = wishlist_save;
								$this.removeClass("added").addClass("removed");
								$this.parents(".jobportal-jobs-item").addClass("removed-wishlist");
							}
