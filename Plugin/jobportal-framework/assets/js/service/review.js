jQuery(document).ready(function ($) {
  var ajax_url = jobportal_service_review_vars.ajax_url;
  var service_review = $(".service-review-details");

  service_review.find("input:file").on('change', function () {
  ...
  $("body").on("click", ".form-reply .jobportal-submit-service-reply", function (e) {
    e.preventDefault();
    var $this = $(this);
  ...
  $(".reviewForm").validate({
    ...
    submitHandler: function (form) {
      var $this = $(".reviewForm").find(".jobportal-submit-service-rating");
      var $form = $(".reviewForm");
