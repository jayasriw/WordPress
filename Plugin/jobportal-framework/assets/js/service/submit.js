(function ($) {
    ...
    var ajax_url = jobportal_submit_vars.ajax_url,
        service_dashboard = jobportal_submit_vars.service_dashboard,
    ...
    $(document).ready(function () {
        ...
        //More Section
        var $rowActive = submit_form.find(".jobportal-addons-wrapper > .row:first-child");
        ...
        submit_form.find(".btn-more.service-fields").on("click", function () {
            ...
            var row = $(this).closest(".jobportal-addons-wrapper").find('.row');
        ...
        function ajax_load() {
            var service_form = submit_form.find('input[name="service_form"]').val(),
                ...
                jobportal_security_service_submit = submit_form.find('#jobportal_security_service_submit').val(),
                ...
                service_map_location = submit_form
                    ...
                    .val(),
                service_latitude = submit_form.find('input[name="jobportal_latitude"]').val(),
            ...
            $.ajax({
                ...
                data: {
                    ...
                    jobportal_security_service_submit: jobportal_security_service_submit,
