jQuery(document).ready(function ($) {
  var ajax_url = jobportal_candidate_review_vars.ajax_url;
  var candidate_review = $(".candidate-review-details");

  candidate_review.find("input:file").on('change', function () {
  ...
  $("body").on(
    "click",
    ".form-reply .jobportal-submit-candidate-reply",
    function (e) {
      e.preventDefault();
      var $this = $(this);
  ...
  $(".reviewForm").validate({
    ...
    submitHandler: function (form) {
      var $this = $(".reviewForm").find(".jobportal-submit-candidate-rating");
      var $form = $(".reviewForm");
