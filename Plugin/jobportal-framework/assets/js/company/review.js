jQuery(document).ready(function ($) {
  var ajax_url = jobportal_company_review_vars.ajax_url;
  var company_review = $(".company-review-details");

  company_review.find("input:file").on('change', function () {
  ...
  $("body").on("click", ".form-reply .jobportal-submit-company-reply", function (e) {
    e.preventDefault();
    var $this = $(this);
  ...
  $(".reviewForm").validate({
    ...
    submitHandler: function (form) {
      var $this = $(".reviewForm").find(".jobportal-submit-company-rating");
      var $form = $(".reviewForm");
