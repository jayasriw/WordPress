(function ($) {
  ...
  var ajax_url = jobportal_submit_vars.ajax_url,
    company_dashboard = jobportal_submit_vars.company_dashboard,
    custom_field_company = jobportal_submit_vars.custom_field_company;
  ...
  $(document).ready(function () {
    ...
    submit_form.validate({
      ...
      submitHandler: function (form) {
        var submitButtonName = $(this.submitButton).attr("data-type");
    ...
    function ajax_load(submitButtonName) {
      ...
      var company_des;
      if ($("#wp-company_des-wrap textarea[name='candidate_des']").length) {
        company_des = submit_form.find('textarea[name="candidate_des"]').val();
      } else {
      ...
      $.ajax({
        ...
        data: {
          ...
          security: theme_vars.create_company_nonce,
        },
        beforeSend: function () {
          $(
            ".btn-submit-company[data-type=" +
              submitButtonName +
              "] .btn-loading"
          ).fadeIn();
        },
